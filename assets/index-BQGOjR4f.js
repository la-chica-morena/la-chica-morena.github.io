 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var A_;function By(){if(A_)return ne;A_=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),y=Symbol.iterator;function S(N){return N===null||typeof N!="object"?null:(N=y&&N[y]||N["@@iterator"],typeof N=="function"?N:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,M={};function x(N,it,Mt){this.props=N,this.context=it,this.refs=M,this.updater=Mt||E}x.prototype.isReactComponent={},x.prototype.setState=function(N,it){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,it,"setState")},x.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function B(){}B.prototype=x.prototype;function U(N,it,Mt){this.props=N,this.context=it,this.refs=M,this.updater=Mt||E}var w=U.prototype=new B;w.constructor=U,R(w,x.prototype),w.isPureReactComponent=!0;var K=Array.isArray;function G(){}var P={H:null,A:null,T:null,S:null},j=Object.prototype.hasOwnProperty;function D(N,it,Mt){var Z=Mt.ref;return{$$typeof:s,type:N,key:it,ref:Z!==void 0?Z:null,props:Mt}}function C(N,it){return D(N.type,it,N.props)}function H(N){return typeof N=="object"&&N!==null&&N.$$typeof===s}function ct(N){var it={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(Mt){return it[Mt]})}var ot=/\/+/g;function gt(N,it){return typeof N=="object"&&N!==null&&N.key!=null?ct(""+N.key):it.toString(36)}function tt(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(G,G):(N.status="pending",N.then(function(it){N.status==="pending"&&(N.status="fulfilled",N.value=it)},function(it){N.status==="pending"&&(N.status="rejected",N.reason=it)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function O(N,it,Mt,Z,ut){var At=typeof N;(At==="undefined"||At==="boolean")&&(N=null);var St=!1;if(N===null)St=!0;else switch(At){case"bigint":case"string":case"number":St=!0;break;case"object":switch(N.$$typeof){case s:case t:St=!0;break;case g:return St=N._init,O(St(N._payload),it,Mt,Z,ut)}}if(St)return ut=ut(N),St=Z===""?"."+gt(N,0):Z,K(ut)?(Mt="",St!=null&&(Mt=St.replace(ot,"$&/")+"/"),O(ut,it,Mt,"",function(ie){return ie})):ut!=null&&(H(ut)&&(ut=C(ut,Mt+(ut.key==null||N&&N.key===ut.key?"":(""+ut.key).replace(ot,"$&/")+"/")+St)),it.push(ut)),1;St=0;var Gt=Z===""?".":Z+":";if(K(N))for(var Ft=0;Ft<N.length;Ft++)Z=N[Ft],At=Gt+gt(Z,Ft),St+=O(Z,it,Mt,At,ut);else if(Ft=S(N),typeof Ft=="function")for(N=Ft.call(N),Ft=0;!(Z=N.next()).done;)Z=Z.value,At=Gt+gt(Z,Ft++),St+=O(Z,it,Mt,At,ut);else if(At==="object"){if(typeof N.then=="function")return O(tt(N),it,Mt,Z,ut);throw it=String(N),Error("Objects are not valid as a React child (found: "+(it==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":it)+"). If you meant to render a collection of children, use an array instead.")}return St}function V(N,it,Mt){if(N==null)return N;var Z=[],ut=0;return O(N,Z,"","",function(At){return it.call(Mt,At,ut++)}),Z}function W(N){if(N._status===-1){var it=N._result;it=it(),it.then(function(Mt){(N._status===0||N._status===-1)&&(N._status=1,N._result=Mt)},function(Mt){(N._status===0||N._status===-1)&&(N._status=2,N._result=Mt)}),N._status===-1&&(N._status=0,N._result=it)}if(N._status===1)return N._result.default;throw N._result}var xt=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var it=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(it))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},Tt={map:V,forEach:function(N,it,Mt){V(N,function(){it.apply(this,arguments)},Mt)},count:function(N){var it=0;return V(N,function(){it++}),it},toArray:function(N){return V(N,function(it){return it})||[]},only:function(N){if(!H(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return ne.Activity=_,ne.Children=Tt,ne.Component=x,ne.Fragment=i,ne.Profiler=l,ne.PureComponent=U,ne.StrictMode=r,ne.Suspense=p,ne.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,ne.__COMPILER_RUNTIME={__proto__:null,c:function(N){return P.H.useMemoCache(N)}},ne.cache=function(N){return function(){return N.apply(null,arguments)}},ne.cacheSignal=function(){return null},ne.cloneElement=function(N,it,Mt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var Z=R({},N.props),ut=N.key;if(it!=null)for(At in it.key!==void 0&&(ut=""+it.key),it)!j.call(it,At)||At==="key"||At==="__self"||At==="__source"||At==="ref"&&it.ref===void 0||(Z[At]=it[At]);var At=arguments.length-2;if(At===1)Z.children=Mt;else if(1<At){for(var St=Array(At),Gt=0;Gt<At;Gt++)St[Gt]=arguments[Gt+2];Z.children=St}return D(N.type,ut,Z)},ne.createContext=function(N){return N={$$typeof:f,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:c,_context:N},N},ne.createElement=function(N,it,Mt){var Z,ut={},At=null;if(it!=null)for(Z in it.key!==void 0&&(At=""+it.key),it)j.call(it,Z)&&Z!=="key"&&Z!=="__self"&&Z!=="__source"&&(ut[Z]=it[Z]);var St=arguments.length-2;if(St===1)ut.children=Mt;else if(1<St){for(var Gt=Array(St),Ft=0;Ft<St;Ft++)Gt[Ft]=arguments[Ft+2];ut.children=Gt}if(N&&N.defaultProps)for(Z in St=N.defaultProps,St)ut[Z]===void 0&&(ut[Z]=St[Z]);return D(N,At,ut)},ne.createRef=function(){return{current:null}},ne.forwardRef=function(N){return{$$typeof:d,render:N}},ne.isValidElement=H,ne.lazy=function(N){return{$$typeof:g,_payload:{_status:-1,_result:N},_init:W}},ne.memo=function(N,it){return{$$typeof:m,type:N,compare:it===void 0?null:it}},ne.startTransition=function(N){var it=P.T,Mt={};P.T=Mt;try{var Z=N(),ut=P.S;ut!==null&&ut(Mt,Z),typeof Z=="object"&&Z!==null&&typeof Z.then=="function"&&Z.then(G,xt)}catch(At){xt(At)}finally{it!==null&&Mt.types!==null&&(it.types=Mt.types),P.T=it}},ne.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},ne.use=function(N){return P.H.use(N)},ne.useActionState=function(N,it,Mt){return P.H.useActionState(N,it,Mt)},ne.useCallback=function(N,it){return P.H.useCallback(N,it)},ne.useContext=function(N){return P.H.useContext(N)},ne.useDebugValue=function(){},ne.useDeferredValue=function(N,it){return P.H.useDeferredValue(N,it)},ne.useEffect=function(N,it){return P.H.useEffect(N,it)},ne.useEffectEvent=function(N){return P.H.useEffectEvent(N)},ne.useId=function(){return P.H.useId()},ne.useImperativeHandle=function(N,it,Mt){return P.H.useImperativeHandle(N,it,Mt)},ne.useInsertionEffect=function(N,it){return P.H.useInsertionEffect(N,it)},ne.useLayoutEffect=function(N,it){return P.H.useLayoutEffect(N,it)},ne.useMemo=function(N,it){return P.H.useMemo(N,it)},ne.useOptimistic=function(N,it){return P.H.useOptimistic(N,it)},ne.useReducer=function(N,it,Mt){return P.H.useReducer(N,it,Mt)},ne.useRef=function(N){return P.H.useRef(N)},ne.useState=function(N){return P.H.useState(N)},ne.useSyncExternalStore=function(N,it,Mt){return P.H.useSyncExternalStore(N,it,Mt)},ne.useTransition=function(){return P.H.useTransition()},ne.version="19.2.6",ne}var b_;function Cd(){return b_||(b_=1,Jf.exports=By()),Jf.exports}var kn=Cd();const Iy=Hv(kn);var $f={exports:{}},Uo={},th={exports:{}},eh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var R_;function Fy(){return R_||(R_=1,(function(s){function t(O,V){var W=O.length;O.push(V);t:for(;0<W;){var xt=W-1>>>1,Tt=O[xt];if(0<l(Tt,V))O[xt]=V,O[W]=Tt,W=xt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var V=O[0],W=O.pop();if(W!==V){O[0]=W;t:for(var xt=0,Tt=O.length,N=Tt>>>1;xt<N;){var it=2*(xt+1)-1,Mt=O[it],Z=it+1,ut=O[Z];if(0>l(Mt,W))Z<Tt&&0>l(ut,Mt)?(O[xt]=ut,O[Z]=W,xt=Z):(O[xt]=Mt,O[it]=W,xt=it);else if(Z<Tt&&0>l(ut,W))O[xt]=ut,O[Z]=W,xt=Z;else break t}}return V}function l(O,V){var W=O.sortIndex-V.sortIndex;return W!==0?W:O.id-V.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var f=Date,d=f.now();s.unstable_now=function(){return f.now()-d}}var p=[],m=[],g=1,_=null,y=3,S=!1,E=!1,R=!1,M=!1,x=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function w(O){for(var V=i(m);V!==null;){if(V.callback===null)r(m);else if(V.startTime<=O)r(m),V.sortIndex=V.expirationTime,t(p,V);else break;V=i(m)}}function K(O){if(R=!1,w(O),!E)if(i(p)!==null)E=!0,G||(G=!0,ct());else{var V=i(m);V!==null&&tt(K,V.startTime-O)}}var G=!1,P=-1,j=5,D=-1;function C(){return M?!0:!(s.unstable_now()-D<j)}function H(){if(M=!1,G){var O=s.unstable_now();D=O;var V=!0;try{t:{E=!1,R&&(R=!1,B(P),P=-1),S=!0;var W=y;try{e:{for(w(O),_=i(p);_!==null&&!(_.expirationTime>O&&C());){var xt=_.callback;if(typeof xt=="function"){_.callback=null,y=_.priorityLevel;var Tt=xt(_.expirationTime<=O);if(O=s.unstable_now(),typeof Tt=="function"){_.callback=Tt,w(O),V=!0;break e}_===i(p)&&r(p),w(O)}else r(p);_=i(p)}if(_!==null)V=!0;else{var N=i(m);N!==null&&tt(K,N.startTime-O),V=!1}}break t}finally{_=null,y=W,S=!1}V=void 0}}finally{V?ct():G=!1}}}var ct;if(typeof U=="function")ct=function(){U(H)};else if(typeof MessageChannel<"u"){var ot=new MessageChannel,gt=ot.port2;ot.port1.onmessage=H,ct=function(){gt.postMessage(null)}}else ct=function(){x(H,0)};function tt(O,V){P=x(function(){O(s.unstable_now())},V)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(O){O.callback=null},s.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<O?Math.floor(1e3/O):5},s.unstable_getCurrentPriorityLevel=function(){return y},s.unstable_next=function(O){switch(y){case 1:case 2:case 3:var V=3;break;default:V=y}var W=y;y=V;try{return O()}finally{y=W}},s.unstable_requestPaint=function(){M=!0},s.unstable_runWithPriority=function(O,V){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var W=y;y=O;try{return V()}finally{y=W}},s.unstable_scheduleCallback=function(O,V,W){var xt=s.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?xt+W:xt):W=xt,O){case 1:var Tt=-1;break;case 2:Tt=250;break;case 5:Tt=1073741823;break;case 4:Tt=1e4;break;default:Tt=5e3}return Tt=W+Tt,O={id:g++,callback:V,priorityLevel:O,startTime:W,expirationTime:Tt,sortIndex:-1},W>xt?(O.sortIndex=W,t(m,O),i(p)===null&&O===i(m)&&(R?(B(P),P=-1):R=!0,tt(K,W-xt))):(O.sortIndex=Tt,t(p,O),E||S||(E=!0,G||(G=!0,ct()))),O},s.unstable_shouldYield=C,s.unstable_wrapCallback=function(O){var V=y;return function(){var W=y;y=V;try{return O.apply(this,arguments)}finally{y=W}}}})(eh)),eh}var C_;function Hy(){return C_||(C_=1,th.exports=Fy()),th.exports}var nh={exports:{}},bn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var U_;function ky(){if(U_)return Uo;U_=1;var s=Hy(),t=Cd(),i=Vy();function r(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function f(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function p(e){if(c(e)!==e)throw Error(r(188))}function m(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(r(188));return n!==e?null:e}for(var a=e,o=n;;){var u=a.return;if(u===null)break;var h=u.alternate;if(h===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===h.child){for(h=u.child;h;){if(h===a)return p(u),e;if(h===o)return p(u),n;h=h.sibling}throw Error(r(188))}if(a.return!==o.return)a=u,o=h;else{for(var v=!1,T=u.child;T;){if(T===a){v=!0,a=u,o=h;break}if(T===o){v=!0,o=u,a=h;break}T=T.sibling}if(!v){for(T=h.child;T;){if(T===a){v=!0,a=h,o=u;break}if(T===o){v=!0,o=h,a=u;break}T=T.sibling}if(!v)throw Error(r(189))}}if(a.alternate!==o)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?e:n}function g(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=g(e),n!==null)return n;e=e.sibling}return null}var _=Object.assign,y=Symbol.for("react.element"),S=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),R=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),B=Symbol.for("react.consumer"),U=Symbol.for("react.context"),w=Symbol.for("react.forward_ref"),K=Symbol.for("react.suspense"),G=Symbol.for("react.suspense_list"),P=Symbol.for("react.memo"),j=Symbol.for("react.lazy"),D=Symbol.for("react.activity"),C=Symbol.for("react.memo_cache_sentinel"),H=Symbol.iterator;function ct(e){return e===null||typeof e!="object"?null:(e=H&&e[H]||e["@@iterator"],typeof e=="function"?e:null)}var ot=Symbol.for("react.client.reference");function gt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===ot?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case R:return"Fragment";case x:return"Profiler";case M:return"StrictMode";case K:return"Suspense";case G:return"SuspenseList";case D:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case E:return"Portal";case U:return e.displayName||"Context";case B:return(e._context.displayName||"Context")+".Consumer";case w:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case P:return n=e.displayName||null,n!==null?n:gt(e.type)||"Memo";case j:n=e._payload,e=e._init;try{return gt(e(n))}catch{}}return null}var tt=Array.isArray,O=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,V=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W={pending:!1,data:null,method:null,action:null},xt=[],Tt=-1;function N(e){return{current:e}}function it(e){0>Tt||(e.current=xt[Tt],xt[Tt]=null,Tt--)}function Mt(e,n){Tt++,xt[Tt]=e.current,e.current=n}var Z=N(null),ut=N(null),At=N(null),St=N(null);function Gt(e,n){switch(Mt(At,n),Mt(ut,e),Mt(Z,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?qg(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=qg(n),e=Yg(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}it(Z),Mt(Z,e)}function Ft(){it(Z),it(ut),it(At)}function ie(e){e.memoizedState!==null&&Mt(St,e);var n=Z.current,a=Yg(n,e.type);n!==a&&(Mt(ut,e),Mt(Z,a))}function Ne(e){ut.current===e&&(it(Z),it(ut)),St.current===e&&(it(St),bo._currentValue=W)}var fe,Xe;function I(e){if(fe===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);fe=n&&n[1]||"",Xe=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+fe+e+Xe}var Tn=!1;function ue(e,n){if(!e||Tn)return"";Tn=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var mt=function(){throw Error()};if(Object.defineProperty(mt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(mt,[])}catch(st){var et=st}Reflect.construct(e,[],mt)}else{try{mt.call()}catch(st){et=st}e.call(mt.prototype)}}else{try{throw Error()}catch(st){et=st}(mt=e())&&typeof mt.catch=="function"&&mt.catch(function(){})}}catch(st){if(st&&et&&typeof st.stack=="string")return[st.stack,et.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var h=o.DetermineComponentFrameRoot(),v=h[0],T=h[1];if(v&&T){var z=v.split(`
`),$=T.split(`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zy=kn.forwardRef(({color:s="currentColor",size:t=24,strokeWidth:i=2,absoluteStrokeWidth:r,className:l="",children:c,iconNode:f,...d},p)=>kn.createElement("svg",{ref:p,...jy,width:t,height:t,stroke:s,strokeWidth:r?Number(i)*24/Number(t):i,className:Gv("lucide",l),...d},[...f.map(([m,g])=>kn.createElement(m,g)),...Array.isArray(c)?c:[c]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qo=(s,t)=>{const i=kn.forwardRef(({className:r,...l},c)=>kn.createElement(Zy,{ref:c,iconNode:t,className:Gv(`lucide-${Yy(s)}`,r),...l}));return i.displayName=`${s}`,i};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ky=qo("ArrowUpRight",[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
#endif`,PE="gl_FragColor = linearToOutputTexel( gl_FragColor );",zE=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,ce={alphahash_fragment:rE,alphahash_pars_fragment:sE,alphamap_fragment:oE,alphamap_pars_fragment:lE,alphatest_fragment:cE,alphatest_pars_fragment:uE,aomap_fragment:fE,aomap_pars_fragment:hE,batching_pars_vertex:dE,batching_vertex:pE,begin_vertex:mE,beginnormal_vertex:gE,bsdfs:_E,iridescence_fragment:vE,bumpmap_pars_fragment:xE,clipping_planes_fragment:yE,clipping_planes_pars_fragment:SE,clipping_planes_pars_vertex:ME,clipping_planes_vertex:EE,color_fragment:TE,color_pars_fragment:AE,color_pars_vertex:bE,color_vertex:RE,common:CE,cube_uv_reflection_fragment:wE,defaultnormal_vertex:DE,displacementmap_pars_vertex:UE,displacementmap_vertex:LE,emissivemap_fragment:NE,emissivemap_pars_fragment:OE,colorspace_fragment:PE,colorspace_pars_fragment:zE,envmap_fragment:BE,envmap_common_pars_fragment:IE,envmap_pars_fragment:FE,envmap_pars_vertex:HE,envmap_physical_pars_fragment:QE,envmap_vertex:GE,fog_vertex:VE,fog_pars_vertex:kE,fog_fragment:XE,fog_pars_fragment:WE,gradientmap_pars_fragment:qE,lightmap_pars_fragment:YE,lights_lambert_fragment:jE,lights_lambert_pars_fragment:ZE,lights_pars_begin:KE,lights_toon_fragment:JE,lights_toon_pars_fragment:$E,lights_phong_fragment:tT,lights_phong_pars_fragment:eT,lights_physical_fragment:nT,lights_physical_pars_fragment:iT,lights_fragment_begin:aT,lights_fragment_maps:rT,lights_fragment_end:sT,logdepthbuf_fragment:oT,logdepthbuf_pars_fragment:lT,logdepthbuf_pars_vertex:cT,logdepthbuf_vertex:uT,map_fragment:fT,map_pars_fragment:hT,map_particle_fragment:dT,map_particle_pars_fragment:pT,metalnessmap_fragment:mT,metalnessmap_pars_fragment:gT,morphinstance_vertex:_T,morphcolor_vertex:vT,morphnormal_vertex:xT,morphtarget_pars_vertex:yT,morphtarget_vertex:ST,normal_fragment_begin:MT,normal_fragment_maps:ET,normal_pars_fragment:TT,normal_pars_vertex:AT,normal_vertex:bT,normalmap_pars_fragment:RT,clearcoat_normal_fragment_begin:CT,clearcoat_normal_fragment_maps:wT,clearcoat_pars_fragment:DT,iridescence_pars_fragment:UT,opaque_fragment:LT,packing:NT,premultiplied_alpha_fragment:OT,project_vertex:PT,dithering_fragment:zT,dithering_pars_fragment:BT,roughnessmap_fragment:IT,roughnessmap_pars_fragment:FT,shadowmap_pars_fragment:HT,shadowmap_pars_vertex:GT,shadowmap_vertex:VT,shadowmask_pars_fragment:kT,skinbase_vertex:XT,skinning_pars_vertex:WT,skinning_vertex:qT,skinnormal_vertex:YT,specularmap_fragment:jT,specularmap_pars_fragment:ZT,tonemapping_fragment:KT,tonemapping_pars_fragment:QT,transmission_fragment:JT,transmission_pars_fragment:$T,uv_pars_fragment:t1,uv_pars_vertex:e1,uv_vertex:n1,worldpos_vertex:i1,background_vert:a1,background_frag:r1,backgroundCube_vert:s1,backgroundCube_frag:o1,cube_vert:l1,cube_frag:c1,depth_vert:u1,depth_frag:f1,distanceRGBA_vert:h1,distanceRGBA_frag:d1,equirect_vert:p1,equirect_frag:m1,linedashed_vert:g1,linedashed_frag:_1,meshbasic_vert:v1,meshbasic_frag:x1,meshlambert_vert:y1,meshlambert_frag:S1,meshmatcap_vert:M1,meshmatcap_frag:E1,meshnormal_vert:T1,meshnormal_frag:A1,meshphong_vert:b1,meshphong_frag:R1,meshphysical_vert:C1,meshphysical_frag:w1,meshtoon_vert:D1,meshtoon_frag:U1,points_vert:L1,points_frag:N1,shadow_vert:O1,shadow_frag:P1,sprite_vert:z1,sprite_frag:B1},Lt={common:{diffuse:{value:new we(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new le},alphaMap:{value:null},alphaMapTransform:{value:new le},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new le}},envmap:{envMap:{value:null},envMapRotation:{value:new le},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new le}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new le}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new le},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new le},normalScale:{value:new qt(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new le},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new le}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new le}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new le}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new we(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new we(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new le},alphaTest:{value:0},uvTransform:{value:new le}},sprite:{diffuse:{value:new we(16777215)},opacity:{value:1},center:{value:new qt(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new le},alphaMap:{value:null},alphaMapTransform:{value:new le},alphaTest:{value:0}}},Di={basic:{uniforms:Nn([Lt.common,Lt.specularmap,Lt.envmap,Lt.aomap,Lt.lightmap,Lt.fog]),vertexShader:ce.meshbasic_vert,fragmentShader:ce.meshbasic_frag},lambert:{uniforms:Nn([Lt.common,Lt.specularmap,Lt.envmap,Lt.aomap,Lt.lightmap,Lt.emissivemap,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,Lt.fog,Lt.lights,{emissive:{value:new we(0)}}]),vertexShader:ce.meshlambert_vert,fragmentShader:ce.meshlambert_frag},phong:{uniforms:Nn([Lt.common,Lt.specularmap,Lt.envmap,Lt.aomap,Lt.lightmap,Lt.emissivemap,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,Lt.fog,Lt.lights,{emissive:{value:new we(0)},specular:{value:new we(1118481)},shininess:{value:30}}]),vertexShader:ce.meshphong_vert,fragmentShader:ce.meshphong_frag},standard:{uniforms:Nn([Lt.common,Lt.envmap,Lt.aomap,Lt.lightmap,Lt.emissivemap,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,Lt.roughnessmap,Lt.metalnessmap,Lt.fog,Lt.lights,{emissive:{value:new we(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:ce.meshphysical_vert,fragmentShader:ce.meshphysical_frag},toon:{uniforms:Nn([Lt.common,Lt.aomap,Lt.lightmap,Lt.emissivemap,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,Lt.gradientmap,Lt.fog,Lt.lights,{emissive:{value:new we(0)}}]),vertexShader:ce.meshtoon_vert,fragmentShader:ce.meshtoon_frag},matcap:{uniforms:Nn([Lt.common,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,Lt.fog,{matcap:{value:null}}]),vertexShader:ce.meshmatcap_vert,fragmentShader:ce.meshmatcap_frag},points:{uniforms:Nn([Lt.points,Lt.fog]),vertexShader:ce.points_vert,fragmentShader:ce.points_frag},dashed:{uniforms:Nn([Lt.common,Lt.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:ce.linedashed_vert,fragmentShader:ce.linedashed_frag},depth:{uniforms:Nn([Lt.common,Lt.displacementmap]),vertexShader:ce.depth_vert,fragmentShader:ce.depth_frag},normal:{uniforms:Nn([Lt.common,Lt.bumpmap,Lt.normalmap,Lt.displacementmap,{opacity:{value:1}}]),vertexShader:ce.meshnormal_vert,fragmentShader:ce.meshnormal_frag},sprite:{uniforms:Nn([Lt.sprite,Lt.fog]),vertexShader:ce.sprite_vert,fragmentShader:ce.sprite_frag},background:{uniforms:{uvTransform:{value:new le},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:ce.background_vert,fragmentShader:ce.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new le}},vertexShader:ce.backgroundCube_vert,fragmentShader:ce.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:ce.cube_vert,fragmentShader:ce.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:ce.equirect_vert,fragmentShader:ce.equirect_frag},distanceRGBA:{uniforms:Nn([Lt.common,Lt.displacementmap,{referencePosition:{value:new Q},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:ce.distanceRGBA_vert,fragmentShader:ce.distanceRGBA_frag},shadow:{uniforms:Nn([Lt.lights,Lt.fog,{color:{value:new we(0)},opacity:{value:1}}]),vertexShader:ce.shadow_vert,fragmentShader:ce.shadow_frag}};Di.physical={uniforms:Nn([Di.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new le},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new le},clearcoatNormalScale:{value:new qt(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new le},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new le},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new le},sheen:{value:0},sheenColor:{value:new we(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new le},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new le},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new le},transmissionSamplerSize:{value:new qt},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new le},attenuationDistance:{value:0},attenuationColor:{value:new we(0)},specularColor:{value:new we(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new le},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new le},anisotropyVector:{value:new qt},anisotropyMap:{value:null},anisotropyMapTransform:{value:new le}}]),vertexShader:ce.meshphysical_vert,fragmentShader:ce.meshphysical_frag};const wc={r:0,b:0,g:0},gr=new Ni,I1=new je;function F1(s,t,i,r,l,c,f){const d=new we(0);let p=c===!0?0:1,m,g,_=null,y=0,S=null;function E(U){let w=U.isScene===!0?U.background:null;return w&&w.isTexture&&(w=(U.backgroundBlurriness>0?i:t).get(w)),w}function R(U){let w=!1;const K=E(U);K===null?x(d,p):K&&K.isColor&&(x(K,1),w=!0);const G=s.xr.getEnvironmentBlendMode();G==="additive"?r.buffers.color.setClear(0,0,0,1,f):G==="alpha-blend"&&r.buffers.color.setClear(0,0,0,0,f),(s.autoClear||w)&&(r.buffers.depth.setTest(!0),r.buffers.depth.setMask(!0),r.buffers.color.setMask(!0),s.clear(s.autoClearColor,s.autoClearDepth,s.autoClearStencil))}function M(U,w){const K=E(w);K&&(K.isCubeTexture||K.mapping===Gc)?(g===void 0&&(g=new Xn(new zs(1,1,1),new Wa({name:"BackgroundCubeMaterial",uniforms:Ns(Di.backgroundCube.uniforms),vertexShader:Di.backgroundCube.vertexShader,fragmentShader:Di.backgroundCube.fragmentShader,side:Wn,depthTest:!1,depthWrite:!1,fog:!1})),g.geometry.deleteAttribute("normal"),g.geometry.deleteAttribute("uv"),g.onBeforeRender=function(G,P,j){this.matrixWorld.copyPosition(j.matrixWorld)},Object.defineProperty(g.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),l.update(g)),gr.copy(w.backgroundRotation),gr.x*=-1,gr.y*=-1,gr.z*=-1,K.isCubeTexture&&K.isRenderTargetTexture===!1&&(gr.y*=-1,gr.z*=-1),g.material.uniforms.envMap.value=K,g.material.uniforms.flipEnvMap.value=K.isCubeTexture&&K.isRenderTargetTexture===!1?-1:1,g.material.uniforms.backgroundBlurriness.value=w.backgroundBlurriness,g.material.uniforms.backgroundIntensity.value=w.backgroundIntensity,g.material.uniforms.backgroundRotation.value.setFromMatrix4(I1.makeRotationFromEuler(gr)),g.material.toneMapped=Re.getTransfer(K.colorSpace)!==Ie,(_!==K||y!==K.version||S!==s.toneMapping)&&(g.material.needsUpdate=!0,_=K,y=K.version,S=s.toneMapping),g.layers.enableAll(),U.unshift(g,g.geometry,g.material,0,0,null)):K&&K.isTexture&&(m===void 0&&(m=new Xn(new Qo(2,2),new Wa({name:"BackgroundMaterial",uniforms:Ns(Di.background.uniforms),vertexShader:Di.background.vertexShader,fragmentShader:Di.background.fragmentShader,side:Xa,depthTest:!1,depthWrite:!1,fog:!1})),m.geometry.deleteAttribute("normal"),Object.defineProperty(m.material,"map",{get:function(){return this.uniforms.t2D.value}}),l.update(m)),m.material.uniforms.t2D.value=K,m.material.uniforms.backgroundIntensity.value=w.backgroundIntensity,m.material.toneMapped=Re.getTransfer(K.colorSpace)!==Ie,K.matrixAutoUpdate===!0&&K.updateMatrix(),m.material.uniforms.uvTransform.value.copy(K.matrix),(_!==K||y!==K.version||S!==s.toneMapping)&&(m.material.needsUpdate=!0,_=K,y=K.version,S=s.toneMapping),m.layers.enableAll(),U.unshift(m,m.geometry,m.material,0,0,null))}function x(U,w){U.getRGB(wc,f0(s)),r.buffers.color.setClear(wc.r,wc.g,wc.b,w,f)}function B(){g!==void 0&&(g.geometry.dispose(),g.material.dispose()),m!==void 0&&(m.geometry.dispose(),m.material.dispose())}return{getClearColor:function(){return d},setClearColor:function(U,w=1){d.set(U),p=w,x(d,p)},getClearAlpha:function(){return p},setClearAlpha:function(U){p=U,x(d,p)},render:R,addToRenderList:M,dispose:B}}function H1(s,t){const i=s.getParameter(s.MAX_VERTEX_ATTRIBS),r={},l=y(null);let c=l,f=!1;function d(C,H,ct,ot,gt){let tt=!1;const O=_(ot,ct,H);c!==O&&(c=O,m(c.object)),tt=S(C,ot,ct,gt),tt&&E(C,ot,ct,gt),gt!==null&&t.update(gt,s.ELEMENT_ARRAY_BUFFER),(tt||f)&&(f=!1,w(C,H,ct,ot),gt!==null&&s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,t.get(gt).buffer))}function p(){return s.createVertexArray()}function m(C){return s.bindVertexArray(C)}function g(C){return s.deleteVertexArray(C)}function _(C,H,ct){const ot=ct.wireframe===!0;let gt=r[C.id];gt===void 0&&(gt={},r[C.id]=gt);let tt=gt[H.id];tt===void 0&&(tt={},gt[H.id]=tt);let O=tt[ot];return O===void 0&&(O=y(p()),tt[ot]=O),O}function y(C){const H=[],ct=[],ot=[];for(let gt=0;gt<i;gt++)H[gt]=0,ct[gt]=0,ot[gt]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:H,enabledAttributes:ct,attributeDivisors:ot,object:C,attributes:{},index:null}}function S(C,H,ct,ot){const gt=c.attributes,tt=H.attributes;let O=0;const V=ct.getAttributes();for(const W in V)if(V[W].location>=0){const Tt=gt[W];let N=tt[W];if(N===void 0&&(W==="instanceMatrix"&&C.instanceMatrix&&(N=C.instanceMatrix),W==="instanceColor"&&C.instanceColor&&(N=C.instanceColor)),Tt===void 0||Tt.attribute!==N||N&&Tt.data!==N.data)return!0;O++}return c.attributesNum!==O||c.index!==ot}function E(C,H,ct,ot){const gt={},tt=H.attributes;let O=0;const V=ct.getAttributes();for(const W in V)if(V[W].location>=0){let Tt=tt[W];Tt===void 0&&(W==="instanceMatrix"&&C.instanceMatrix&&(Tt=C.instanceMatrix),W==="instanceColor"&&C.instanceColor&&(Tt=C.instanceColor));const N={};N.attribute=Tt,Tt&&Tt.data&&(N.data=Tt.data),gt[W]=N,O++}c.attributes=gt,c.attributesNum=O,c.index=ot}function R(){const C=c.newAttributes;for(let H=0,ct=C.length;H<ct;H++)C[H]=0}function M(C){x(C,0)}function x(C,H){const ct=c.newAttributes,ot=c.enabledAttributes,gt=c.attributeDivisors;ct[C]=1,ot[C]===0&&(s.enableVertexAttribArray(C),ot[C]=1),gt[C]!==H&&(s.vertexAttribDivisor(C,H),gt[C]=H)}function B(){const C=c.newAttributes,H=c.enabledAttributes;for(let ct=0,ot=H.length;ct<ot;ct++)H[ct]!==C[ct]&&(s.disableVertexAttribArray(ct),H[ct]=0)}function U(C,H,ct,ot,gt,tt,O){O===!0?s.vertexAttribIPointer(C,H,ct,gt,tt):s.vertexAttribPointer(C,H,ct,ot,gt,tt)}function w(C,H,ct,ot){R();const gt=ot.attributes,tt=ct.getAttributes(),O=H.defaultAttributeValues;for(const V in tt){const W=tt[V];if(W.location>=0){let xt=gt[V];if(xt===void 0&&(V==="instanceMatrix"&&C.instanceMatrix&&(xt=C.instanceMatrix),V==="instanceColor"&&C.instanceColor&&(xt=C.instanceColor)),xt!==void 0){const Tt=xt.normalized,N=xt.itemSize,it=t.get(xt);if(it===void 0)continue;const Mt=it.buffer,Z=it.type,ut=it.bytesPerElement,At=Z===s.INT||Z===s.UNSIGNED_INT||xt.gpuType===Dd;if(xt.isInterleavedBufferAttribute){const St=xt.data,Gt=St.stride,Ft=xt.offset;if(St.isInstancedInterleavedBuffer){for(let ie=0;ie<W.locationSize;ie++)x(W.location+ie,St.meshPerAttribute);C.isInstancedMesh!==!0&&ot._maxInstanceCount===void 0&&(ot._maxInstanceCount=St.meshPerAttribute*St.count)}else for(let ie=0;ie<W.locationSize;ie++)M(W.location+ie);s.bindBuffer(s.ARRAY_BUFFER,Mt);for(let ie=0;ie<W.locationSize;ie++)U(W.location+ie,N/W.locationSize,Z,Tt,Gt*ut,(Ft+N/W.locationSize*ie)*ut,At)}else{if(xt.isInstancedBufferAttribute){for(let St=0;St<W.locationSize;St++)x(W.location+St,xt.meshPerAttribute);C.isInstancedMesh!==!0&&ot._maxInstanceCount===void 0&&(ot._maxInstanceCount=xt.meshPerAttribute*xt.count)}else for(let St=0;St<W.locationSize;St++)M(W.location+St);s.bindBuffer(s.ARRAY_BUFFER,Mt);for(let St=0;St<W.locationSize;St++)U(W.location+St,N/W.locationSize,Z,Tt,N*ut,N/W.locationSize*St*ut,At)}}else if(O!==void 0){const Tt=O[V];if(Tt!==void 0)switch(Tt.length){case 2:s.vertexAttrib2fv(W.location,Tt);break;case 3:s.vertexAttrib3fv(W.location,Tt);break;case 4:s.vertexAttrib4fv(W.location,Tt);break;default:s.vertexAttrib1fv(W.location,Tt)}}}}B()}function K(){j();for(const C in r){const H=r[C];for(const ct in H){const ot=H[ct];for(const gt in ot)g(ot[gt].object),delete ot[gt];delete H[ct]}delete r[C]}}function G(C){if(r[C.id]===void 0)return;const H=r[C.id];for(const ct in H){const ot=H[ct];for(const gt in ot)g(ot[gt].object),delete ot[gt];delete H[ct]}delete r[C.id]}function P(C){for(const H in r){const ct=r[H];if(ct[C.id]===void 0)continue;const ot=ct[C.id];for(const gt in ot)g(ot[gt].object),delete ot[gt];delete ct[C.id]}}function j(){D(),f=!0,c!==l&&(c=l,m(c.object))}function D(){l.geometry=null,l.program=null,l.wireframe=!1}return{setup:d,reset:j,resetDefaultState:D,dispose:K,releaseStatesOfGeometry:G,releaseStatesOfProgram:P,initAttributes:R,enableAttribute:M,disableUnusedAttributes:B}}function G1(s,t,i){let r;function l(m){r=m}function c(m,g){s.drawArrays(r,m,g),i.update(g,r,1)}function f(m,g,_){_!==0&&(s.drawArraysInstanced(r,m,g,_),i.update(g,r,_))}function d(m,g,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(r,m,0,g,0,_);let S=0;for(let E=0;E<_;E++)S+=g[E];i.update(S,r,1)}function p(m,g,_,y){if(_===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let E=0;E<m.length;E++)f(m[E],g[E],y[E]);else{S.multiDrawArraysInstancedWEBGL(r,m,0,g,0,y,0,_);let E=0;for(let R=0;R<_;R++)E+=g[R]*y[R];i.update(E,r,1)}}this.setMode=l,this.render=c,this.renderInstances=f,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function V1(s,t,i,r){let l;function c(){if(l!==void 0)return l;if(t.has("EXT_texture_filter_anisotropic")===!0){const P=t.get("EXT_texture_filter_anisotropic");l=s.getParameter(P.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else l=0;return l}function f(P){return!(P!==Mi&&r.convert(P)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_FORMAT))}function d(P){const j=P===Yo&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(P!==ca&&r.convert(P)!==s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE)&&P!==sa&&!j)}function p(P){if(P==="highp"){if(s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.HIGH_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.HIGH_FLOAT).precision>0)return"highp";P="mediump"}return P==="mediump"&&s.getShaderPrecisionFormat(s.VERTEX_SHADER,s.MEDIUM_FLOAT).precision>0&&s.getShaderPrecisionFormat(s.FRAGMENT_SHADER,s.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let m=i.precision!==void 0?i.precision:"highp";const g=p(m);g!==m&&(console.warn("THREE.WebGLRenderer:",m,"not supported, using",g,"instead."),m=g);const _=i.logarithmicDepthBuffer===!0,y=i.reverseDepthBuffer===!0&&t.has("EXT_clip_control"),S=s.getParameter(s.MAX_TEXTURE_IMAGE_UNITS),E=s.getParameter(s.MAX_VERTEX_TEXTURE_IMAGE_UNITS),R=s.getParameter(s.MAX_TEXTURE_SIZE),M=s.getParameter(s.MAX_CUBE_MAP_TEXTURE_SIZE),x=s.getParameter(s.MAX_VERTEX_ATTRIBS),B=s.getParameter(s.MAX_VERTEX_UNIFORM_VECTORS),U=s.getParameter(s.MAX_VARYING_VECTORS),w=s.getParameter(s.MAX_FRAGMENT_UNIFORM_VECTORS),K=E>0,G=s.getParameter(s.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:c,getMaxPrecision:p,textureFormatReadable:f,textureTypeReadable:d,precision:m,logarithmicDepthBuffer:_,reverseDepthBuffer:y,maxTextures:S,maxVertexTextures:E,maxTextureSize:R,maxCubemapSize:M,maxAttributes:x,maxVertexUniforms:B,maxVaryings:U,maxFragmentUniforms:w,vertexTextures:K,maxSamples:G}}function k1(s){const t=this;let i=null,r=0,l=!1,c=!1;const f=new vr,d=new le,p={value:null,needsUpdate:!1};this.uniform=p,this.numPlanes=0,this.numIntersection=0,this.init=function(_,y){const S=_.length!==0||y||r!==0||l;return l=y,r=_.length,S},this.beginShadows=function(){c=!0,g(null)},this.endShadows=function(){c=!1},this.setGlobalState=function(_,y){i=g(_,y,0)},this.setState=function(_,y,S){const E=_.clippingPlanes,R=_.clipIntersection,M=_.clipShadows,x=s.get(_);if(!l||E===null||E.length===0||c&&!M)c?g(null):m();else{const B=c?0:r,U=B*4;let w=x.clippingState||null;p.value=w,w=g(E,y,U,S);for(let K=0;K!==U;++K)w[K]=i[K];x.clippingState=w,this.numIntersection=R?this.numPlanes:0,this.numPlanes+=B}};function m(){p.value!==i&&(p.value=i,p.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function g(_,y,S,E){const R=_!==null?_.length:0;let M=null;if(R!==0){if(M=p.value,E!==!0||M===null){const x=S+R*4,B=y.matrixWorldInverse;d.getNormalMatrix(B),(M===null||M.length<x)&&(M=new Float32Array(x));for(let U=0,w=S;U!==R;++U,w+=4)f.copy(_[U]).applyMatrix4(B,d),f.normal.toArray(M,w),M[w+3]=f.constant}p.value=M,p.needsUpdate=!0}return t.numPlanes=R,t.numIntersection=0,M}}function X1(s){let t=new WeakMap;function i(f,d){return d===jh?f.mapping=Cs:d===Zh&&(f.mapping=ws),f}function r(f){if(f&&f.isTexture){const d=f.mapping;if(d===jh||d===Zh)if(t.has(f)){const p=t.get(f).texture;return i(p,f.mapping)}else{const p=f.image;if(p&&p.height>0){const m=new pM(p.height);return m.fromEquirectangularTexture(s,f),t.set(f,m),f.addEventListener("dispose",l),i(m.texture,f.mapping)}else return null}}return f}function l(f){const d=f.target;d.removeEventListener("dispose",l);const p=t.get(d);p!==void 0&&(t.delete(d),p.dispose())}function c(){t=new WeakMap}return{get:r,dispose:c}}const Es=4,gv=[.125,.215,.35,.446,.526,.582],Sr=20,Uh=new T0,_v=new we;let Lh=null,Nh=0,Oh=0,Ph=!1;const xr=(1+Math.sqrt(5))/2,ys=1/xr,vv=[new Q(-xr,ys,0),new Q(xr,ys,0),new Q(-ys,0,xr),new Q(ys,0,xr),new Q(0,xr,-ys),new Q(0,xr,ys),new Q(-1,1,-1),new Q(1,1,-1),new Q(-1,1,1),new Q(1,1,1)];class xv{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,i=0,r=.1,l=100){Lh=this._renderer.getRenderTarget(),Nh=this._renderer.getActiveCubeFace(),Oh=this._renderer.getActiveMipmapLevel(),Ph=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(256);const c=this._allocateTargets();return c.depthBuffer=!0,this._sceneToCubeUV(t,r,l,c),i>0&&this._blur(c,0,0,i),this._applyPMREM(c),this._cleanup(c),c}fromEquirectangular(t,i=null){return this._fromTexture(t,i)}fromCubemap(t,i=null){return this._fromTexture(t,i)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Mv(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Sv(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(Lh,Nh,Oh),this._renderer.xr.enabled=Ph,t.scissorTest=!1,Dc(t,0,0,t.width,t.height)}_fromTexture(t,i){t.mapping===Cs||t.mapping===ws?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),Lh=this._renderer.getRenderTarget(),Nh=this._renderer.getActiveCubeFace(),Oh=this._renderer.getActiveMipmapLevel(),Ph=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const r=i||this._allocateTargets();return this._textureToCubeUV(t,r),this._applyPMREM(r),this._cleanup(r),r}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),i=4*this._cubeSize,r={magFilter:Ui,minFilter:Ui,generateMipmaps:!1,type:Yo,format:Mi,colorSpace:Ls,depthBuffer:!1},l=yv(t,i,r);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==i){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=yv(t,i,r);const{_lodMax:c}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=W1(c)),this._blurMaterial=q1(c,t,i)}return l}_compileMaterial(t){const i=new Xn(this._lodPlanes[0],t);this._renderer.compile(i,Uh)}_sceneToCubeUV(t,i,r,l){const d=new fi(90,1,i,r),p=[1,-1,1,1,1,1],m=[1,1,1,-1,-1,-1],g=this._renderer,_=g.autoClear,y=g.toneMapping;g.getClearColor(_v),g.toneMapping=ka,g.autoClear=!1;const S=new Io({name:"PMREM.Background",side:Wn,depthWrite:!1,depthTest:!1}),E=new Xn(new zs,S);let R=!1;const M=t.background;M?M.isColor&&(S.color.copy(M),t.background=null,R=!0):(S.color.copy(_v),R=!0);for(let x=0;x<6;x++){const B=x%3;B===0?(d.up.set(0,p[x],0),d.lookAt(m[x],0,0)):B===1?(d.up.set(0,0,p[x]),d.lookAt(0,m[x],0)):(d.up.set(0,p[x],0),d.lookAt(0,0,m[x]));const U=this._cubeSize;Dc(l,B*U,x>2?U:0,U,U),g.setRenderTarget(l),R&&g.render(E,d),g.render(t,d)}E.geometry.dispose(),E.material.dispose(),g.toneMapping=y,g.autoClear=_,t.background=M}_textureToCubeUV(t,i){const r=this._renderer,l=t.mapping===Cs||t.mapping===ws;l?(this._cubemapMaterial===null&&(this._cubemapMaterial=Mv()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Sv());const c=l?this._cubemapMaterial:this._equirectMaterial,f=new Xn(this._lodPlanes[0],c),d=c.uniforms;d.envMap.value=t;const p=this._cubeSize;Dc(i,0,0,3*p,2*p),r.setRenderTarget(i),r.render(f,Uh)}_applyPMREM(t){const i=this._renderer,r=i.autoClear;i.autoClear=!1;const l=this._lodPlanes.length;for(let c=1;c<l;c++){const f=Math.sqrt(this._sigmas[c]*this._sigmas[c]-this._sigmas[c-1]*this._sigmas[c-1]),d=vv[(l-c-1)%vv.length];this._blur(t,c-1,c,f,d)}i.autoClear=r}_blur(t,i,r,l,c){const f=this._pingPongRenderTarget;this._halfBlur(t,f,i,r,l,"latitudinal",c),this._halfBlur(f,t,r,r,l,"longitudinal",c)}_halfBlur(t,i,r,l,c,f,d){const p=this._renderer,m=this._blurMaterial;f!=="latitudinal"&&f!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const g=3,_=new Xn(this._lodPlanes[l],m),y=m.uniforms,S=this._sizeLods[r]-1,E=isFinite(c)?Math.PI/(2*S):2*Math.PI/(2*Sr-1),R=c/E,M=isFinite(c)?1+Math.floor(g*R):Sr;M>Sr&&console.warn(`sigmaRadians, ${c}, is too large and will clip, as it requested ${M} samples when the maximum is set to ${Sr}`);const x=[];let B=0;for(let P=0;P<Sr;++P){const j=P/R,D=Math.exp(-j*j/2);x.push(D),P===0?B+=D:P<M&&(B+=2*D)}for(let P=0;P<x.length;P++)x[P]=x[P]/B;y.envMap.value=t.texture,y.samples.value=M,y.weights.value=x,y.latitudinal.value=f==="latitudinal",d&&(y.poleAxis.value=d);const{_lodMax:U}=this;y.dTheta.value=E,y.mipInt.value=U-r;const w=this._sizeLods[l],K=3*w*(l>U-Es?l-U+Es:0),G=4*(this._cubeSize-w);Dc(i,K,G,3*w,2*w),p.setRenderTarget(i),p.render(_,Uh)}}function W1(s){const t=[],i=[],r=[];let l=s;const c=s-Es+1+gv.length;for(let f=0;f<c;f++){const d=Math.pow(2,l);i.push(d);let p=1/d;f>s-Es?p=gv[f-s+Es-1]:f===0&&(p=0),r.push(p);const m=1/(d-2),g=-m,_=1+m,y=[g,g,_,g,_,_,g,g,_,_,g,_],S=6,E=6,R=3,M=2,x=1,B=new Float32Array(R*E*S),U=new Float32Array(M*E*S),w=new Float32Array(x*E*S);for(let G=0;G<S;G++){const P=G%3*2/3-1,j=G>2?0:-1,D=[P,j,0,P+2/3,j,0,P+2/3,j+1,0,P,j,0,P+2/3,j+1,0,P,j+1,0];B.set(D,R*E*G),U.set(y,M*E*G);const C=[G,G,G,G,G,G];w.set(C,x*E*G)}const K=new ua;K.setAttribute("position",new Li(B,R)),K.setAttribute("uv",new Li(U,M)),K.setAttribute("faceIndex",new Li(w,x)),t.push(K),l>Es&&l--}return{lodPlanes:t,sizeLods:i,sigmas:r}}function yv(s,t,i){const r=new Ar(s,t,i);return r.texture.mapping=Gc,r.texture.name="PMREM.cubeUv",r.scissorTest=!0,r}function Dc(s,t,i,r,l){s.viewport.set(t,i,r,l),s.scissor.set(t,i,r,l)}function q1(s,t,i){const r=new Float32Array(Sr),l=new Q(0,1,0);return new Wa({name:"SphericalGaussianBlur",defines:{n:Sr,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Vd(),fragmentShader:`
	...
	`}function Y1(s){let t=new WeakMap,i=null;function r(d){if(d&&d.isTexture){const p=d.mapping,m=p===jh||p===Zh,g=p===Cs||p===ws;if(m||g){let _=t.get(d);const y=_!==void 0?_.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==y)return i===null&&(i=new xv(s)),_=m?i.fromEquirectangular(d,_):i.fromCubemap(d,_),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),_.texture;if(_!==void 0)return _.texture;{const S=d.image;return m&&S&&S.height>0||g&&S&&l(S)?(i===null&&(i=new xv(s)),_=m?i.fromEquirectangular(d):i.fromCubemap(d),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),d.addEventListener("dispose",c),_.texture):null}}}return d}function l(d){let p=0;const m=6;for(let g=0;g<m;g++)d[g]!==void 0&&p++;return p===m}function c(d){const p=d.target;p.removeEventListener("dispose",c);const m=t.get(p);m!==void 0&&(t.delete(p),m.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function j1(s){const t={};function i(r){if(t[r]!==void 0)return t[r];let l;switch(r){case"WEBGL_depth_texture":l=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=s.getExtension(r)}return t[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&Ss("THREE.WebGLRenderer: "+r+" extension not supported."),l}}}function Z1(s,t,i,r){const l={},c=new WeakMap;function f(_){const y=_.target;y.index!==null&&t.remove(y.index);for(const E in y.attributes)t.remove(y.attributes[E]);y.removeEventListener("dispose",f),delete l[y.id];const S=c.get(y);S&&(t.remove(S),c.delete(y)),r.releaseStatesOfGeometry(y),y.isInstancedBufferGeometry===!0&&delete y._maxInstanceCount,i.memory.geometries--}function d(_,y){return l[y.id]===!0||(y.addEventListener("dispose",f),l[y.id]=!0,i.memory.geometries++),y}function p(_){const y=_.attributes;for(const S in y)t.update(y[S],s.ARRAY_BUFFER)}function m(_){const y=[],S=_.index,E=_.attributes.position;let R=0;if(S!==null){const B=S.array;R=S.version;for(let U=0,w=B.length;U<w;U+=3){const K=B[U+0],G=B[U+1],P=B[U+2];y.push(K,G,G,P,P,K)}}else if(E!==void 0){const B=E.array;R=E.version;for(let U=0,w=B.length/3-1;U<w;U+=3){const K=U+0,G=U+1,P=U+2;y.push(K,G,G,P,P,K)}}else return;const M=new(a0(y)?u0:c0)(y,1);M.version=R;const x=c.get(_);x&&t.remove(x),c.set(_,M)}function g(_){const y=c.get(_);if(y){const S=_.index;S!==null&&y.version<S.version&&m(_)}else m(_);return c.get(_)}return{get:d,update:p,getWireframeAttribute:g}}function K1(s,t,i){let r;function l(y){r=y}let c,f;function d(y){c=y.type,f=y.bytesPerElement}function p(y,S){s.drawElements(r,S,c,y*f),i.update(S,r,1)}function m(y,S,E){E!==0&&(s.drawElementsInstanced(r,S,c,y*f,E),i.update(S,r,E))}function g(y,S,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,S,0,c,y,0,E);let M=0;for(let x=0;x<E;x++)M+=S[x];i.update(M,r,1)}function _(y,S,E,R){if(E===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let x=0;x<y.length;x++)m(y[x]/f,S[x],R[x]);else{M.multiDrawElementsInstancedWEBGL(r,S,0,c,y,0,R,0,E);let x=0;for(let B=0;B<E;B++)x+=S[B]*R[B];i.update(x,r,1)}}this.setMode=l,this.setIndex=d,this.render=p,this.renderInstances=m,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function Q1(s){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,f,d){switch(i.calls++,f){case s.TRIANGLES:i.triangles+=d*(c/3);break;case s.LINES:i.lines+=d*(c/2);break;case s.LINE_STRIP:i.lines+=d*(c-1);break;case s.LINE_LOOP:i.lines+=d*c;break;case s.POINTS:i.points+=d*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:r}}function J1(s,t,i){const r=new WeakMap,l=new $e;function c(f,d,p){const m=f.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,_=g!==void 0?g.length:0;let y=r.get(d);if(y===void 0||y.count!==_){let C=function(){j.dispose(),r.delete(d),d.removeEventListener("dispose",C)};var S=C;y!==void 0&&y.texture.dispose();const E=d.morphAttributes.position!==void 0,R=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,x=d.morphAttributes.position||[],B=d.morphAttributes.normal||[],U=d.morphAttributes.color||[];let w=0;E===!0&&(w=1),R===!0&&(w=2),M===!0&&(w=3);let K=d.attributes.position.count*w,G=1;K>t.maxTextureSize&&(G=Math.ceil(K/t.maxTextureSize),K=t.maxTextureSize);const P=new Float32Array(K*G*4*_),j=new s0(P,K,G,_);j.type=sa,j.needsUpdate=!0;const D=w*4;for(let H=0;H<_;H++){const ct=x[H],ot=B[H],gt=U[H],tt=K*G*4*H;for(let O=0;O<ct.count;O++){const V=O*D;E===!0&&(l.fromBufferAttribute(ct,O),P[tt+V+0]=l.x,P[tt+V+1]=l.y,P[tt+V+2]=l.z,P[tt+V+3]=0),R===!0&&(l.fromBufferAttribute(ot,O),P[tt+V+4]=l.x,P[tt+V+5]=l.y,P[tt+V+6]=l.z,P[tt+V+7]=0),M===!0&&(l.fromBufferAttribute(gt,O),P[tt+V+8]=l.x,P[tt+V+9]=l.y,P[tt+V+10]=l.z,P[tt+V+11]=gt.itemSize===4?l.w:1)}}y={count:_,texture:j,size:new qt(K,G)},r.set(d,y),d.addEventListener("dispose",C)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",f.morphTexture,i);else{let E=0;for(let M=0;M<m.length;M++)E+=m[M];const R=d.morphTargetsRelative?1:1-E;p.getUniforms().setValue(s,"morphTargetBaseInfluence",R),p.getUniforms().setValue(s,"morphTargetInfluences",m)}p.getUniforms().setValue(s,"morphTargetsTexture",y.texture,i),p.getUniforms().setValue(s,"morphTargetsTextureSize",y.size)}return{update:c}}function $1(s,t,i,r){let l=new WeakMap;function c(p){const m=r.render.frame,g=p.geometry,_=t.get(p,g);if(l.get(_)!==m&&(t.update(_),l.set(_,m)),p.isInstancedMesh&&(p.hasEventListener("dispose",d)===!1&&p.addEventListener("dispose",d),l.get(p)!==m&&(i.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,s.ARRAY_BUFFER),l.set(p,m))),p.isSkinnedMesh){const y=p.skeleton;l.get(y)!==m&&(y.update(),l.set(y,m))}return _}function f(){l=new WeakMap}function d(p){const m=p.target;m.removeEventListener("dispose",d),i.remove(m.instanceMatrix),m.instanceColor!==null&&i.remove(m.instanceColor)}return{update:c,dispose:f}}const b0=new On,Ev=new p0(1,1),R0=new s0,C0=new QS,w0=new d0,Tv=[],Av=[],bv=new Float32Array(16),Rv=new Float32Array(9),Cv=new Float32Array(4);function Bs(s,t,i){const r=s[0];if(r<=0||r>0)return s;const l=t*i;let c=Tv[l];if(c===void 0&&(c=new Float32Array(l),Tv[l]=c),t!==0){r.toArray(c,0);for(let f=1,d=0;f!==t;++f)d+=i,s[f].toArray(c,d)}return c}function dn(s,t){if(s.length!==t.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==t[i])return!1;return!0}function pn(s,t){for(let i=0,r=t.length;i<r;i++)s[i]=t[i]}function kc(s,t){let i=Av[t];i===void 0&&(i=new Int32Array(t),Av[t]=i);for(let r=0;r!==t;++r)i[r]=s.allocateTextureUnit();return i}function tA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1f(this.addr,t),i[0]=t)}function eA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(dn(i,t))return;s.uniform2fv(this.addr,t),pn(i,t)}}function nA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(dn(i,t))return;s.uniform3fv(this.addr,t),pn(i,t)}}function iA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(dn(i,t))return;s.uniform4fv(this.addr,t),pn(i,t)}}function aA(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(dn(i,t))return;s.uniformMatrix2fv(this.addr,!1,t),pn(i,t)}else{if(dn(i,r))return;Cv.set(r),s.uniformMatrix2fv(this.addr,!1,Cv),pn(i,r)}}function rA(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(dn(i,t))return;s.uniformMatrix3fv(this.addr,!1,t),pn(i,t)}else{if(dn(i,r))return;Rv.set(r),s.uniformMatrix3fv(this.addr,!1,Rv),pn(i,r)}}function sA(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(dn(i,t))return;s.uniformMatrix4fv(this.addr,!1,t),pn(i,t)}else{if(dn(i,r))return;bv.set(r),s.uniformMatrix4fv(this.addr,!1,bv),pn(i,r)}}function oA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1i(this.addr,t),i[0]=t)}function lA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(dn(i,t))return;s.uniform2iv(this.addr,t),pn(i,t)}}function cA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(dn(i,t))return;s.uniform3iv(this.addr,t),pn(i,t)}}function uA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(dn(i,t))return;s.uniform4iv(this.addr,t),pn(i,t)}}function fA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1ui(this.addr,t),i[0]=t)}function hA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(dn(i,t))return;s.uniform2uiv(this.addr,t),pn(i,t)}}function dA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(dn(i,t))return;s.uniform3uiv(this.addr,t),pn(i,t)}}function pA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(dn(i,t))return;s.uniform4uiv(this.addr,t),pn(i,t)}}function mA(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let c;this.type===s.SAMPLER_2D_SHADOW?(Ev.compareFunction=i0,c=Ev):c=b0,i.setTexture2D(t||c,l)}function gA(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(t||C0,l)}function _A(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(t||w0,l)}function vA(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(t||R0,l)}function xA(s){switch(s){case 5126:return tA;case 35664:return eA;case 35665:return nA;case 35666:return iA;case 35674:return aA;case 35675:return rA;case 35676:return sA;case 5124:case 35670:return oA;case 35667:case 35671:return lA;case 35668:case 35672:return cA;case 35669:case 35673:return uA;case 5125:return fA;case 36294:return hA;case 36295:return dA;case 36296:return pA;case 35678:case 36198:case 36298:case 36306:case 35682:return mA;case 35679:case 36299:case 36307:return gA;case 35680:case 36300:case 36308:case 36293:return _A;case 36289:case 36303:case 36311:case 36292:return vA}}function yA(s,t){s.uniform1fv(this.addr,t)}function SA(s,t){const i=Bs(t,this.size,2);s.uniform2fv(this.addr,i)}function MA(s,t){const i=Bs(t,this.size,3);s.uniform3fv(this.addr,i)}function EA(s,t){const i=Bs(t,this.size,4);s.uniform4fv(this.addr,i)}function TA(s,t){const i=Bs(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function AA(s,t){const i=Bs(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function bA(s,t){const i=Bs(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function RA(s,t){s.uniform1iv(this.addr,t)}function CA(s,t){s.uniform2iv(this.addr,t)}function wA(s,t){s.uniform3iv(this.addr,t)}function DA(s,t){s.uniform4iv(this.addr,t)}function UA(s,t){s.uniform1uiv(this.addr,t)}function LA(s,t){s.uniform2uiv(this.addr,t)}function NA(s,t){s.uniform3uiv(this.addr,t)}function OA(s,t){s.uniform4uiv(this.addr,t)}function PA(s,t,i){const r=this.cache,l=t.length,c=kc(i,l);dn(r,c)||(s.uniform1iv(this.addr,c),pn(r,c));for(let f=0;f!==l;++f)i.setTexture2D(t[f]||b0,c[f])}function zA(s,t,i){const r=this.cache,l=t.length,c=kc(i,l);dn(r,c)||(s.uniform1iv(this.addr,c),pn(r,c));for(let f=0;f!==l;++f)i.setTexture3D(t[f]||C0,c[f])}function BA(s,t,i){const r=this.cache,l=t.length,c=kc(i,l);dn(r,c)||(s.uniform1iv(this.addr,c),pn(r,c));for(let f=0;f!==l;++f)i.setTextureCube(t[f]||w0,c[f])}function IA(s,t,i){const r=this.cache,l=t.length,c=kc(i,l);dn(r,c)||(s.uniform1iv(this.addr,c),pn(r,c));for(let f=0;f!==l;++f)i.setTexture2DArray(t[f]||R0,c[f])}function FA(s){switch(s){case 5126:return yA;case 35664:return SA;case 35665:return MA;case 35666:return EA;case 35674:return TA;case 35675:return AA;case 35676:return bA;case 5124:case 35670:return RA;case 35667:case 35671:return CA;case 35668:case 35672:return wA;case 35669:case 35673:return DA;case 5125:return UA;case 36294:return LA;case 36295:return NA;case 36296:return OA;case 35678:case 36198:case 36298:case 36306:case 35682:return PA;case 35679:case 36299:case 36307:return zA;case 35680:case 36300:case 36308:case 36293:return BA;case 36289:case 36303:case 36311:case 36292:return IA}}class HA{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.setValue=xA(i.type)}}class GA{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=FA(i.type)}}class VA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,r){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const d=l[c];d.setValue(t,i[d.id],r)}}}const zh=/(\w+)(\])?(\[|\.)?/g;function wv(s,t){s.seq.push(t),s.map[t.id]=t}function kA(s,t,i){const r=s.name,l=r.length;for(zh.lastIndex=0;;){const c=zh.exec(r),f=zh.lastIndex;let d=c[1];const p=c[2]==="]",m=c[3];if(p&&(d=d|0),m===void 0||m==="["&&f+2===l){wv(i,m===void 0?new HA(d,s,t):new GA(d,s,t));break}else{let _=i.map[d];_===void 0&&(_=new VA(d),wv(i,_)),i=_}}}class Bc{constructor(t,i){this.seq=[],this.map={};const r=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<r;++l){const c=t.getActiveUniform(i,l),f=t.getUniformLocation(i,c.name);kA(c,f,this)}}setValue(t,i,r,l){const c=this.map[i];c!==void 0&&c.setValue(t,r,l)}setOptional(t,i,r){const l=i[r];l!==void 0&&this.setValue(t,r,l)}static upload(t,i,r,l){for(let c=0,f=i.length;c!==f;++c){const d=i[c],p=r[d.id];p.needsUpdate!==!1&&d.setValue(t,p.value,l)}}static seqWithValue(t,i){const r=[];for(let l=0,c=t.length;l!==c;++l){const f=t[l];f.id in i&&r.push(f)}return r}}function Dv(s,t,i){const r=s.createShader(t);return s.shaderSource(r,i),s.compileShader(r),r}const XA=37297;let WA=0;function qA(s,t){const i=s.split(`
`),r=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let f=l;f<c;f++){const d=f+1;r.push(`${d===t?">":" "} ${d}: ${i[f]}`)}return r.join(`
`)}const Uv=new le;function YA(s){Re._getMatrix(Uv,Re.workingColorSpace,s);const t=`mat3( ${Uv.elements.map(i=>i.toFixed(4))} )`;switch(Re.getTransfer(s)){case Ic:return[t,"LinearTransferOETF"];case Ie:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function Lv(s,t,i){const r=s.getShaderParameter(t,s.COMPILE_STATUS),l=s.getShaderInfoLog(t).trim();if(r&&l==="")return"";const c=/ERROR: 0:(\d+)/.exec(l);if(c){const f=parseInt(c[1]);return i.toUpperCase()+`

`+l+`

`+qA(s.getShaderSource(t),f)}else return l}function jA(s,t){const i=YA(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function ZA(s,t){let i;switch(t){case ES:i="Linear";break;case TS:i="Reinhard";break;case AS:i="Cineon";break;case bS:i="ACESFilmic";break;case CS:i="AgX";break;case wS:i="Neutral";break;case RS:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Uc=new Q;function KA(){Re.getLuminanceCoefficients(Uc);const s=Uc.x.toFixed(4),t=Uc.y.toFixed(4),i=Uc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function QA(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Bo).join(`
`)}function JA(s){const t=[];for(const i in s){const r=s[i];r!==!1&&t.push("#define "+i+" "+r)}return t.join(`
`)}function $A(s,t){const i={},r=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const c=s.getActiveAttrib(t,l),f=c.name;let d=1;c.type===s.FLOAT_MAT2&&(d=2),c.type===s.FLOAT_MAT3&&(d=3),c.type===s.FLOAT_MAT4&&(d=4),i[f]={type:c.type,location:s.getAttribLocation(t,f),locationSize:d}}return i}function Bo(s){return s!==""}function Nv(s,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ov(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const tb=/^[ \t]*#include +<([\w\d./]+)>/gm;function Rd(s){return s.replace(tb,nb)}const eb=new Map;function nb(s,t){let i=ce[t];if(i===void 0){const r=eb.get(t);if(r!==void 0)i=ce[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,r);else throw new Error("Can not resolve #include <"+t+">")}return Rd(i)}const ib=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Pv(s){return s.replace(ib,ab)}function ab(s,t,i,r){let l="";for(let c=parseInt(t);c<parseInt(i);c++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function zv(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function rb(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===kv?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===nS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ra&&(t="SHADOWMAP_TYPE_VSM"),t}function sb(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Cs:case ws:t="ENVMAP_TYPE_CUBE";break;case Gc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ob(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ws:t="ENVMAP_MODE_REFRACTION";break}return t}function lb(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Xv:t="ENVMAP_BLENDING_MULTIPLY";break;case SS:t="ENVMAP_BLENDING_MIX";break;case MS:t="ENVMAP_BLENDING_ADD";break}return t}function cb(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function ub(s,t,i,r){const l=s.getContext(),c=i.defines;let f=i.vertexShader,d=i.fragmentShader;const p=rb(i),m=sb(i),g=ob(i),_=lb(i),y=cb(i),S=QA(i),E=JA(c),R=l.createProgram();let M,x,B=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+x);const U=B+M+f,w=B+x+d,K=Dv(l,l.VERTEX_SHADER,U),G=Dv(l,l.FRAGMENT_SHADER,w);l.attachShader(R,K),l.attachShader(R,G),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function P(H){if(s.debug.checkShaderErrors){const ct=l.getProgramInfoLog(R).trim(),ot=l.getShaderInfoLog(K).trim(),gt=l.getShaderInfoLog(G).trim();let tt=!0,O=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(tt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,R,K,G);else{const V=Lv(l,K,"vertex"),W=Lv(l,G,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
...
Program Info Log: `+ct+`
`+V+`
`+W)}else ct!==""?console.warn("THREE.WebGLProgram: Program Info Log:",ct):(ot===""||gt==="")&&(O=!1);O&&(H.diagnostics={runnable:tt,programLog:ct,vertexShader:{log:ot,prefix:M},fragmentShader:{log:gt,prefix:x}})}l.deleteShader(K),l.deleteShader(G),j=new Bc(l,R),D=$A(l,R)}let j;this.getUniforms=function(){return j===void 0&&P(this),j};let D;this.getAttributes=function(){return D===void 0&&P(this),D};let C=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return C===!1&&(C=l.getProgramParameter(R,XA)),C},this.destroy=function(){r.releaseStatesOfProgram(this),l.deleteProgram(R),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=WA++,this.cacheKey=t,this.usedTimes=1,this.program=R,this.vertexShader=K,this.fragmentShader=G,this}let fb=0;class hb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,r=t.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(r),f=this._getShaderCacheForMaterial(t);return f.has(l)===!1&&(f.add(l),l.usedTimes++),f.has(c)===!1&&(f.add(c),c.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const r of i)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let r=i.get(t);return r===void 0&&(r=new Set,i.set(t,r)),r}_getShaderStage(t){const i=this.shaderCache;let r=i.get(t);return r===void 0&&(r=new db(t),i.set(t,r)),r}}class db{constructor(t){this.id=fb++,this.code=t,this.usedTimes=0}}function pb(s,t,i,r,l,c,f){const d=new o0,p=new hb,m=new Set,g=[],_=l.logarithmicDepthBuffer,y=l.vertexTextures;let S=l.precision;const E={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function R(D){return m.add(D),D===0?"uv":`uv${D}`}function M(D,C,H,ct,ot){const gt=ct.fog,tt=ot.geometry,O=D.isMeshStandardMaterial?ct.environment:null,V=(D.isMeshStandardMaterial?i:t).get(D.envMap||O),W=V&&V.mapping===Gc?V.image.height:null,xt=E[D.type];D.precision!==null&&(S=l.getMaxPrecision(D.precision),S!==D.precision&&console.warn("THREE.WebGLProgram.getParameters:",D.precision,"not supported, using",S,"instead."));const Tt=tt.morphAttributes.position||tt.morphAttributes.normal||tt.morphAttributes.color,N=Tt!==void 0?Tt.length:0;let it=0;tt.morphAttributes.position!==void 0&&(it=1),tt.morphAttributes.normal!==void 0&&(it=2),tt.morphAttributes.color!==void 0&&(it=3);let Mt,Z,ut,At;if(xt){const Me=Di[xt];Mt=Me.vertexShader,Z=Me.fragmentShader}else Mt=D.vertexShader,Z=D.fragmentShader,p.update(D),ut=p.getVertexShaderID(D),At=p.getFragmentShaderID(D);const St=s.getRenderTarget(),Gt=s.state.buffers.depth.getReversed(),Ft=ot.isInstancedMesh===!0,ie=ot.isBatchedMesh===!0,Ne=!!D.map,fe=!!D.matcap,Xe=!!V,I=!!D.aoMap,Tn=!!D.lightMap,ue=!!D.bumpMap,ge=!!D.normalMap,Yt=!!D.displacementMap,De=!!D.emissiveMap,Wt=!!D.metalnessMap,L=!!D.roughnessMap,A=D.anisotropy>0,nt=D.clearcoat>0,ht=D.dispersion>0,Et=D.iridescence>0,pt=D.sheen>0,kt=D.transmission>0,wt=A&&!!D.anisotropyMap,zt=nt&&!!D.clearcoatMap,_e=nt&&!!D.clearcoatNormalMap,bt=nt&&!!D.clearcoatRoughnessMap,Bt=Et&&!!D.iridescenceMap,jt=Et&&!!D.iridescenceThicknessMap,Xt=pt&&!!D.sheenColorMap,Nt=pt&&!!D.sheenRoughnessMap,$t=!!D.specularMap,ae=!!D.specularColorMap,Oe=!!D.specularIntensityMap,k=kt&&!!D.transmissionMap,Rt=kt&&!!D.thicknessMap,lt=!!D.gradientMap,_t=!!D.alphaMap,Ct=D.alphaTest>0,Dt=!!D.alphaHash,te=!!D.extensions;let We=ka;D.toneMapped&&(St===null||St.isXRRenderTarget===!0)&&(We=s.toneMapping);const un={shaderID:xt,shaderType:D.type,shaderName:D.name,vertexShader:Mt,fragmentShader:Z,defines:D.defines,customVertexShaderID:ut,customFragmentShaderID:At,isRawShaderMaterial:D.isRawShaderMaterial===!0,glslVersion:D.glslVersion,precision:S,batching:ie,batchingColor:ie&&ot._colorsTexture!==null,instancing:Ft,instancingColor:Ft&&ot.instanceColor!==null,instancingMorph:Ft&&ot.morphTexture!==null,supportsVertexTextures:y,outputColorSpace:St===null?s.outputColorSpace:St.isXRRenderTarget===!0?St.texture.colorSpace:Ls,alphaToCoverage:!!D.alphaToCoverage,map:Ne,matcap:fe,envMap:Xe,envMapMode:Xe&&V.mapping,envMapCubeUVHeight:W,aoMap:I,lightMap:Tn,bumpMap:ue,normalMap:ge,displacementMap:y&&Yt,emissiveMap:De,normalMapObjectSpace:ge&&D.normalMapType===NS,normalMapTangentSpace:ge&&D.normalMapType===n0,metalnessMap:Wt,roughnessMap:L,anisotropy:A,anisotropyMap:wt,clearcoat:nt,clearcoatMap:zt,clearcoatNormalMap:_e,clearcoatRoughnessMap:bt,dispersion:ht,iridescence:Et,iridescenceMap:Bt,iridescenceThicknessMap:jt,sheen:pt,sheenColorMap:Xt,sheenRoughnessMap:Nt,specularMap:$t,specularColorMap:ae,specularIntensityMap:Oe,transmission:kt,transmissionMap:k,thicknessMap:Rt,gradientMap:lt,opaque:D.transparent===!1&&D.blending===Ts&&D.alphaToCoverage===!1,alphaMap:_t,alphaTest:Ct,alphaHash:Dt,combine:D.combine,mapUv:Ne&&R(D.map.channel),aoMapUv:I&&R(D.aoMap.channel),lightMapUv:Tn&&R(D.lightMap.channel),bumpMapUv:ue&&R(D.bumpMap.channel),normalMapUv:ge&&R(D.normalMap.channel),displacementMapUv:Yt&&R(D.displacementMap.channel),emissiveMapUv:De&&R(D.emissiveMap.channel),metalnessMapUv:Wt&&R(D.metalnessMap.channel),roughnessMapUv:L&&R(D.roughnessMap.channel),anisotropyMapUv:wt&&R(D.anisotropyMap.channel),clearcoatMapUv:zt&&R(D.clearcoatMap.channel),clearcoatNormalMapUv:_e&&R(D.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:bt&&R(D.clearcoatRoughnessMap.channel),iridescenceMapUv:Bt&&R(D.iridescenceMap.channel),iridescenceThicknessMapUv:jt&&R(D.iridescenceThicknessMap.channel),sheenColorMapUv:Xt&&R(D.sheenColorMap.channel),sheenRoughnessMapUv:Nt&&R(D.sheenRoughnessMap.channel),specularMapUv:$t&&R(D.specularMap.channel),specularColorMapUv:ae&&R(D.specularColorMap.channel),specularIntensityMapUv:Oe&&R(D.specularIntensityMap.channel),transmissionMapUv:k&&R(D.transmissionMap.channel),thicknessMapUv:Rt&&R(D.thicknessMap.channel),alphaMapUv:_t&&R(D.alphaMap.channel),vertexTangents:!!tt.attributes.tangent&&(ge||A),vertexColors:D.vertexColors,vertexAlphas:D.vertexColors===!0&&!!tt.attributes.color&&tt.attributes.color.itemSize===4,pointsUvs:ot.isPoints===!0&&!!tt.attributes.uv&&(Ne||_t),fog:!!gt,useFog:D.fog===!0,fogExp2:!!gt&&gt.isFogExp2,flatShading:D.flatShading===!0,sizeAttenuation:D.sizeAttenuation===!0,logarithmicDepthBuffer:_,reverseDepthBuffer:Gt,skinning:ot.isSkinnedMesh===!0,morphTargets:tt.morphAttributes.position!==void 0,morphNormals:tt.morphAttributes.normal!==void 0,morphColors:tt.morphAttributes.color!==void 0,morphTargetsCount:N,morphTextureStride:it,numDirLights:C.directional.length,numPointLights:C.point.length,numSpotLights:C.spot.length,numSpotLightMaps:C.spotLightMap.length,numRectAreaLights:C.rectArea.length,numHemiLights:C.hemi.length,numDirLightShadows:C.directionalShadowMap.length,numPointLightShadows:C.pointShadowMap.length,numSpotLightShadows:C.spotShadowMap.length,numSpotLightShadowsWithMaps:C.numSpotLightShadowsWithMaps,numLightProbes:C.numLightProbes,numClippingPlanes:f.numPlanes,numClipIntersection:f.numIntersection,dithering:D.dithering,shadowMapEnabled:s.shadowMap.enabled&&H.length>0,shadowMapType:s.shadowMap.type,toneMapping:We,decodeVideoTexture:Ne&&D.map.isVideoTexture===!0&&Re.getTransfer(D.map.colorSpace)===Ie,decodeVideoTextureEmissive:De&&D.emissiveMap.isVideoTexture===!0&&Re.getTransfer(D.emissiveMap.colorSpace)===Ie,premultipliedAlpha:D.premultipliedAlpha,doubleSided:D.side===hi,flipSided:D.side===Wn,useDepthPacking:D.depthPacking>=0,depthPacking:D.depthPacking||0,index0AttributeName:D.index0AttributeName,extensionClipCullDistance:te&&D.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(te&&D.extensions.multiDraw===!0||ie)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:D.customProgramCacheKey()};return un.vertexUv1s=m.has(1),un.vertexUv2s=m.has(2),un.vertexUv3s=m.has(3),m.clear(),un}function x(D){const C=[];if(D.shaderID?C.push(D.shaderID):(C.push(D.customVertexShaderID),C.push(D.customFragmentShaderID)),D.defines!==void 0)for(const H in D.defines)C.push(H),C.push(D.defines[H]);return D.isRawShaderMaterial===!1&&(B(C,D),U(C,D),C.push(s.outputColorSpace)),C.push(D.customProgramCacheKey),C.join()}function B(D,C){D.push(C.precision),D.push(C.outputColorSpace),D.push(C.envMapMode),D.push(C.envMapCubeUVHeight),D.push(C.mapUv),D.push(C.alphaMapUv),D.push(C.lightMapUv),D.push(C.aoMapUv),D.push(C.bumpMapUv),D.push(C.normalMapUv),D.push(C.displacementMapUv),D.push(C.emissiveMapUv),D.push(C.metalnessMapUv),D.push(C.roughnessMapUv),D.push(C.anisotropyMapUv),D.push(C.clearcoatMapUv),D.push(C.clearcoatNormalMapUv),D.push(C.clearcoatRoughnessMapUv),D.push(C.iridescenceMapUv),D.push(C.iridescenceThicknessMapUv),D.push(C.sheenColorMapUv),D.push(C.sheenRoughnessMapUv),D.push(C.specularMapUv),D.push(C.specularColorMapUv),D.push(C.specularIntensityMapUv),D.push(C.transmissionMapUv),D.push(C.thicknessMapUv),D.push(C.combine),D.push(C.fogExp2),D.push(C.sizeAttenuation),D.push(C.morphTargetsCount),D.push(C.morphAttributeCount),D.push(C.numDirLights),D.push(C.numPointLights),D.push(C.numSpotLights),D.push(C.numSpotLightMaps),D.push(C.numHemiLights),D.push(C.numRectAreaLights),D.push(C.numDirLightShadows),D.push(C.numPointLightShadows),D.push(C.numSpotLightShadows),D.push(C.numSpotLightShadowsWithMaps),D.push(C.numLightProbes),D.push(C.shadowMapType),D.push(C.toneMapping),D.push(C.numClippingPlanes),D.push(C.numClipIntersection),D.push(C.depthPacking)}function U(D,C){d.disableAll(),C.supportsVertexTextures&&d.enable(0),C.instancing&&d.enable(1),C.instancingColor&&d.enable(2),C.instancingMorph&&d.enable(3),C.matcap&&d.enable(4),C.envMap&&d.enable(5),C.normalMapObjectSpace&&d.enable(6),C.normalMapTangentSpace&&d.enable(7),C.clearcoat&&d.enable(8),C.iridescence&&d.enable(9),C.alphaTest&&d.enable(10),C.vertexColors&&d.enable(11),C.vertexAlphas&&d.enable(12),C.vertexUv1s&&d.enable(13),C.vertexUv2s&&d.enable(14),C.vertexUv3s&&d.enable(15),C.vertexTangents&&d.enable(16),C.anisotropy&&d.enable(17),C.alphaHash&&d.enable(18),C.batching&&d.enable(19),C.dispersion&&d.enable(20),C.batchingColor&&d.enable(21),D.push(d.mask),d.disableAll(),C.fog&&d.enable(0),C.useFog&&d.enable(1),C.flatShading&&d.enable(2),C.logarithmicDepthBuffer&&d.enable(3),C.reverseDepthBuffer&&d.enable(4),C.skinning&&d.enable(5),C.morphTargets&&d.enable(6),C.morphNormals&&d.enable(7),C.morphColors&&d.enable(8),C.premultipliedAlpha&&d.enable(9),C.shadowMapEnabled&&d.enable(10),C.doubleSided&&d.enable(11),C.flipSided&&d.enable(12),C.useDepthPacking&&d.enable(13),C.dithering&&d.enable(14),C.transmission&&d.enable(15),C.sheen&&d.enable(16),C.opaque&&d.enable(17),C.pointsUvs&&d.enable(18),C.decodeVideoTexture&&d.enable(19),C.decodeVideoTextureEmissive&&d.enable(20),C.alphaToCoverage&&d.enable(21),D.push(d.mask)}function w(D){const C=E[D.type];let H;if(C){const ct=Di[C];H=uM.clone(ct.uniforms)}else H=D.uniforms;return H}function K(D,C){let H;for(let ct=0,ot=g.length;ct<ot;ct++){const gt=g[ct];if(gt.cacheKey===C){H=gt,++H.usedTimes;break}}return H===void 0&&(H=new ub(s,C,D,c),g.push(H)),H}function G(D){if(--D.usedTimes===0){const C=g.indexOf(D);g[C]=g[g.length-1],g.pop(),D.destroy()}}function P(D){p.remove(D)}function j(){p.dispose()}return{getParameters:M,getProgramCacheKey:x,getUniforms:w,acquireProgram:K,releaseProgram:G,releaseShaderCache:P,programs:g,dispose:j}}function mb(){let s=new WeakMap;function t(f){return s.has(f)}function i(f){let d=s.get(f);return d===void 0&&(d={},s.set(f,d)),d}function r(f){s.delete(f)}function l(f,d,p){s.get(f)[d]=p}function c(){s=new WeakMap}return{has:t,get:i,remove:r,update:l,dispose:c}}function gb(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.material.id!==t.material.id?s.material.id-t.material.id:s.z!==t.z?s.z-t.z:s.id-t.id}function Bv(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.z!==t.z?t.z-s.z:s.id-t.id}function Iv(){const s=[];let t=0;const i=[],r=[],l=[];function c(){t=0,i.length=0,r.length=0,l.length=0}function f(_,y,S,E,R,M){let x=s[t];return x===void 0?(x={id:_.id,object:_,geometry:y,material:S,groupOrder:E,renderOrder:_.renderOrder,z:R,group:M},s[t]=x):(x.id=_.id,x.object=_,x.geometry=y,x.material=S,x.groupOrder=E,x.renderOrder=_.renderOrder,x.z=R,x.group=M),t++,x}function d(_,y,S,E,R,M){const x=f(_,y,S,E,R,M);S.transmission>0?r.push(x):S.transparent===!0?l.push(x):i.push(x)}function p(_,y,S,E,R,M){const x=f(_,y,S,E,R,M);S.transmission>0?r.unshift(x):S.transparent===!0?l.unshift(x):i.unshift(x)}function m(_,y){i.length>1&&i.sort(_||gb),r.length>1&&r.sort(y||Bv),l.length>1&&l.sort(y||Bv)}function g(){for(let _=t,y=s.length;_<y;_++){const S=s[_];if(S.id===null)break;S.id=null,S.object=null,S.geometry=null,S.material=null,S.group=null}}return{opaque:i,transmissive:r,transparent:l,init:c,push:d,unshift:p,finish:g,sort:m}}function _b(){let s=new WeakMap;function t(r,l){const c=s.get(r);let f;return c===void 0?(f=new Iv,s.set(r,[f])):l>=c.length?(f=new Iv,c.push(f)):f=c[l],f}function i(){s=new WeakMap}return{get:t,dispose:i}}function vb(){const s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new Q,color:new we};break;case"SpotLight":i={position:new Q,direction:new Q,color:new we,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new Q,color:new we,distance:0,decay:0};break;case"HemisphereLight":i={direction:new Q,skyColor:new we,groundColor:new we};break;case"RectAreaLight":i={color:new we,position:new Q,halfWidth:new Q,halfHeight:new Q};break}return s[t.id]=i,i}}}function xb(){const s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qt};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qt};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qt,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[t.id]=i,i}}}let yb=0;function Sb(s,t){return(t.castShadow?2:0)-(s.castShadow?2:0)+(t.map?1:0)-(s.map?1:0)}function Mb(s){const t=new vb,i=xb(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let m=0;m<9;m++)r.probe.push(new Q);const l=new Q,c=new je,f=new je;function d(m){let g=0,_=0,y=0;for(let D=0;D<9;D++)r.probe[D].set(0,0,0);let S=0,E=0,R=0,M=0,x=0,B=0,U=0,w=0,K=0,G=0,P=0;m.sort(Sb);for(let D=0,C=m.length;D<C;D++){const H=m[D],ct=H.color,ot=H.intensity,gt=H.distance,tt=H.shadow&&H.shadow.map?H.shadow.map.texture:null;if(H.isAmbientLight)g+=ct.r*ot,_+=ct.g*ot,y+=ct.b*ot;else if(H.isLightProbe){for(let O=0;O<9;O++)r.probe[O].addScaledVector(H.sh.coefficients[O],ot);P++}else if(H.isDirectionalLight){const O=t.get(H);if(O.color.copy(H.color).multiplyScalar(H.intensity),H.castShadow){const V=H.shadow,W=i.get(H);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,r.directionalShadow[S]=W,r.directionalShadowMap[S]=tt,r.directionalShadowMatrix[S]=H.shadow.matrix,B++}r.directional[S]=O,S++}else if(H.isSpotLight){const O=t.get(H);O.position.setFromMatrixPosition(H.matrixWorld),O.color.copy(ct).multiplyScalar(ot),O.distance=gt,O.coneCos=Math.cos(H.angle),O.penumbraCos=Math.cos(H.angle*(1-H.penumbra)),O.decay=H.decay,r.spot[R]=O;const V=H.shadow;if(H.map&&(r.spotLightMap[K]=H.map,K++,V.updateMatrices(H),H.castShadow&&G++),r.spotLightMatrix[R]=V.matrix,H.castShadow){const W=i.get(H);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,r.spotShadow[R]=W,r.spotShadowMap[R]=tt,w++}R++}else if(H.isRectAreaLight){const O=t.get(H);O.color.copy(ct).multiplyScalar(ot),O.halfWidth.set(H.width*.5,0,0),O.halfHeight.set(0,H.height*.5,0),r.rectArea[M]=O,M++}else if(H.isPointLight){const O=t.get(H);if(O.color.copy(H.color).multiplyScalar(H.intensity),O.distance=H.distance,O.decay=H.decay,H.castShadow){const V=H.shadow,W=i.get(H);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,W.shadowCameraNear=V.camera.near,W.shadowCameraFar=V.camera.far,r.pointShadow[E]=W,r.pointShadowMap[E]=tt,r.pointShadowMatrix[E]=H.shadow.matrix,U++}r.point[E]=O,E++}else if(H.isHemisphereLight){const O=t.get(H);O.skyColor.copy(H.color).multiplyScalar(ot),O.groundColor.copy(H.groundColor).multiplyScalar(ot),r.hemi[x]=O,x++}}M>0&&(s.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Lt.LTC_FLOAT_1,r.rectAreaLTC2=Lt.LTC_FLOAT_2):(r.rectAreaLTC1=Lt.LTC_HALF_1,r.rectAreaLTC2=Lt.LTC_HALF_2)),r.ambient[0]=g,r.ambient[1]=_,r.ambient[2]=y;const j=r.hash;(j.directionalLength!==S||j.pointLength!==E||j.spotLength!==R||j.rectAreaLength!==M||j.hemiLength!==x||j.numDirectionalShadows!==B||j.numPointShadows!==U||j.numSpotShadows!==w||j.numSpotMaps!==K||j.numLightProbes!==P)&&(r.directional.length=S,r.spot.length=R,r.rectArea.length=M,r.point.length=E,r.hemi.length=x,r.directionalShadow.length=B,r.directionalShadowMap.length=B,r.pointShadow.length=U,r.pointShadowMap.length=U,r.spotShadow.length=w,r.spotShadowMap.length=w,r.directionalShadowMatrix.length=B,r.pointShadowMatrix.length=U,r.spotLightMatrix.length=w+K-G,r.spotLightMap.length=K,r.numSpotLightShadowsWithMaps=G,r.numLightProbes=P,j.directionalLength=S,j.pointLength=E,j.spotLength=R,j.rectAreaLength=M,j.hemiLength=x,j.numDirectionalShadows=B,j.numPointShadows=U,j.numSpotShadows=w,j.numSpotMaps=K,j.numLightProbes=P,r.version=yb++)}function p(m,g){let _=0,y=0,S=0,E=0,R=0;const M=g.matrixWorldInverse;for(let x=0,B=m.length;x<B;x++){const U=m[x];if(U.isDirectionalLight){const w=r.directional[_];w.direction.setFromMatrixPosition(U.matrixWorld),l.setFromMatrixPosition(U.target.matrixWorld),w.direction.sub(l),w.direction.transformDirection(M),_++}else if(U.isSpotLight){const w=r.spot[S];w.position.setFromMatrixPosition(U.matrixWorld),w.position.applyMatrix4(M),w.direction.setFromMatrixPosition(U.matrixWorld),l.setFromMatrixPosition(U.target.matrixWorld),w.direction.sub(l),w.direction.transformDirection(M),S++}else if(U.isRectAreaLight){const w=r.rectArea[E];w.position.setFromMatrixPosition(U.matrixWorld),w.position.applyMatrix4(M),f.identity(),c.copy(U.matrixWorld),c.premultiply(M),f.extractRotation(c),w.halfWidth.set(U.width*.5,0,0),w.halfHeight.set(0,U.height*.5,0),w.halfWidth.applyMatrix4(f),w.halfHeight.applyMatrix4(f),E++}else if(U.isPointLight){const w=r.point[y];w.position.setFromMatrixPosition(U.matrixWorld),w.position.applyMatrix4(M),y++}else if(U.isHemisphereLight){const w=r.hemi[R];w.direction.setFromMatrixPosition(U.matrixWorld),w.direction.transformDirection(M),R++}}}return{setup:d,setupView:p,state:r}}function Fv(s){const t=new Mb(s),i=[],r=[];function l(g){m.camera=g,i.length=0,r.length=0}function c(g){i.push(g)}function f(g){r.push(g)}function d(){t.setup(i)}function p(g){t.setupView(i,g)}const m={lightsArray:i,shadowsArray:r,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:m,setupLights:d,setupLightsView:p,pushLight:c,pushShadow:f}}function Eb(s){let t=new WeakMap;function i(l,c=0){const f=t.get(l);let d;return f===void 0?(d=new Fv(s),t.set(l,[d])):c>=f.length?(d=new Fv(s),f.push(d)):d=f[c],d}function r(){t=new WeakMap}return{get:i,dispose:r}}const Tb=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function bb(s,t,i){let r=new Bd;const l=new qt,c=new qt,f=new $e,d=new ZM({depthPacking:LS}),p=new KM,m={},g=i.maxTextureSize,_={[Xa]:Wn,[Wn]:Xa,[hi]:hi},y=new Wa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qt},radius:{value:4}},vertexShader:Tb,fragmentShader:Ab}),S=y.clone();S.defines.HORIZONTAL_PASS=1;const E=new ua;E.setAttribute("position",new Li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new Xn(E,y),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=kv;let x=this.type;this.render=function(G,P,j){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||G.length===0)return;const D=s.getRenderTarget(),C=s.getActiveCubeFace(),H=s.getActiveMipmapLevel(),ct=s.state;ct.setBlending(Va),ct.buffers.color.setClear(1,1,1,1),ct.buffers.depth.setTest(!0),ct.setScissorTest(!1);const ot=x!==ra&&this.type===ra,gt=x===ra&&this.type!==ra;for(let tt=0,O=G.length;tt<O;tt++){const V=G[tt],W=V.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",V,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;l.copy(W.mapSize);const xt=W.getFrameExtents();if(l.multiply(xt),c.copy(W.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(c.x=Math.floor(g/xt.x),l.x=c.x*xt.x,W.mapSize.x=c.x),l.y>g&&(c.y=Math.floor(g/xt.y),l.y=c.y*xt.y,W.mapSize.y=c.y)),W.map===null||ot===!0||gt===!0){const N=this.type!==ra?{minFilter:Ei,magFilter:Ei}:{};W.map!==null&&W.map.dispose(),W.map=new Ar(l.x,l.y,N),W.map.texture.name=V.name+".shadowMap",W.camera.updateProjectionMatrix()}s.setRenderTarget(W.map),s.clear();const Tt=W.getViewportCount();for(let N=0;N<Tt;N++){const it=W.getViewport(N);f.set(c.x*it.x,c.y*it.y,c.x*it.z,c.y*it.w),ct.viewport(f),W.updateMatrices(V,N),r=W.getFrustum(),w(P,j,W.camera,V,this.type)}W.isPointLightShadow!==!0&&this.type===ra&&B(W,j),W.needsUpdate=!1}x=this.type,M.needsUpdate=!1,s.setRenderTarget(D,C,H)};function B(G,P){const j=t.update(R);y.defines.VSM_SAMPLES!==G.blurSamples&&(y.defines.VSM_SAMPLES=G.blurSamples,S.defines.VSM_SAMPLES=G.blurSamples,y.needsUpdate=!0,S.needsUpdate=!0),G.mapPass===null&&(G.mapPass=new Ar(l.x,l.y)),y.uniforms.shadow_pass.value=G.map.texture,y.uniforms.resolution.value=G.mapSize,y.uniforms.radius.value=G.radius,s.setRenderTarget(G.mapPass),s.clear(),s.renderBufferDirect(P,null,j,y,R,null),S.uniforms.shadow_pass.value=G.mapPass.texture,S.uniforms.resolution.value=G.mapSize,S.uniforms.radius.value=G.radius,s.setRenderTarget(G.map),s.clear(),s.renderBufferDirect(P,null,j,S,R,null)}function U(G,P,j,D){let C=null;const H=j.isPointLight===!0?G.customDistanceMaterial:G.customDepthMaterial;if(H!==void 0)C=H;else if(C=j.isPointLight===!0?p:d,s.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0){const ct=C.uuid,ot=P.uuid;let gt=m[ct];gt===void 0&&(gt={},m[ct]=gt);let tt=gt[ot];tt===void 0&&(tt=C.clone(),gt[ot]=tt,P.addEventListener("dispose",K)),C=tt}if(C.visible=P.visible,C.wireframe=P.wireframe,D===ra?C.side=P.shadowSide!==null?P.shadowSide:P.side:C.side=P.shadowSide!==null?P.shadowSide:_[P.side],C.alphaMap=P.alphaMap,C.alphaTest=P.alphaTest,C.map=P.map,C.clipShadows=P.clipShadows,C.clippingPlanes=P.clippingPlanes,C.clipIntersection=P.clipIntersection,C.displacementMap=P.displacementMap,C.displacementScale=P.displacementScale,C.displacementBias=P.displacementBias,C.wireframeLinewidth=P.wireframeLinewidth,C.linewidth=P.linewidth,j.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const ct=s.properties.get(C);ct.light=j}return C}function w(G,P,j,D,C){if(G.visible===!1)return;if(G.layers.test(P.layers)&&(G.isMesh||G.isLine||G.isPoints)&&(G.castShadow||G.receiveShadow&&C===ra)&&(!G.frustumCulled||r.intersectsObject(G))){G.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,G.matrixWorld);const ot=t.update(G),gt=G.material;if(Array.isArray(gt)){const tt=ot.groups;for(let O=0,V=tt.length;O<V;O++){const W=tt[O],xt=gt[W.materialIndex];if(xt&&xt.visible){const Tt=U(G,xt,D,C);G.onBeforeShadow(s,G,P,j,ot,Tt,W),s.renderBufferDirect(j,null,ot,Tt,G,W),G.onAfterShadow(s,G,P,j,ot,Tt,W)}}}else if(gt.visible){const tt=U(G,gt,D,C);G.onBeforeShadow(s,G,P,j,ot,tt,null),s.renderBufferDirect(j,null,ot,tt,G,null),G.onAfterShadow(s,G,P,j,ot,tt,null)}}const ct=G.children;for(let ot=0,gt=ct.length;ot<gt;ot++)w(ct[ot],P,j,D,C)}function K(G){G.target.removeEventListener("dispose",K);for(const j in m){const D=m[j],C=G.target.uuid;C in D&&(D[C].dispose(),delete D[C])}}}const Rb={[Gh]:Vh,[kh]:qh,[Xh]:Yh,[Rs]:Wh,[Vh]:Gh,[qh]:kh,[Yh]:Xh,[Wh]:Rs};function Cb(s,t){function i(){let k=!1;const Rt=new $e;let lt=null;const _t=new $e(0,0,0,0);return{setMask:function(Ct){lt!==Ct&&!k&&(s.colorMask(Ct,Ct,Ct,Ct),lt=Ct)},setLocked:function(Ct){k=Ct},setClear:function(Ct,Dt,te,We,un){un===!0&&(Ct*=We,Dt*=We,te*=We),Rt.set(Ct,Dt,te,We),_t.equals(Rt)===!1&&(s.clearColor(Ct,Dt,te,We),_t.copy(Rt))},reset:function(){k=!1,lt=null,_t.set(-1,0,0,0)}}}function r(){let k=!1,Rt=!1,lt=null,_t=null,Ct=null;return{setReversed:function(Dt){if(Rt!==Dt){const te=t.get("EXT_clip_control");Rt?te.clipControlEXT(te.LOWER_LEFT_EXT,te.ZERO_TO_ONE_EXT):te.clipControlEXT(te.LOWER_LEFT_EXT,te.NEGATIVE_ONE_TO_ONE_EXT);const We=Ct;Ct=null,this.setClear(We)}Rt=Dt},getReversed:function(){return Rt},setTest:function(Dt){Dt?St(s.DEPTH_TEST):Gt(s.DEPTH_TEST)},setMask:function(Dt){lt!==Dt&&!k&&(s.depthMask(Dt),lt=Dt)},setFunc:function(Dt){if(Rt&&(Dt=Rb[Dt]),_t!==Dt){switch(Dt){case Gh:s.depthFunc(s.NEVER);break;case Vh:s.depthFunc(s.ALWAYS);break;case kh:s.depthFunc(s.LESS);break;case Rs:s.depthFunc(s.LEQUAL);break;case Xh:s.depthFunc(s.EQUAL);break;case Wh:s.depthFunc(s.GEQUAL);break;case qh:s.depthFunc(s.GREATER);break;case Yh:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}_t=Dt}},setLocked:function(Dt){k=Dt},setClear:function(Dt){Ct!==Dt&&(Rt&&(Dt=1-Dt),s.clearDepth(Dt),Ct=Dt)},reset:function(){k=!1,lt=null,_t=null,Ct=null,Rt=!1}}}function l(){let k=!1,Rt=null,lt=null,_t=null,Ct=null,Dt=null,te=null,We=null,un=null;return{setTest:function(Me){k||(Me?St(s.STENCIL_TEST):Gt(s.STENCIL_TEST))},setMask:function(Me){Rt!==Me&&!k&&(s.stencilMask(Me),Rt=Me)},setFunc:function(Me,vn,di){(lt!==Me||_t!==vn||Ct!==di)&&(s.stencilFunc(Me,vn,di),lt=Me,_t=vn,Ct=di)},setOp:function(Me,vn,di){(Dt!==Me||te!==vn||We!==di)&&(s.stencilOp(Me,vn,di),Dt=Me,te=vn,We=di)},setLocked:function(Me){k=Me},setClear:function(Me){un!==Me&&(s.clearStencil(Me),un=Me)},reset:function(){k=!1,Rt=null,lt=null,_t=null,Ct=null,Dt=null,te=null,We=null,un=null}}}const c=new i,f=new r,d=new l,p=new WeakMap,m=new WeakMap;let g={},_={},y=new WeakMap,S=[],E=null,R=!1,M=null,x=null,B=null,U=null,w=null,K=null,G=null,P=new we(0,0,0),j=0,D=!1,C=null,H=null,ct=null,ot=null,gt=null;const tt=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,V=0;const W=s.getParameter(s.VERSION);W.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(W)[1]),O=V>=1):W.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),O=V>=2);let xt=null,Tt={};const N=s.getParameter(s.SCISSOR_BOX),it=s.getParameter(s.VIEWPORT),Mt=new $e().fromArray(N),Z=new $e().fromArray(it);function ut(k,Rt,lt,_t){const Ct=new Uint8Array(4),Dt=s.createTexture();s.bindTexture(k,Dt),s.texParameteri(k,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(k,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let te=0;te<lt;te++)k===s.TEXTURE_3D||k===s.TEXTURE_2D_ARRAY?s.texImage3D(Rt,0,s.RGBA,1,1,_t,0,s.RGBA,s.UNSIGNED_BYTE,Ct):s.texImage2D(Rt+te,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ct);return Dt}const At={};At[s.TEXTURE_2D]=ut(s.TEXTURE_2D,s.TEXTURE_2D,1),At[s.TEXTURE_CUBE_MAP]=ut(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),At[s.TEXTURE_2D_ARRAY]=ut(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),At[s.TEXTURE_3D]=ut(s.TEXTURE_3D,s.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),d.setClear(0),St(s.DEPTH_TEST),f.setFunc(Rs),ue(!1),ge(P_),St(s.CULL_FACE),I(Va);function St(k){g[k]!==!0&&(s.enable(k),g[k]=!0)}function Gt(k){g[k]!==!1&&(s.disable(k),g[k]=!1)}function Ft(k,Rt){return _[k]!==Rt?(s.bindFramebuffer(k,Rt),_[k]=Rt,k===s.DRAW_FRAMEBUFFER&&(_[s.FRAMEBUFFER]=Rt),k===s.FRAMEBUFFER&&(_[s.DRAW_FRAMEBUFFER]=Rt),!0):!1}function ie(k,Rt){let lt=S,_t=!1;if(k){lt=y.get(Rt),lt===void 0&&(lt=[],y.set(Rt,lt));const Ct=k.textures;if(lt.length!==Ct.length||lt[0]!==s.COLOR_ATTACHMENT0){for(let Dt=0,te=Ct.length;Dt<te;Dt++)lt[Dt]=s.COLOR_ATTACHMENT0+Dt;lt.length=Ct.length,_t=!0}}else lt[0]!==s.BACK&&(lt[0]=s.BACK,_t=!0);_t&&s.drawBuffers(lt)}function Ne(k){return E!==k?(s.useProgram(k),E=k,!0):!1}const fe={[yr]:s.FUNC_ADD,[aS]:s.FUNC_SUBTRACT,[rS]:s.FUNC_REVERSE_SUBTRACT};fe[sS]=s.MIN,fe[oS]=s.MAX;const Xe={[lS]:s.ZERO,[cS]:s.ONE,[uS]:s.SRC_COLOR,[Fh]:s.SRC_ALPHA,[gS]:s.SRC_ALPHA_SATURATE,[pS]:s.DST_COLOR,[hS]:s.DST_ALPHA,[fS]:s.ONE_MINUS_SRC_COLOR,[Hh]:s.ONE_MINUS_SRC_ALPHA,[mS]:s.ONE_MINUS_DST_COLOR,[dS]:s.ONE_MINUS_DST_ALPHA,[_S]:s.CONSTANT_COLOR,[vS]:s.ONE_MINUS_CONSTANT_COLOR,[xS]:s.CONSTANT_ALPHA,[yS]:s.ONE_MINUS_CONSTANT_ALPHA};function I(k,Rt,lt,_t,Ct,Dt,te,We,un,Me){if(k===Va){R===!0&&(Gt(s.BLEND),R=!1);return}if(R===!1&&(St(s.BLEND),R=!0),k!==iS){if(k!==M||Me!==D){if((x!==yr||w!==yr)&&(s.blendEquation(s.FUNC_ADD),x=yr,w=yr),Me)switch(k){case Ts:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case z_:s.blendFunc(s.ONE,s.ONE);break;case B_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case I_:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}else switch(k){case Ts:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case z_:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case B_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case I_:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}B=null,U=null,K=null,G=null,P.set(0,0,0),j=0,M=k,D=Me}return}Ct=Ct||Rt,Dt=Dt||lt,te=te||_t,(Rt!==x||Ct!==w)&&(s.blendEquationSeparate(fe[Rt],fe[Ct]),x=Rt,w=Ct),(lt!==B||_t!==U||Dt!==K||te!==G)&&(s.blendFuncSeparate(Xe[lt],Xe[_t],Xe[Dt],Xe[te]),B=lt,U=_t,K=Dt,G=te),(We.equals(P)===!1||un!==j)&&(s.blendColor(We.r,We.g,We.b,un),P.copy(We),j=un),M=k,D=!1}function Tn(k,Rt){k.side===hi?Gt(s.CULL_FACE):St(s.CULL_FACE);let lt=k.side===Wn;Rt&&(lt=!lt),ue(lt),k.blending===Ts&&k.transparent===!1?I(Va):I(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),f.setFunc(k.depthFunc),f.setTest(k.depthTest),f.setMask(k.depthWrite),c.setMask(k.colorWrite);const _t=k.stencilWrite;d.setTest(_t),_t&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),De(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?St(s.SAMPLE_ALPHA_TO_COVERAGE):Gt(s.SAMPLE_ALPHA_TO_COVERAGE)}function ue(k){C!==k&&(k?s.frontFace(s.CW):s.frontFace(s.CCW),C=k)}function ge(k){k!==tS?(St(s.CULL_FACE),k!==H&&(k===P_?s.cullFace(s.BACK):k===eS?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Gt(s.CULL_FACE),H=k}function Yt(k){k!==ct&&(O&&s.lineWidth(k),ct=k)}function De(k,Rt,lt){k?(St(s.POLYGON_OFFSET_FILL),(ot!==Rt||gt!==lt)&&(s.polygonOffset(Rt,lt),ot=Rt,gt=lt)):Gt(s.POLYGON_OFFSET_FILL)}function Wt(k){k?St(s.SCISSOR_TEST):Gt(s.SCISSOR_TEST)}function L(k){k===void 0&&(k=s.TEXTURE0+tt-1),xt!==k&&(s.activeTexture(k),xt=k)}function A(k,Rt,lt){lt===void 0&&(xt===null?lt=s.TEXTURE0+tt-1:lt=xt);let _t=Tt[lt];_t===void 0&&(_t={type:void 0,texture:void 0},Tt[lt]=_t),(_t.type!==k||_t.texture!==Rt)&&(xt!==lt&&(s.activeTexture(lt),xt=lt),s.bindTexture(k,Rt||At[k]),_t.type=k,_t.texture=Rt)}function nt(){const k=Tt[xt];k!==void 0&&k.type!==void 0&&(s.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function ht(){try{s.compressedTexImage2D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Et(){try{s.compressedTexImage3D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function pt(){try{s.texSubImage2D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function kt(){try{s.texSubImage3D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function wt(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function zt(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function _e(){try{s.texStorage2D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function bt(){try{s.texStorage3D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Bt(){try{s.texImage2D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function jt(){try{s.texImage3D.apply(s,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Xt(k){Mt.equals(k)===!1&&(s.scissor(k.x,k.y,k.z,k.w),Mt.copy(k))}function Nt(k){Z.equals(k)===!1&&(s.viewport(k.x,k.y,k.z,k.w),Z.copy(k))}function $t(k,Rt){let lt=m.get(Rt);lt===void 0&&(lt=new WeakMap,m.set(Rt,lt));let _t=lt.get(k);_t===void 0&&(_t=s.getUniformBlockIndex(Rt,k.name),lt.set(k,_t))}function ae(k,Rt){const _t=m.get(Rt).get(k);p.get(Rt)!==_t&&(s.uniformBlockBinding(Rt,_t,k.__bindingPointIndex),p.set(Rt,_t))}function Oe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),f.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},xt=null,Tt={},_={},y=new WeakMap,S=[],E=null,R=!1,M=null,x=null,B=null,U=null,w=null,K=null,G=null,P=new we(0,0,0),j=0,D=!1,C=null,H=null,ct=null,ot=null,gt=null,Mt.set(0,0,s.canvas.width,s.canvas.height),Z.set(0,0,s.canvas.width,s.canvas.height),c.reset(),f.reset(),d.reset()}return{buffers:{color:c,depth:f,stencil:d},enable:St,disable:Gt,bindFramebuffer:Ft,drawBuffers:ie,useProgram:Ne,setBlending:I,setMaterial:Tn,setFlipSided:ue,setCullFace:ge,setLineWidth:Yt,setPolygonOffset:De,setScissorTest:Wt,activeTexture:L,bindTexture:A,unbindTexture:nt,compressedTexImage2D:ht,compressedTexImage3D:Et,texImage2D:Bt,texImage3D:jt,updateUBOMapping:$t,uniformBlockBinding:ae,texStorage2D:_e,texStorage3D:bt,texSubImage2D:pt,texSubImage3D:kt,compressedTexSubImage2D:wt,compressedTexSubImage3D:zt,scissor:Xt,viewport:Nt,reset:Oe}}function wb(s,t,i,r,l,c,f){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new qt,g=new WeakMap;let _;const y=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(L,A){return S?new OffscreenCanvas(L,A):Hc("canvas")}function R(L,A,nt){let ht=1;const Et=Wt(L);if((Et.width>nt||Et.height>nt)&&(ht=nt/Math.max(Et.width,Et.height)),ht<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const pt=Math.floor(ht*Et.width),kt=Math.floor(ht*Et.height);_===void 0&&(_=E(pt,kt));const wt=A?E(pt,kt):_;return wt.width=pt,wt.height=kt,wt.getContext("2d").drawImage(L,0,0,pt,kt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Et.width+"x"+Et.height+") to ("+pt+"x"+kt+")."),wt}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Et.width+"x"+Et.height+")."),L;return L}function M(L){return L.generateMipmaps}function x(L){s.generateMipmap(L)}function B(L){return L.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?s.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function U(L,A,nt,ht,Et=!1){if(L!==null){if(s[L]!==void 0)return s[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let pt=A;if(A===s.RED&&(nt===s.FLOAT&&(pt=s.R32F),nt===s.HALF_FLOAT&&(pt=s.R16F),nt===s.UNSIGNED_BYTE&&(pt=s.R8)),A===s.RED_INTEGER&&(nt===s.UNSIGNED_BYTE&&(pt=s.R8UI),nt===s.UNSIGNED_SHORT&&(pt=s.R16UI),nt===s.UNSIGNED_INT&&(pt=s.R32UI),nt===s.BYTE&&(pt=s.R8I),nt===s.SHORT&&(pt=s.R16I),nt===s.INT&&(pt=s.R32I)),A===s.RG&&(nt===s.FLOAT&&(pt=s.RG32F),nt===s.HALF_FLOAT&&(pt=s.RG16F),nt===s.UNSIGNED_BYTE&&(pt=s.RG8)),A===s.RG_INTEGER&&(nt===s.UNSIGNED_BYTE&&(pt=s.RG8UI),nt===s.UNSIGNED_SHORT&&(pt=s.RG16UI),nt===s.UNSIGNED_INT&&(pt=s.RG32UI),nt===s.BYTE&&(pt=s.RG8I),nt===s.SHORT&&(pt=s.RG16I),nt===s.INT&&(pt=s.RG32I)),A===s.RGB_INTEGER&&(nt===s.UNSIGNED_BYTE&&(pt=s.RGB8UI),nt===s.UNSIGNED_SHORT&&(pt=s.RGB16UI),nt===s.UNSIGNED_INT&&(pt=s.RGB32UI),nt===s.BYTE&&(pt=s.RGB8I),nt===s.SHORT&&(pt=s.RGB16I),nt===s.INT&&(pt=s.RGB32I)),A===s.RGBA_INTEGER&&(nt===s.UNSIGNED_BYTE&&(pt=s.RGBA8UI),nt===s.UNSIGNED_SHORT&&(pt=s.RGBA16UI),nt===s.UNSIGNED_INT&&(pt=s.RGBA32UI),nt===s.BYTE&&(pt=s.RGBA8I),nt===s.SHORT&&(pt=s.RGBA16I),nt===s.INT&&(pt=s.RGBA32I)),A===s.RGB&&nt===s.UNSIGNED_INT_5_9_9_9_REV&&(pt=s.RGB9_E5),A===s.RGBA){const kt=Et?Ic:Re.getTransfer(ht);nt===s.FLOAT&&(pt=s.RGBA32F),nt===s.HALF_FLOAT&&(pt=s.RGBA16F),nt===s.UNSIGNED_BYTE&&(pt=kt===Ie?s.SRGB8_ALPHA8:s.RGBA8),nt===s.UNSIGNED_SHORT_4_4_4_4&&(pt=s.RGBA4),nt===s.UNSIGNED_SHORT_5_5_5_1&&(pt=s.RGB5_A1)}return(pt===s.R16F||pt===s.R32F||pt===s.RG16F||pt===s.RG32F||pt===s.RGBA16F||pt===s.RGBA32F)&&t.get("EXT_color_buffer_float"),pt}function w(L,A){let nt;return L?A===null||A===Tr||A===Ds?nt=s.DEPTH24_STENCIL8:A===sa?nt=s.DEPTH32F_STENCIL8:A===Vo&&(nt=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===Tr||A===Ds?nt=s.DEPTH_COMPONENT24:A===sa?nt=s.DEPTH_COMPONENT32F:A===Vo&&(nt=s.DEPTH_COMPONENT16),nt}function K(L,A){return M(L)===!0||L.isFramebufferTexture&&L.minFilter!==Ei&&L.minFilter!==Ui?Math.log2(Math.max(A.width,A.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?A.mipmaps.length:1}function G(L){const A=L.target;A.removeEventListener("dispose",G),j(A),A.isVideoTexture&&g.delete(A)}function P(L){const A=L.target;A.removeEventListener("dispose",P),C(A)}function j(L){const A=r.get(L);if(A.__webglInit===void 0)return;const nt=L.source,ht=y.get(nt);if(ht){const Et=ht[A.__cacheKey];Et.usedTimes--,Et.usedTimes===0&&D(L),Object.keys(ht).length===0&&y.delete(nt)}r.remove(L)}function D(L){const A=r.get(L);s.deleteTexture(A.__webglTexture);const nt=L.source,ht=y.get(nt);delete ht[A.__cacheKey],f.memory.textures--}function C(L){const A=r.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),r.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let ht=0;ht<6;ht++){if(Array.isArray(A.__webglFramebuffer[ht]))for(let Et=0;Et<A.__webglFramebuffer[ht].length;Et++)s.deleteFramebuffer(A.__webglFramebuffer[ht][Et]);else s.deleteFramebuffer(A.__webglFramebuffer[ht]);A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer[ht])}else{if(Array.isArray(A.__webglFramebuffer))for(let ht=0;ht<A.__webglFramebuffer.length;ht++)s.deleteFramebuffer(A.__webglFramebuffer[ht]);else s.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&s.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let ht=0;ht<A.__webglColorRenderbuffer.length;ht++)A.__webglColorRenderbuffer[ht]&&s.deleteRenderbuffer(A.__webglColorRenderbuffer[ht]);A.__webglDepthRenderbuffer&&s.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const nt=L.textures;for(let ht=0,Et=nt.length;ht<Et;ht++){const pt=r.get(nt[ht]);pt.__webglTexture&&(s.deleteTexture(pt.__webglTexture),f.memory.textures--),r.remove(nt[ht])}r.remove(L)}let H=0;function ct(){H=0}function ot(){const L=H;return L>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+l.maxTextures),H+=1,L}function gt(L){const A=[];return A.push(L.wrapS),A.push(L.wrapT),A.push(L.wrapR||0),A.push(L.magFilter),A.push(L.minFilter),A.push(L.anisotropy),A.push(L.internalFormat),A.push(L.format),A.push(L.type),A.push(L.generateMipmaps),A.push(L.premultiplyAlpha),A.push(L.flipY),A.push(L.unpackAlignment),A.push(L.colorSpace),A.join()}function tt(L,A){const nt=r.get(L);if(L.isVideoTexture&&Yt(L),L.isRenderTargetTexture===!1&&L.version>0&&nt.__version!==L.version){const ht=L.image;if(ht===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ht.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(nt,L,A);return}}i.bindTexture(s.TEXTURE_2D,nt.__webglTexture,s.TEXTURE0+A)}function O(L,A){const nt=r.get(L);if(L.version>0&&nt.__version!==L.version){Z(nt,L,A);return}i.bindTexture(s.TEXTURE_2D_ARRAY,nt.__webglTexture,s.TEXTURE0+A)}function V(L,A){const nt=r.get(L);if(L.version>0&&nt.__version!==L.version){Z(nt,L,A);return}i.bindTexture(s.TEXTURE_3D,nt.__webglTexture,s.TEXTURE0+A)}function W(L,A){const nt=r.get(L);if(L.version>0&&nt.__version!==L.version){ut(nt,L,A);return}i.bindTexture(s.TEXTURE_CUBE_MAP,nt.__webglTexture,s.TEXTURE0+A)}const xt={[Kh]:s.REPEAT,[Mr]:s.CLAMP_TO_EDGE,[Qh]:s.MIRRORED_REPEAT},Tt={[Ei]:s.NEAREST,[DS]:s.NEAREST_MIPMAP_NEAREST,[lc]:s.NEAREST_MIPMAP_LINEAR,[Ui]:s.LINEAR,[ih]:s.LINEAR_MIPMAP_NEAREST,[Er]:s.LINEAR_MIPMAP_LINEAR},N={[OS]:s.NEVER,[HS]:s.ALWAYS,[PS]:s.LESS,[i0]:s.LEQUAL,[zS]:s.EQUAL,[FS]:s.GEQUAL,[BS]:s.GREATER,[IS]:s.NOTEQUAL};function it(L,A){if(A.type===sa&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===Ui||A.magFilter===ih||A.magFilter===lc||A.magFilter===Er||A.minFilter===Ui||A.minFilter===ih||A.minFilter===lc||A.minFilter===Er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(L,s.TEXTURE_WRAP_S,xt[A.wrapS]),s.texParameteri(L,s.TEXTURE_WRAP_T,xt[A.wrapT]),(L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY)&&s.texParameteri(L,s.TEXTURE_WRAP_R,xt[A.wrapR]),s.texParameteri(L,s.TEXTURE_MAG_FILTER,Tt[A.magFilter]),s.texParameteri(L,s.TEXTURE_MIN_FILTER,Tt[A.minFilter]),A.compareFunction&&(s.texParameteri(L,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(L,s.TEXTURE_COMPARE_FUNC,N[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===Ei||A.minFilter!==lc&&A.minFilter!==Er||A.type===sa&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||r.get(A).__currentAnisotropy){const nt=t.get("EXT_texture_filter_anisotropic");s.texParameterf(L,nt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,l.getMaxAnisotropy())),r.get(A).__currentAnisotropy=A.anisotropy}}}function Mt(L,A){let nt=!1;L.__webglInit===void 0&&(L.__webglInit=!0,A.addEventListener("dispose",G));const ht=A.source;let Et=y.get(ht);Et===void 0&&(Et={},y.set(ht,Et));const pt=gt(A);if(pt!==L.__cacheKey){Et[pt]===void 0&&(Et[pt]={texture:s.createTexture(),usedTimes:0},f.memory.textures++,nt=!0),Et[pt].usedTimes++;const kt=Et[L.__cacheKey];kt!==void 0&&(Et[L.__cacheKey].usedTimes--,kt.usedTimes===0&&D(A)),L.__cacheKey=pt,L.__webglTexture=Et[pt].texture}return nt}function Z(L,A,nt){let ht=s.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(ht=s.TEXTURE_2D_ARRAY),A.isData3DTexture&&(ht=s.TEXTURE_3D);const Et=Mt(L,A),pt=A.source;i.bindTexture(ht,L.__webglTexture,s.TEXTURE0+nt);const kt=r.get(pt);if(pt.version!==kt.__version||Et===!0){i.activeTexture(s.TEXTURE0+nt);const wt=Re.getPrimaries(Re.workingColorSpace),zt=A.colorSpace===Ha?null:Re.getPrimaries(A.colorSpace),_e=A.colorSpace===Ha||wt===zt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);let bt=R(A.image,!1,l.maxTextureSize);bt=De(A,bt);const Bt=c.convert(A.format,A.colorSpace),jt=c.convert(A.type);let Xt=U(A.internalFormat,Bt,jt,A.colorSpace,A.isVideoTexture);it(ht,A);let Nt;const $t=A.mipmaps,ae=A.isVideoTexture!==!0,Oe=kt.__version===void 0||Et===!0,k=pt.dataReady,Rt=K(A,bt);if(A.isDepthTexture)Xt=w(A.format===Us,A.type),Oe&&(ae?i.texStorage2D(s.TEXTURE_2D,1,Xt,bt.width,bt.height):i.texImage2D(s.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Bt,jt,null));else if(A.isDataTexture)if($t.length>0){ae&&Oe&&i.texStorage2D(s.TEXTURE_2D,Rt,Xt,$t[0].width,$t[0].height);for(let lt=0,_t=$t.length;lt<_t;lt++)Nt=$t[lt],ae?k&&i.texSubImage2D(s.TEXTURE_2D,lt,0,0,Nt.width,Nt.height,Bt,jt,Nt.data):i.texImage2D(s.TEXTURE_2D,lt,Xt,Nt.width,Nt.height,0,Bt,jt,Nt.data);A.generateMipmaps=!1}else ae?(Oe&&i.texStorage2D(s.TEXTURE_2D,Rt,Xt,bt.width,bt.height),k&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,bt.width,bt.height,Bt,jt,bt.data)):i.texImage2D(s.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Bt,jt,bt.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){ae&&Oe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Rt,Xt,$t[0].width,$t[0].height,bt.depth);for(let lt=0,_t=$t.length;lt<_t;lt++)if(Nt=$t[lt],A.format!==Mi)if(Bt!==null)if(ae){if(k)if(A.layerUpdates.size>0){const Ct=mv(Nt.width,Nt.height,A.format,A.type);for(const Dt of A.layerUpdates){const te=Nt.data.subarray(Dt*Ct/Nt.data.BYTES_PER_ELEMENT,(Dt+1)*Ct/Nt.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,lt,0,0,Dt,Nt.width,Nt.height,1,Bt,te)}A.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,lt,0,0,0,Nt.width,Nt.height,bt.depth,Bt,Nt.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,lt,Xt,Nt.width,Nt.height,bt.depth,0,Nt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ae?k&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,lt,0,0,0,Nt.width,Nt.height,bt.depth,Bt,jt,Nt.data):i.texImage3D(s.TEXTURE_2D_ARRAY,lt,Xt,Nt.width,Nt.height,bt.depth,0,Bt,jt,Nt.data)}else{ae&&Oe&&i.texStorage2D(s.TEXTURE_2D,Rt,Xt,$t[0].width,$t[0].height);for(let lt=0,_t=$t.length;lt<_t;lt++)Nt=$t[lt],A.format!==Mi?Bt!==null?ae?k&&i.compressedTexSubImage2D(s.TEXTURE_2D,lt,0,0,Nt.width,Nt.height,Bt,Nt.data):i.compressedTexImage2D(s.TEXTURE_2D,lt,Xt,Nt.width,Nt.height,0,Nt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ae?k&&i.texSubImage2D(s.TEXTURE_2D,lt,0,0,Nt.width,Nt.height,Bt,jt,Nt.data):i.texImage2D(s.TEXTURE_2D,lt,Xt,Nt.width,Nt.height,0,Bt,jt,Nt.data)}else if(A.isDataArrayTexture)if(ae){if(Oe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Rt,Xt,bt.width,bt.height,bt.depth),k)if(A.layerUpdates.size>0){const lt=mv(bt.width,bt.height,A.format,A.type);for(const _t of A.layerUpdates){const Ct=bt.data.subarray(_t*lt/bt.data.BYTES_PER_ELEMENT,(_t+1)*lt/bt.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,_t,bt.width,bt.height,1,Bt,jt,Ct)}A.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,Bt,jt,bt.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Xt,bt.width,bt.height,bt.depth,0,Bt,jt,bt.data);else if(A.isData3DTexture)ae?(Oe&&i.texStorage3D(s.TEXTURE_3D,Rt,Xt,bt.width,bt.height,bt.depth),k&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,Bt,jt,bt.data)):i.texImage3D(s.TEXTURE_3D,0,Xt,bt.width,bt.height,bt.depth,0,Bt,jt,bt.data);else if(A.isFramebufferTexture){if(Oe)if(ae)i.texStorage2D(s.TEXTURE_2D,Rt,Xt,bt.width,bt.height);else{let lt=bt.width,_t=bt.height;for(let Ct=0;Ct<Rt;Ct++)i.texImage2D(s.TEXTURE_2D,Ct,Xt,lt,_t,0,Bt,jt,null),lt>>=1,_t>>=1}}else if($t.length>0){if(ae&&Oe){const lt=Wt($t[0]);i.texStorage2D(s.TEXTURE_2D,Rt,Xt,lt.width,lt.height)}for(let lt=0,_t=$t.length;lt<_t;lt++)Nt=$t[lt],ae?k&&i.texSubImage2D(s.TEXTURE_2D,lt,0,0,Bt,jt,Nt):i.texImage2D(s.TEXTURE_2D,lt,Xt,Bt,jt,Nt);A.generateMipmaps=!1}else if(ae){if(Oe){const lt=Wt(bt);i.texStorage2D(s.TEXTURE_2D,Rt,Xt,lt.width,lt.height)}k&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Bt,jt,bt)}else i.texImage2D(s.TEXTURE_2D,0,Xt,Bt,jt,bt);M(A)&&x(ht),kt.__version=pt.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function ut(L,A,nt){if(A.image.length!==6)return;const ht=Mt(L,A),Et=A.source;i.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+nt);const pt=r.get(Et);if(Et.version!==pt.__version||ht===!0){i.activeTexture(s.TEXTURE0+nt);const kt=Re.getPrimaries(Re.workingColorSpace),wt=A.colorSpace===Ha?null:Re.getPrimaries(A.colorSpace),zt=A.colorSpace===Ha||kt===wt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);const _e=A.isCompressedTexture||A.image[0].isCompressedTexture,bt=A.image[0]&&A.image[0].isDataTexture,Bt=[];for(let _t=0;_t<6;_t++)!_e&&!bt?Bt[_t]=R(A.image[_t],!0,l.maxCubemapSize):Bt[_t]=bt?A.image[_t].image:A.image[_t],Bt[_t]=De(A,Bt[_t]);const jt=Bt[0],Xt=c.convert(A.format,A.colorSpace),Nt=c.convert(A.type),$t=U(A.internalFormat,Xt,Nt,A.colorSpace),ae=A.isVideoTexture!==!0,Oe=pt.__version===void 0||ht===!0,k=Et.dataReady;let Rt=K(A,jt);it(s.TEXTURE_CUBE_MAP,A);let lt;if(_e){ae&&Oe&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Rt,$t,jt.width,jt.height);for(let _t=0;_t<6;_t++){lt=Bt[_t].mipmaps;for(let Ct=0;Ct<lt.length;Ct++){const Dt=lt[Ct];A.format!==Mi?Xt!==null?ae?k&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct,0,0,Dt.width,Dt.height,Xt,Dt.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct,$t,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ae?k&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct,0,0,Dt.width,Dt.height,Xt,Nt,Dt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct,$t,Dt.width,Dt.height,0,Xt,Nt,Dt.data)}}}else{if(lt=A.mipmaps,ae&&Oe){lt.length>0&&Rt++;const _t=Wt(Bt[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Rt,$t,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(bt){ae?k&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Bt[_t].width,Bt[_t].height,Xt,Nt,Bt[_t].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,$t,Bt[_t].width,Bt[_t].height,0,Xt,Nt,Bt[_t].data);for(let Ct=0;Ct<lt.length;Ct++){const te=lt[Ct].image[_t].image;ae?k&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct+1,0,0,te.width,te.height,Xt,Nt,te.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct+1,$t,te.width,te.height,0,Xt,Nt,te.data)}}else{ae?k&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Xt,Nt,Bt[_t]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,$t,Xt,Nt,Bt[_t]);for(let Ct=0;Ct<lt.length;Ct++){const Dt=lt[Ct];ae?k&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct+1,0,0,Xt,Nt,Dt.image[_t]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ct+1,$t,Xt,Nt,Dt.image[_t])}}}M(A)&&x(s.TEXTURE_CUBE_MAP),pt.__version=Et.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function At(L,A,nt,ht,Et,pt){const kt=c.convert(nt.format,nt.colorSpace),wt=c.convert(nt.type),zt=U(nt.internalFormat,kt,wt,nt.colorSpace),_e=r.get(A),bt=r.get(nt);if(bt.__renderTarget=A,!_e.__hasExternalTextures){const Bt=Math.max(1,A.width>>pt),jt=Math.max(1,A.height>>pt);Et===s.TEXTURE_3D||Et===s.TEXTURE_2D_ARRAY?i.texImage3D(Et,pt,zt,Bt,jt,A.depth,0,kt,wt,null):i.texImage2D(Et,pt,zt,Bt,jt,0,kt,wt,null)}i.bindFramebuffer(s.FRAMEBUFFER,L),ge(A)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ht,Et,bt.__webglTexture,0,ue(A)):(Et===s.TEXTURE_2D||Et>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Et<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ht,Et,bt.__webglTexture,pt),i.bindFramebuffer(s.FRAMEBUFFER,null)}function St(L,A,nt){if(s.bindRenderbuffer(s.RENDERBUFFER,L),A.depthBuffer){const ht=A.depthTexture,Et=ht&&ht.isDepthTexture?ht.type:null,pt=w(A.stencilBuffer,Et),kt=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,wt=ue(A);ge(A)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,wt,pt,A.width,A.height):nt?s.renderbufferStorageMultisample(s.RENDERBUFFER,wt,pt,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,pt,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,kt,s.RENDERBUFFER,L)}else{const ht=A.textures;for(let Et=0;Et<ht.length;Et++){const pt=ht[Et],kt=c.convert(pt.format,pt.colorSpace),wt=c.convert(pt.type),zt=U(pt.internalFormat,kt,wt,pt.colorSpace),_e=ue(A);nt&&ge(A)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,_e,zt,A.width,A.height):ge(A)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,_e,zt,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,zt,A.width,A.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Gt(L,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,L),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ht=r.get(A.depthTexture);ht.__renderTarget=A,(!ht.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),tt(A.depthTexture,0);const Et=ht.__webglTexture,pt=ue(A);if(A.depthTexture.format===As)ge(A)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0,pt):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0);else if(A.depthTexture.format===Us)ge(A)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0,pt):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0);else throw new Error("Unknown depthTexture format")}function Ft(L){const A=r.get(L),nt=L.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==L.depthTexture){const ht=L.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),ht){const Et=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,ht.removeEventListener("dispose",Et)};ht.addEventListener("dispose",Et),A.__depthDisposeCallback=Et}A.__boundDepthTexture=ht}if(L.depthTexture&&!A.__autoAllocateDepthBuffer){if(nt)throw new Error("target.depthTexture not supported in Cube render targets");Gt(A.__webglFramebuffer,L)}else if(nt){A.__webglDepthbuffer=[];for(let ht=0;ht<6;ht++)if(i.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer[ht]),A.__webglDepthbuffer[ht]===void 0)A.__webglDepthbuffer[ht]=s.createRenderbuffer(),St(A.__webglDepthbuffer[ht],L,!1);else{const Et=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,pt=A.__webglDepthbuffer[ht];s.bindRenderbuffer(s.RENDERBUFFER,pt),s.framebufferRenderbuffer(s.FRAMEBUFFER,Et,s.RENDERBUFFER,pt)}}else if(i.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=s.createRenderbuffer(),St(A.__webglDepthbuffer,L,!1);else{const ht=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Et=A.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Et),s.framebufferRenderbuffer(s.FRAMEBUFFER,ht,s.RENDERBUFFER,Et)}i.bindFramebuffer(s.FRAMEBUFFER,null)}function ie(L,A,nt){const ht=r.get(L);A!==void 0&&At(ht.__webglFramebuffer,L,L.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),nt!==void 0&&Ft(L)}function Ne(L){const A=L.texture,nt=r.get(L),ht=r.get(A);L.addEventListener("dispose",P);const Et=L.textures,pt=L.isWebGLCubeRenderTarget===!0,kt=Et.length>1;if(kt||(ht.__webglTexture===void 0&&(ht.__webglTexture=s.createTexture()),ht.__version=A.version,f.memory.textures++),pt){nt.__webglFramebuffer=[];for(let wt=0;wt<6;wt++)if(A.mipmaps&&A.mipmaps.length>0){nt.__webglFramebuffer[wt]=[];for(let zt=0;zt<A.mipmaps.length;zt++)nt.__webglFramebuffer[wt][zt]=s.createFramebuffer()}else nt.__webglFramebuffer[wt]=s.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){nt.__webglFramebuffer=[];for(let wt=0;wt<A.mipmaps.length;wt++)nt.__webglFramebuffer[wt]=s.createFramebuffer()}else nt.__webglFramebuffer=s.createFramebuffer();if(kt)for(let wt=0,zt=Et.length;wt<zt;wt++){const _e=r.get(Et[wt]);_e.__webglTexture===void 0&&(_e.__webglTexture=s.createTexture(),f.memory.textures++)}if(L.samples>0&&ge(L)===!1){nt.__webglMultisampledFramebuffer=s.createFramebuffer(),nt.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,nt.__webglMultisampledFramebuffer);for(let wt=0;wt<Et.length;wt++){const zt=Et[wt];nt.__webglColorRenderbuffer[wt]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,nt.__webglColorRenderbuffer[wt]);const _e=c.convert(zt.format,zt.colorSpace),bt=c.convert(zt.type),Bt=U(zt.internalFormat,_e,bt,zt.colorSpace,L.isXRRenderTarget===!0),jt=ue(L);s.renderbufferStorageMultisample(s.RENDERBUFFER,jt,Bt,L.width,L.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+wt,s.RENDERBUFFER,nt.__webglColorRenderbuffer[wt])}s.bindRenderbuffer(s.RENDERBUFFER,null),L.depthBuffer&&(nt.__webglDepthRenderbuffer=s.createRenderbuffer(),St(nt.__webglDepthRenderbuffer,L,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(pt){i.bindTexture(s.TEXTURE_CUBE_MAP,ht.__webglTexture),it(s.TEXTURE_CUBE_MAP,A);for(let wt=0;wt<6;wt++)if(A.mipmaps&&A.mipmaps.length>0)for(let zt=0;zt<A.mipmaps.length;zt++)At(nt.__webglFramebuffer[wt][zt],L,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+wt,zt);else At(nt.__webglFramebuffer[wt],L,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+wt,0);M(A)&&x(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(kt){for(let wt=0,zt=Et.length;wt<zt;wt++){const _e=Et[wt],bt=r.get(_e);i.bindTexture(s.TEXTURE_2D,bt.__webglTexture),it(s.TEXTURE_2D,_e),At(nt.__webglFramebuffer,L,_e,s.COLOR_ATTACHMENT0+wt,s.TEXTURE_2D,0),M(_e)&&x(s.TEXTURE_2D)}i.unbindTexture()}else{let wt=s.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(wt=L.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(wt,ht.__webglTexture),it(wt,A),A.mipmaps&&A.mipmaps.length>0)for(let zt=0;zt<A.mipmaps.length;zt++)At(nt.__webglFramebuffer[zt],L,A,s.COLOR_ATTACHMENT0,wt,zt);else At(nt.__webglFramebuffer,L,A,s.COLOR_ATTACHMENT0,wt,0);M(A)&&x(wt),i.unbindTexture()}L.depthBuffer&&Ft(L)}function fe(L){const A=L.textures;for(let nt=0,ht=A.length;nt<ht;nt++){const Et=A[nt];if(M(Et)){const pt=B(L),kt=r.get(Et).__webglTexture;i.bindTexture(pt,kt),x(pt),i.unbindTexture()}}}const Xe=[],I=[];function Tn(L){if(L.samples>0){if(ge(L)===!1){const A=L.textures,nt=L.width,ht=L.height;let Et=s.COLOR_BUFFER_BIT;const pt=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,kt=r.get(L),wt=A.length>1;if(wt)for(let zt=0;zt<A.length;zt++)i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+zt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+zt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,kt.__webglMultisampledFramebuffer),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,kt.__webglFramebuffer);for(let zt=0;zt<A.length;zt++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(Et|=s.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(Et|=s.STENCIL_BUFFER_BIT)),wt){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,kt.__webglColorRenderbuffer[zt]);const _e=r.get(A[zt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,_e,0)}s.blitFramebuffer(0,0,nt,ht,0,0,nt,ht,Et,s.NEAREST),p===!0&&(Xe.length=0,I.length=0,Xe.push(s.COLOR_ATTACHMENT0+zt),L.depthBuffer&&L.resolveDepthBuffer===!1&&(Xe.push(pt),I.push(pt),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,I)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Xe))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),wt)for(let zt=0;zt<A.length;zt++){i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+zt,s.RENDERBUFFER,kt.__webglColorRenderbuffer[zt]);const _e=r.get(A[zt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+zt,s.TEXTURE_2D,_e,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,kt.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&p){const A=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[A])}}}function ue(L){return Math.min(l.maxSamples,L.samples)}function ge(L){const A=r.get(L);return L.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Yt(L){const A=f.render.frame;g.get(L)!==A&&(g.set(L,A),L.update())}function De(L,A){const nt=L.colorSpace,ht=L.format,Et=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||nt!==Ls&&nt!==Ha&&(Re.getTransfer(nt)===Ie?(ht!==Mi||Et!==ca)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",nt)),A}function Wt(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(m.width=L.naturalWidth||L.width,m.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(m.width=L.displayWidth,m.height=L.displayHeight):(m.width=L.width,m.height=L.height),m}this.allocateTextureUnit=ot,this.resetTextureUnits=ct,this.setTexture2D=tt,this.setTexture2DArray=O,this.setTexture3D=V,this.setTextureCube=W,this.rebindTextures=ie,this.setupRenderTarget=Ne,this.updateRenderTargetMipmap=fe,this.updateMultisampleRenderTarget=Tn,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=At,this.useMultisampledRTT=ge}function Db(s,t){function i(r,l=Ha){let c;const f=Re.getTransfer(l);if(r===ca)return s.UNSIGNED_BYTE;if(r===Ud)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Ld)return s.UNSIGNED_SHORT_5_5_5_1;if(r===jv)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===qv)return s.BYTE;if(r===Yv)return s.SHORT;if(r===Vo)return s.UNSIGNED_SHORT;if(r===Dd)return s.INT;if(r===Tr)return s.UNSIGNED_INT;if(r===sa)return s.FLOAT;if(r===Yo)return s.HALF_FLOAT;if(r===Zv)return s.ALPHA;if(r===Kv)return s.RGB;if(r===Mi)return s.RGBA;if(r===Qv)return s.LUMINANCE;if(r===Jv)return s.LUMINANCE_ALPHA;if(r===As)return s.DEPTH_COMPONENT;if(r===Us)return s.DEPTH_STENCIL;if(r===$v)return s.RED;if(r===Nd)return s.RED_INTEGER;if(r===t0)return s.RG;if(r===Od)return s.RG_INTEGER;if(r===Pd)return s.RGBA_INTEGER;if(r===Lc||r===Nc||r===Oc||r===Pc)if(f===Ie)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(r===Lc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Nc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Oc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Pc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(r===Lc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Nc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Oc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Pc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Jh||r===$h||r===td||r===ed)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(r===Jh)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===$h)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===td)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===ed)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===nd||r===id||r===ad)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(r===nd||r===id)return f===Ie?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(r===ad)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===rd||r===sd||r===od||r===ld||r===cd||r===ud||r===fd||r===hd||r===dd||r===pd||r===md||r===gd||r===_d||r===vd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(r===rd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===sd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===od)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===ld)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===cd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===ud)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===fd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===hd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===dd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===pd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===md)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===gd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===_d)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===vd)return f===Ie?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===zc||r===xd||r===yd)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(r===zc)return f===Ie?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===xd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===yd)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===e0||r===Sd||r===Md||r===Ed)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(r===zc)return c.COMPRESSED_RED_RGTC1_EXT;if(r===Sd)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Md)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Ed)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Ds?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const Ub={type:"move"};class Bh{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ga,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ga,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Q,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Q),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ga,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Q,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Q),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const i=this._hand;if(i)for(const r of t.hand.values())this._getHandJoint(i,r)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,i,r){let l=null,c=null,f=null;const d=this._targetRay,p=this._grip,m=this._hand;if(t&&i.session.visibilityState!=="visible-blurred"){if(m&&t.hand){f=!0;for(const R of t.hand.values()){const M=i.getJointPose(R,r),x=this._getHandJoint(m,R);M!==null&&(x.matrix.fromArray(M.transform.matrix),x.matrix.decompose(x.position,x.rotation,x.scale),x.matrixWorldNeedsUpdate=!0,x.jointRadius=M.radius),x.visible=M!==null}const g=m.joints["index-finger-tip"],_=m.joints["thumb-tip"],y=g.position.distanceTo(_.position),S=.02,E=.005;m.inputState.pinching&&y>S+E?(m.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!m.inputState.pinching&&y<=S-E&&(m.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else p!==null&&t.gripSpace&&(c=i.getPose(t.gripSpace,r),c!==null&&(p.matrix.fromArray(c.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,c.linearVelocity?(p.hasLinearVelocity=!0,p.linearVelocity.copy(c.linearVelocity)):p.hasLinearVelocity=!1,c.angularVelocity?(p.hasAngularVelocity=!0,p.angularVelocity.copy(c.angularVelocity)):p.hasAngularVelocity=!1));d!==null&&(l=i.getPose(t.targetRaySpace,r),l===null&&c!==null&&(l=c),l!==null&&(d.matrix.fromArray(l.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,l.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(l.linearVelocity)):d.hasLinearVelocity=!1,l.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(l.angularVelocity)):d.hasAngularVelocity=!1,this.dispatchEvent(Ub)))}return d!==null&&(d.visible=l!==null),p!==null&&(p.visible=c!==null),m!==null&&(m.visible=f!==null),this}_getHandJoint(t,i){if(t.joints[i.jointName]===void 0){const r=new Ga;r.matrixAutoUpdate=!1,r.visible=!1,t.joints[i.jointName]=r,t.add(r)}return t.joints[i.jointName]}}const Lb=`
void main() {
...
}`;class Ob{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i,r){if(this.texture===null){const l=new On,c=t.properties.get(l);c.__webglTexture=i.texture,(i.depthNear!=r.depthNear||i.depthFar!=r.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,r=new Wa({vertexShader:Lb,fragmentShader:Nb,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Xn(new Qo(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Pb extends Os{constructor(t,i){super();const r=this;let l=null,c=1,f=null,d="local-floor",p=1,m=null,g=null,_=null,y=null,S=null,E=null;const R=new Ob,M=i.getContextAttributes();let x=null,B=null;const U=[],w=[],K=new qt;let G=null;const P=new fi;P.viewport=new $e;const j=new fi;j.viewport=new $e;const D=[P,j],C=new eE;let H=null,ct=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let ut=U[Z];return ut===void 0&&(ut=new Bh,U[Z]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(Z){let ut=U[Z];return ut===void 0&&(ut=new Bh,U[Z]=ut),ut.getGripSpace()},this.getHand=function(Z){let ut=U[Z];return ut===void 0&&(ut=new Bh,U[Z]=ut),ut.getHandSpace()};function ot(Z){const ut=w.indexOf(Z.inputSource);if(ut===-1)return;const At=U[ut];At!==void 0&&(At.update(Z.inputSource,Z.frame,m||f),At.dispatchEvent({type:Z.type,data:Z.inputSource}))}function gt(){l.removeEventListener("select",ot),l.removeEventListener("selectstart",ot),l.removeEventListener("selectend",ot),l.removeEventListener("squeeze",ot),l.removeEventListener("squeezestart",ot),l.removeEventListener("squeezeend",ot),l.removeEventListener("end",gt),l.removeEventListener("inputsourceschange",tt);for(let Z=0;Z<U.length;Z++){const ut=w[Z];ut!==null&&(w[Z]=null,U[Z].disconnect(ut))}H=null,ct=null,R.reset(),t.setRenderTarget(x),S=null,y=null,_=null,l=null,B=null,Mt.stop(),r.isPresenting=!1,t.setPixelRatio(G),t.setSize(K.width,K.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){c=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){d=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||f},this.setReferenceSpace=function(Z){m=Z},this.getBaseLayer=function(){return y!==null?y:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return l},this.setSession=async function(Z){if(l=Z,l!==null){if(x=t.getRenderTarget(),l.addEventListener("select",ot),l.addEventListener("selectstart",ot),l.addEventListener("selectend",ot),l.addEventListener("squeeze",ot),l.addEventListener("squeezestart",ot),l.addEventListener("squeezeend",ot),l.addEventListener("end",gt),l.addEventListener("inputsourceschange",tt),M.xrCompatible!==!0&&await i.makeXRCompatible(),G=t.getPixelRatio(),t.getSize(K),l.renderState.layers===void 0){const ut={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:c};S=new XRWebGLLayer(l,i,ut),l.updateRenderState({baseLayer:S}),t.setPixelRatio(1),t.setSize(S.framebufferWidth,S.framebufferHeight,!1),B=new Ar(S.framebufferWidth,S.framebufferHeight,{format:Mi,type:ca,colorSpace:t.outputColorSpace,stencilBuffer:M.stencil})}else{let ut=null,At=null,St=null;M.depth&&(St=M.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,ut=M.stencil?Us:As,At=M.stencil?Ds:Tr);const Gt={colorFormat:i.RGBA8,depthFormat:St,scaleFactor:c};_=new XRWebGLBinding(l,i),y=_.createProjectionLayer(Gt),l.updateRenderState({layers:[y]}),t.setPixelRatio(1),t.setSize(y.textureWidth,y.textureHeight,!1),B=new Ar(y.textureWidth,y.textureHeight,{format:Mi,type:ca,depthTexture:new p0(y.textureWidth,y.textureHeight,At,void 0,void 0,void 0,void 0,void 0,void 0,ut),stencilBuffer:M.stencil,colorSpace:t.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1})}B.isXRRenderTarget=!0,this.setFoveation(p),m=null,f=await l.requestReferenceSpace(d),Mt.setContext(l),Mt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return R.getDepthTexture()};function tt(Z){for(let ut=0;ut<Z.removed.length;ut++){const At=Z.removed[ut],St=w.indexOf(At);St>=0&&(w[St]=null,U[St].disconnect(At))}for(let ut=0;ut<Z.added.length;ut++){const At=Z.added[ut];let St=w.indexOf(At);if(St===-1){for(let Ft=0;Ft<U.length;Ft++)if(Ft>=w.length){w.push(At),St=Ft;break}else if(w[Ft]===null){w[Ft]=At,St=Ft;break}if(St===-1)break}const Gt=U[St];Gt&&Gt.connect(At)}}const O=new Q,V=new Q;function W(Z,ut,At){O.setFromMatrixPosition(ut.matrixWorld),V.setFromMatrixPosition(At.matrixWorld);const St=O.distanceTo(V),Gt=ut.projectionMatrix.elements,Ft=At.projectionMatrix.elements,ie=Gt[14]/(Gt[10]-1),Ne=Gt[14]/(Gt[10]+1),fe=(Gt[9]+1)/Gt[5],Xe=(Gt[9]-1)/Gt[5],I=(Gt[8]-1)/Gt[0],Tn=(Ft[8]+1)/Ft[0],ue=ie*I,ge=ie*Tn,Yt=St/(-I+Tn),De=Yt*-I;if(ut.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(De),Z.translateZ(Yt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Gt[10]===-1)Z.projectionMatrix.copy(ut.projectionMatrix),Z.projectionMatrixInverse.copy(ut.projectionMatrixInverse);else{const Wt=ie+Yt,L=Ne+Yt,A=ue-De,nt=ge+(St-De),ht=fe*Ne/L*Wt,Et=Xe*Ne/L*Wt;Z.projectionMatrix.makePerspective(A,nt,ht,Et,Wt,L),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function xt(Z,ut){ut===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(ut.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(l===null)return;let ut=Z.near,At=Z.far;R.texture!==null&&(R.depthNear>0&&(ut=R.depthNear),R.depthFar>0&&(At=R.depthFar)),C.near=j.near=P.near=ut,C.far=j.far=P.far=At,(H!==C.near||ct!==C.far)&&(l.updateRenderState({depthNear:C.near,depthFar:C.far}),H=C.near,ct=C.far),P.layers.mask=Z.layers.mask|2,j.layers.mask=Z.layers.mask|4,C.layers.mask=P.layers.mask|j.layers.mask;const St=Z.parent,Gt=C.cameras;xt(C,St);for(let Ft=0;Ft<Gt.length;Ft++)xt(Gt[Ft],St);Gt.length===2?W(C,P,j):C.projectionMatrix.copy(P.projectionMatrix),Tt(Z,C,St)};function Tt(Z,ut,At){At===null?Z.matrix.copy(ut.matrixWorld):(Z.matrix.copy(At.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(ut.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(ut.projectionMatrix),Z.projectionMatrixInverse.copy(ut.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Td*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(y===null&&S===null))return p},this.setFoveation=function(Z){p=Z,y!==null&&(y.fixedFoveation=Z),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=Z)},this.hasDepthSensing=function(){return R.texture!==null},this.getDepthSensingMesh=function(){return R.getMesh(C)};let N=null;function it(Z,ut){if(g=ut.getViewerPose(m||f),E=ut,g!==null){const At=g.views;S!==null&&(t.setRenderTargetFramebuffer(B,S.framebuffer),t.setRenderTarget(B));let St=!1;At.length!==C.cameras.length&&(C.cameras.length=0,St=!0);for(let Ft=0;Ft<At.length;Ft++){const ie=At[Ft];let Ne=null;if(S!==null)Ne=S.getViewport(ie);else{const Xe=_.getViewSubImage(y,ie);Ne=Xe.viewport,Ft===0&&(t.setRenderTargetTextures(B,Xe.colorTexture,y.ignoreDepthValues?void 0:Xe.depthStencilTexture),t.setRenderTarget(B))}let fe=D[Ft];fe===void 0&&(fe=new fi,fe.layers.enable(Ft),fe.viewport=new $e,D[Ft]=fe),fe.matrix.fromArray(ie.transform.matrix),fe.matrix.decompose(fe.position,fe.quaternion,fe.scale),fe.projectionMatrix.fromArray(ie.projectionMatrix),fe.projectionMatrixInverse.copy(fe.projectionMatrix).invert(),fe.viewport.set(Ne.x,Ne.y,Ne.width,Ne.height),Ft===0&&(C.matrix.copy(fe.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),St===!0&&C.cameras.push(fe)}const Gt=l.enabledFeatures;if(Gt&&Gt.includes("depth-sensing")){const Ft=_.getDepthInformation(At[0]);Ft&&Ft.isValid&&Ft.texture&&R.init(t,Ft,l.renderState)}}for(let At=0;At<U.length;At++){const St=w[At],Gt=U[At];St!==null&&Gt!==void 0&&Gt.update(St,ut,m||f)}N&&N(Z,ut),ut.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ut}),E=null}const Mt=new A0;Mt.setAnimationLoop(it),this.setAnimationLoop=function(Z){N=Z},this.dispose=function(){}}}const _r=new Ni,zb=new je;function Bb(s,t){function i(M,x){M.matrixAutoUpdate===!0&&M.updateMatrix(),x.value.copy(M.matrix)}function r(M,x){x.color.getRGB(M.fogColor.value,f0(s)),x.isFog?(M.fogNear.value=x.near,M.fogFar.value=x.far):x.isFogExp2&&(M.fogDensity.value=x.density)}function l(M,x,B,U,w){x.isMeshBasicMaterial||x.isMeshLambertMaterial?c(M,x):x.isMeshToonMaterial?(c(M,x),_(M,x)):x.isMeshPhongMaterial?(c(M,x),g(M,x)):x.isMeshStandardMaterial?(c(M,x),y(M,x),x.isMeshPhysicalMaterial&&S(M,x,w)):x.isMeshMatcapMaterial?(c(M,x),E(M,x)):x.isMeshDepthMaterial?c(M,x):x.isMeshDistanceMaterial?(c(M,x),R(M,x)):x.isMeshNormalMaterial?c(M,x):x.isLineBasicMaterial?(f(M,x),x.isLineDashedMaterial&&d(M,x)):x.isPointsMaterial?p(M,x,B,U):x.isSpriteMaterial?m(M,x):x.isShadowMaterial?(M.color.value.copy(x.color),M.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function c(M,x){M.opacity.value=x.opacity,x.color&&M.diffuse.value.copy(x.color),x.emissive&&M.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.bumpMap&&(M.bumpMap.value=x.bumpMap,i(x.bumpMap,M.bumpMapTransform),M.bumpScale.value=x.bumpScale,x.side===Wn&&(M.bumpScale.value*=-1)),x.normalMap&&(M.normalMap.value=x.normalMap,i(x.normalMap,M.normalMapTransform),M.normalScale.value.copy(x.normalScale),x.side===Wn&&M.normalScale.value.negate()),x.displacementMap&&(M.displacementMap.value=x.displacementMap,i(x.displacementMap,M.displacementMapTransform),M.displacementScale.value=x.displacementScale,M.displacementBias.value=x.displacementBias),x.emissiveMap&&(M.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,M.emissiveMapTransform)),x.specularMap&&(M.specularMap.value=x.specularMap,i(x.specularMap,M.specularMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest);const B=t.get(x),U=B.envMap,w=B.envMapRotation;U&&(M.envMap.value=U,_r.copy(w),_r.x*=-1,_r.y*=-1,_r.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(_r.y*=-1,_r.z*=-1),M.envMapRotation.value.setFromMatrix4(zb.makeRotationFromEuler(_r)),M.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=x.reflectivity,M.ior.value=x.ior,M.refractionRatio.value=x.refractionRatio),x.lightMap&&(M.lightMap.value=x.lightMap,M.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,M.lightMapTransform)),x.aoMap&&(M.aoMap.value=x.aoMap,M.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,M.aoMapTransform))}function f(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform))}function d(M,x){M.dashSize.value=x.dashSize,M.totalSize.value=x.dashSize+x.gapSize,M.scale.value=x.scale}function p(M,x,B,U){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.size.value=x.size*B,M.scale.value=U*.5,x.map&&(M.map.value=x.map,i(x.map,M.uvTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function m(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.rotation.value=x.rotation,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function g(M,x){M.specular.value.copy(x.specular),M.shininess.value=Math.max(x.shininess,1e-4)}function _(M,x){x.gradientMap&&(M.gradientMap.value=x.gradientMap)}function y(M,x){M.metalness.value=x.metalness,x.metalnessMap&&(M.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,M.metalnessMapTransform)),M.roughness.value=x.roughness,x.roughnessMap&&(M.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,M.roughnessMapTransform)),x.envMap&&(M.envMapIntensity.value=x.envMapIntensity)}function S(M,x,B){M.ior.value=x.ior,x.sheen>0&&(M.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),M.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(M.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,M.sheenColorMapTransform)),x.sheenRoughnessMap&&(M.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,M.sheenRoughnessMapTransform))),x.clearcoat>0&&(M.clearcoat.value=x.clearcoat,M.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(M.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,M.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(M.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Wn&&M.clearcoatNormalScale.value.negate())),x.dispersion>0&&(M.dispersion.value=x.dispersion),x.iridescence>0&&(M.iridescence.value=x.iridescence,M.iridescenceIOR.value=x.iridescenceIOR,M.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(M.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,M.iridescenceMapTransform)),x.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),x.transmission>0&&(M.transmission.value=x.transmission,M.transmissionSamplerMap.value=B.texture,M.transmissionSamplerSize.value.set(B.width,B.height),x.transmissionMap&&(M.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,M.transmissionMapTransform)),M.thickness.value=x.thickness,x.thicknessMap&&(M.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=x.attenuationDistance,M.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(M.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(M.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=x.specularIntensity,M.specularColor.value.copy(x.specularColor),x.specularColorMap&&(M.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,M.specularColorMapTransform)),x.specularIntensityMap&&(M.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,M.specularIntensityMapTransform))}function E(M,x){x.matcap&&(M.matcap.value=x.matcap)}function R(M,x){const B=t.get(x).light;M.referencePosition.value.setFromMatrixPosition(B.matrixWorld),M.nearDistance.value=B.shadow.camera.near,M.farDistance.value=B.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function Ib(s,t,i,r){let l={},c={},f=[];const d=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(B,U){const w=U.program;r.uniformBlockBinding(B,w)}function m(B,U){let w=l[B.id];w===void 0&&(E(B),w=g(B),l[B.id]=w,B.addEventListener("dispose",M));const K=U.program;r.updateUBOMapping(B,K);const G=t.render.frame;c[B.id]!==G&&(y(B),c[B.id]=G)}function g(B){const U=_();B.__bindingPointIndex=U;const w=s.createBuffer(),K=B.__size,G=B.usage;return s.bindBuffer(s.UNIFORM_BUFFER,w),s.bufferData(s.UNIFORM_BUFFER,K,G),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,U,w),w}function _(){for(let B=0;B<d;B++)if(f.indexOf(B)===-1)return f.push(B),B;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(B){const U=l[B.id],w=B.uniforms,K=B.__cache;s.bindBuffer(s.UNIFORM_BUFFER,U);for(let G=0,P=w.length;G<P;G++){const j=Array.isArray(w[G])?w[G]:[w[G]];for(let D=0,C=j.length;D<C;D++){const H=j[D];if(S(H,G,D,K)===!0){const ct=H.__offset,ot=Array.isArray(H.value)?H.value:[H.value];let gt=0;for(let tt=0;tt<ot.length;tt++){const O=ot[tt],V=R(O);typeof O=="number"||typeof O=="boolean"?(H.__data[0]=O,s.bufferSubData(s.UNIFORM_BUFFER,ct+gt,H.__data)):O.isMatrix3?(H.__data[0]=O.elements[0],H.__data[1]=O.elements[1],H.__data[2]=O.elements[2],H.__data[3]=0,H.__data[4]=O.elements[3],H.__data[5]=O.elements[4],H.__data[6]=O.elements[5],H.__data[7]=0,H.__data[8]=O.elements[6],H.__data[9]=O.elements[7],H.__data[10]=O.elements[8],H.__data[11]=0):(O.toArray(H.__data,gt),gt+=V.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,ct,H.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(B,U,w,K){const G=B.value,P=U+"_"+w;if(K[P]===void 0)return typeof G=="number"||typeof G=="boolean"?K[P]=G:K[P]=G.clone(),!0;{const j=K[P];if(typeof G=="number"||typeof G=="boolean"){if(j!==G)return K[P]=G,!0}else if(j.equals(G)===!1)return j.copy(G),!0}return!1}function E(B){const U=B.uniforms;let w=0;const K=16;for(let P=0,j=U.length;P<j;P++){const D=Array.isArray(U[P])?U[P]:[U[P]];for(let C=0,H=D.length;C<H;C++){const ct=D[C],ot=Array.isArray(ct.value)?ct.value:[ct.value];for(let gt=0,tt=ot.length;gt<tt;gt++){const O=ot[gt],V=R(O),W=w%K,xt=W%V.boundary,Tt=W+xt;w+=xt,Tt!==0&&K-Tt<V.storage&&(w+=K-Tt),ct.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),ct.__offset=w,w+=V.storage}}}const G=w%K;return G>0&&(w+=K-G),B.__size=w,B.__cache={},this}function R(B){const U={boundary:0,storage:0};return typeof B=="number"||typeof B=="boolean"?(U.boundary=4,U.storage=4):B.isVector2?(U.boundary=8,U.storage=8):B.isVector3||B.isColor?(U.boundary=16,U.storage=12):B.isVector4?(U.boundary=16,U.storage=16):B.isMatrix3?(U.boundary=48,U.storage=48):B.isMatrix4?(U.boundary=64,U.storage=64):B.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",B),U}function M(B){const U=B.target;U.removeEventListener("dispose",M);const w=f.indexOf(U.__bindingPointIndex);f.splice(w,1),s.deleteBuffer(l[U.id]),delete l[U.id],delete c[U.id]}function x(){for(const B in l)s.deleteBuffer(l[B]);f=[],l={},c={}}return{bind:p,update:m,dispose:x}}class Fb{constructor(t={}){const{canvas:i=VS(),context:r=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:d=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:y=!1}=t;this.isWebGLRenderer=!0;let S;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=r.getContextAttributes().alpha}else S=f;const E=new Uint32Array(4),R=new Int32Array(4);let M=null,x=null;const B=[],U=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Vn,this.toneMapping=ka,this.toneMappingExposure=1;const w=this;let K=!1,G=0,P=0,j=null,D=-1,C=null;const H=new $e,ct=new $e;let ot=null;const gt=new we(0);let tt=0,O=i.width,V=i.height,W=1,xt=null,Tt=null;const N=new $e(0,0,O,V),it=new $e(0,0,O,V);let Mt=!1;const Z=new Bd;let ut=!1,At=!1;const St=new je,Gt=new je,Ft=new Q,ie=new $e,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let fe=!1;function Xe(){return j===null?W:1}let I=r;function Tn(b,X){return i.getContext(b,X)}try{const b={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${wd}`),i.addEventListener("webglcontextlost",_t,!1),i.addEventListener("webglcontextrestored",Ct,!1),i.addEventListener("webglcontextcreationerror",Dt,!1),I===null){const X="webgl2";if(I=Tn(X,b),I===null)throw Tn(X)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let ue,ge,Yt,De,Wt,L,A,nt,ht,Et,pt,kt,wt,zt,_e,bt,Bt,jt,Xt,Nt,$t,ae,Oe,k;function Rt(){ue=new j1(I),ue.init(),ae=new Db(I,ue),ge=new V1(I,ue,t,ae),Yt=new Cb(I,ue),ge.reverseDepthBuffer&&y&&Yt.buffers.depth.setReversed(!0),De=new Q1(I),Wt=new mb,L=new wb(I,ue,Yt,Wt,ge,ae,De),A=new X1(w),nt=new Y1(w),ht=new aE(I),Oe=new H1(I,ht),Et=new Z1(I,ht,De,Oe),pt=new $1(I,Et,ht,De),Xt=new J1(I,ge,L),bt=new k1(Wt),kt=new pb(w,A,nt,ue,ge,Oe,bt),wt=new Bb(w,Wt),zt=new _b,_e=new Eb(ue),jt=new F1(w,A,nt,Yt,pt,S,p),Bt=new bb(w,pt,ge),k=new Ib(I,De,ge,Yt),Nt=new G1(I,ue,De),$t=new K1(I,ue,De),De.programs=kt.programs,w.capabilities=ge,w.extensions=ue,w.properties=Wt,w.renderLists=zt,w.shadowMap=Bt,w.state=Yt,w.info=De}Rt();const lt=new Pb(w,I);this.xr=lt,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const b=ue.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=ue.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return W},this.setPixelRatio=function(b){b!==void 0&&(W=b,this.setSize(O,V,!1))},this.getSize=function(b){return b.set(O,V)},this.setSize=function(b,X,at=!0){if(lt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}O=b,V=X,i.width=Math.floor(b*W),i.height=Math.floor(X*W),at===!0&&(i.style.width=b+"px",i.style.height=X+"px"),this.setViewport(0,0,b,X)},this.getDrawingBufferSize=function(b){return b.set(O*W,V*W).floor()},this.setDrawingBufferSize=function(b,X,at){O=b,V=X,W=at,i.width=Math.floor(b*at),i.height=Math.floor(X*at),this.setViewport(0,0,b,X)},this.getCurrentViewport=function(b){return b.copy(H)},this.getViewport=function(b){return b.copy(N)},this.setViewport=function(b,X,at,rt){b.isVector4?N.set(b.x,b.y,b.z,b.w):N.set(b,X,at,rt),Yt.viewport(H.copy(N).multiplyScalar(W).round())},this.getScissor=function(b){return b.copy(it)},this.setScissor=function(b,X,at,rt){b.isVector4?it.set(b.x,b.y,b.z,b.w):it.set(b,X,at,rt),Yt.scissor(ct.copy(it).multiplyScalar(W).round())},this.getScissorTest=function(){return Mt},this.setScissorTest=function(b){Yt.setScissorTest(Mt=b)},this.setOpaqueSort=function(b){xt=b},this.setTransparentSort=function(b){Tt=b},this.getClearColor=function(b){return b.copy(jt.getClearColor())},this.setClearColor=function(){jt.setClearColor.apply(jt,arguments)},this.getClearAlpha=function(){return jt.getClearAlpha()},this.setClearAlpha=function(){jt.setClearAlpha.apply(jt,arguments)},this.clear=function(b=!0,X=!0,at=!0){let rt=0;if(b){let q=!1;if(j!==null){const vt=j.texture.format;q=vt===Pd||vt===Od||vt===Nd}if(q){const vt=j.texture.type,Ut=vt===ca||vt===Tr||vt===Vo||vt===Ds||vt===Ud||vt===Ld,Pt=jt.getClearColor(),Ot=jt.getClearAlpha(),Qt=Pt.r,ee=Pt.g,Zt=Pt.b;Ut?(E[0]=Qt,E[1]=ee,E[2]=Zt,E[3]=Ot,I.clearBufferuiv(I.COLOR,0,E)):(R[0]=Qt,R[1]=ee,R[2]=Zt,R[3]=Ot,I.clearBufferiv(I.COLOR,0,R))}else rt|=I.COLOR_BUFFER_BIT}X&&(rt|=I.DEPTH_BUFFER_BIT),at&&(rt|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(rt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",_t,!1),i.removeEventListener("webglcontextrestored",Ct,!1),i.removeEventListener("webglcontextcreationerror",Dt,!1),jt.dispose(),zt.dispose(),_e.dispose(),Wt.dispose(),A.dispose(),nt.dispose(),pt.dispose(),Oe.dispose(),k.dispose(),kt.dispose(),lt.dispose(),lt.removeEventListener("sessionstart",Is),lt.removeEventListener("sessionend",Fs),Ti.stop()};function _t(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),K=!0}function Ct(){console.log("THREE.WebGLRenderer: Context Restored."),K=!1;const b=De.autoReset,X=Bt.enabled,at=Bt.autoUpdate,rt=Bt.needsUpdate,q=Bt.type;Rt(),De.autoReset=b,Bt.enabled=X,Bt.autoUpdate=at,Bt.needsUpdate=rt,Bt.type=q}function Dt(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function te(b){const X=b.target;X.removeEventListener("dispose",te),We(X)}function We(b){un(b),Wt.remove(b)}function un(b){const X=Wt.get(b).programs;X!==void 0&&(X.forEach(function(at){kt.releaseProgram(at)}),b.isShaderMaterial&&kt.releaseShaderCache(b))}this.renderBufferDirect=function(b,X,at,rt,q,vt){X===null&&(X=Ne);const Ut=q.isMesh&&q.matrixWorld.determinant()<0,Pt=Gs(b,X,at,rt,q);Yt.setMaterial(rt,Ut);let Ot=at.index,Qt=1;if(rt.wireframe===!0){if(Ot=Et.getWireframeAttribute(at),Ot===void 0)return;Qt=2}const ee=at.drawRange,Zt=at.attributes.position;let ve=ee.start*Qt,Ee=(ee.start+ee.count)*Qt;vt!==null&&(ve=Math.max(ve,vt.start*Qt),Ee=Math.min(Ee,(vt.start+vt.count)*Qt)),Ot!==null?(ve=Math.max(ve,0),Ee=Math.min(Ee,Ot.count)):Zt!=null&&(ve=Math.max(ve,0),Ee=Math.min(Ee,Zt.count));const Ge=Ee-ve;if(Ge<0||Ge===1/0)return;Oe.setup(q,rt,Pt,at,Ot);let Fe,re=Nt;if(Ot!==null&&(Fe=ht.get(Ot),re=$t,re.setIndex(Fe)),q.isMesh)rt.wireframe===!0?(Yt.setLineWidth(rt.wireframeLinewidth*Xe()),re.setMode(I.LINES)):re.setMode(I.TRIANGLES);else if(q.isLine){let Ht=rt.linewidth;Ht===void 0&&(Ht=1),Yt.setLineWidth(Ht*Xe()),q.isLineSegments?re.setMode(I.LINES):q.isLineLoop?re.setMode(I.LINE_LOOP):re.setMode(I.LINE_STRIP)}else q.isPoints?re.setMode(I.POINTS):q.isSprite&&re.setMode(I.TRIANGLES);if(q.isBatchedMesh)if(q._multiDrawInstances!==null)re.renderMultiDrawInstances(q._multiDrawStarts,q._multiDrawCounts,q._multiDrawCount,q._multiDrawInstances);else if(ue.get("WEBGL_multi_draw"))re.renderMultiDraw(q._multiDrawStarts,q._multiDrawCounts,q._multiDrawCount);else{const Ht=q._multiDrawStarts,an=q._multiDrawCounts,Te=q._multiDrawCount,Dn=Ot?ht.get(Ot).bytesPerElement:1,zi=Wt.get(rt).currentProgram.getUniforms();for(let mn=0;mn<Te;mn++)zi.setValue(I,"_gl_DrawID",mn),re.render(Ht[mn]/Dn,an[mn])}else if(q.isInstancedMesh)re.renderInstances(ve,Ge,q.count);else if(at.isInstancedBufferGeometry){const Ht=at._maxInstanceCount!==void 0?at._maxInstanceCount:1/0,an=Math.min(at.instanceCount,Ht);re.renderInstances(ve,Ge,an)}else re.render(ve,Ge)};function Me(b,X,at){b.transparent===!0&&b.side===hi&&b.forceSinglePass===!1?(b.side=Wn,b.needsUpdate=!0,Ze(b,X,at),b.side=Xa,b.needsUpdate=!0,Ze(b,X,at),b.side=hi):Ze(b,X,at)}this.compile=function(b,X,at=null){at===null&&(at=b),x=_e.get(at),x.init(X),U.push(x),at.traverseVisible(function(q){q.isLight&&q.layers.test(X.layers)&&(x.pushLight(q),q.castShadow&&x.pushShadow(q))}),b!==at&&b.traverseVisible(function(q){q.isLight&&q.layers.test(X.layers)&&(x.pushLight(q),q.castShadow&&x.pushShadow(q))}),x.setupLights();const rt=new Set;return b.traverse(function(q){if(!(q.isMesh||q.isPoints||q.isLine||q.isSprite))return;const vt=q.material;if(vt)if(Array.isArray(vt))for(let Ut=0;Ut<vt.length;Ut++){const Pt=vt[Ut];Me(Pt,at,q),rt.add(Pt)}else Me(vt,at,q),rt.add(vt)}),U.pop(),x=null,rt},this.compileAsync=function(b,X,at=null){const rt=this.compile(b,X,at);return new Promise(q=>{function vt(){if(rt.forEach(function(Ut){Wt.get(Ut).currentProgram.isReady()&&rt.delete(Ut)}),rt.size===0){q(b);return}setTimeout(vt,10)}ue.get("KHR_parallel_shader_compile")!==null?vt():setTimeout(vt,10)})};let vn=null;function di(b){vn&&vn(b)}function Is(){Ti.stop()}function Fs(){Ti.start()}const Ti=new A0;Ti.setAnimationLoop(di),typeof self<"u"&&Ti.setContext(self),this.setAnimationLoop=function(b){vn=b,lt.setAnimationLoop(b),b===null?Ti.stop():Ti.start()},lt.addEventListener("sessionstart",Is),lt.addEventListener("sessionend",Fs),this.render=function(b,X){if(X!==void 0&&X.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(K===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),X.parent===null&&X.matrixWorldAutoUpdate===!0&&X.updateMatrixWorld(),lt.enabled===!0&&lt.isPresenting===!0&&(lt.cameraAutoUpdate===!0&&lt.updateCamera(X),X=lt.getCamera()),b.isScene===!0&&b.onBeforeRender(w,b,X,j),x=_e.get(b,U.length),x.init(X),U.push(x),Gt.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),Z.setFromProjectionMatrix(Gt),At=this.localClippingEnabled,ut=bt.init(this.clippingPlanes,At),M=zt.get(b,B.length),M.init(),B.push(M),lt.enabled===!0&&lt.isPresenting===!0){const vt=w.xr.getDepthSensingMesh();vt!==null&&qa(vt,X,-1/0,w.sortObjects)}qa(b,X,0,w.sortObjects),M.finish(),w.sortObjects===!0&&M.sort(xt,Tt),fe=lt.enabled===!1||lt.isPresenting===!1||lt.hasDepthSensing()===!1,fe&&jt.addToRenderList(M,b),this.info.render.frame++,ut===!0&&bt.beginShadows();const at=x.state.shadowsArray;Bt.render(at,b,X),ut===!0&&bt.endShadows(),this.info.autoReset===!0&&this.info.reset();const rt=M.opaque,q=M.transmissive;if(x.setupLights(),X.isArrayCamera){const vt=X.cameras;if(q.length>0)for(let Ut=0,Pt=vt.length;Ut<Pt;Ut++){const Ot=vt[Ut];Hs(rt,q,b,Ot)}fe&&jt.render(b);for(let Ut=0,Pt=vt.length;Ut<Pt;Ut++){const Ot=vt[Ut];Rr(M,b,Ot,Ot.viewport)}}else q.length>0&&Hs(rt,q,b,X),fe&&jt.render(b),Rr(M,b,X);j!==null&&(L.updateMultisampleRenderTarget(j),L.updateRenderTargetMipmap(j)),b.isScene===!0&&b.onAfterRender(w,b,X),Oe.resetDefaultState(),D=-1,C=null,U.pop(),U.length>0?(x=U[U.length-1],ut===!0&&bt.setGlobalState(w.clippingPlanes,x.state.camera)):x=null,B.pop(),B.length>0?M=B[B.length-1]:M=null};function qa(b,X,at,rt){if(b.visible===!1)return;if(b.layers.test(X.layers)){if(b.isGroup)at=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(X);else if(b.isLight)x.pushLight(b),b.castShadow&&x.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Z.intersectsSprite(b)){rt&&ie.setFromMatrixPosition(b.matrixWorld).applyMatrix4(Gt);const Ut=pt.update(b),Pt=b.material;Pt.visible&&M.push(b,Ut,Pt,at,ie.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Z.intersectsObject(b))){const Ut=pt.update(b),Pt=b.material;if(rt&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),ie.copy(b.boundingSphere.center)):(Ut.boundingSphere===null&&Ut.computeBoundingSphere(),ie.copy(Ut.boundingSphere.center)),ie.applyMatrix4(b.matrixWorld).applyMatrix4(Gt)),Array.isArray(Pt)){const Ot=Ut.groups;for(let Qt=0,ee=Ot.length;Qt<ee;Qt++){const Zt=Ot[Qt],ve=Pt[Zt.materialIndex];ve&&ve.visible&&M.push(b,Ut,ve,at,ie.z,Zt)}}else Pt.visible&&M.push(b,Ut,Pt,at,ie.z,null)}}const vt=b.children;for(let Ut=0,Pt=vt.length;Ut<Pt;Ut++)qa(vt[Ut],X,at,rt)}function Rr(b,X,at,rt){const q=b.opaque,vt=b.transmissive,Ut=b.transparent;x.setupLightsView(at),ut===!0&&bt.setGlobalState(w.clippingPlanes,at),rt&&Yt.viewport(H.copy(rt)),q.length>0&&Ya(q,X,at),vt.length>0&&Ya(vt,X,at),Ut.length>0&&Ya(Ut,X,at),Yt.buffers.depth.setTest(!0),Yt.buffers.depth.setMask(!0),Yt.buffers.color.setMask(!0),Yt.setPolygonOffset(!1)}function Hs(b,X,at,rt){if((at.isScene===!0?at.overrideMaterial:null)!==null)return;x.state.transmissionRenderTarget[rt.id]===void 0&&(x.state.transmissionRenderTarget[rt.id]=new Ar(1,1,{generateMipmaps:!0,type:ue.has("EXT_color_buffer_half_float")||ue.has("EXT_color_buffer_float")?Yo:ca,minFilter:Er,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Re.workingColorSpace}));const vt=x.state.transmissionRenderTarget[rt.id],Ut=rt.viewport||H;vt.setSize(Ut.z,Ut.w);const Pt=w.getRenderTarget();w.setRenderTarget(vt),w.getClearColor(gt),tt=w.getClearAlpha(),tt<1&&w.setClearColor(16777215,.5),w.clear(),fe&&jt.render(at);const Ot=w.toneMapping;w.toneMapping=ka;const Qt=rt.viewport;if(rt.viewport!==void 0&&(rt.viewport=void 0),x.setupLightsView(rt),ut===!0&&bt.setGlobalState(w.clippingPlanes,rt),Ya(b,at,rt),L.updateMultisampleRenderTarget(vt),L.updateRenderTargetMipmap(vt),ue.has("WEBGL_multisampled_render_to_texture")===!1){let ee=!1;for(let Zt=0,ve=X.length;Zt<ve;Zt++){const Ee=X[Zt],Ge=Ee.object,Fe=Ee.geometry,re=Ee.material,Ht=Ee.group;if(re.side===hi&&Ge.layers.test(rt.layers)){const an=re.side;re.side=Wn,re.needsUpdate=!0,pi(Ge,at,rt,Fe,re,Ht),re.side=an,re.needsUpdate=!0,ee=!0}}ee===!0&&(L.updateMultisampleRenderTarget(vt),L.updateRenderTargetMipmap(vt))}w.setRenderTarget(Pt),w.setClearColor(gt,tt),Qt!==void 0&&(rt.viewport=Qt),w.toneMapping=Ot}function Ya(b,X,at){const rt=X.isScene===!0?X.overrideMaterial:null;for(let q=0,vt=b.length;q<vt;q++){const Ut=b[q],Pt=Ut.object,Ot=Ut.geometry,Qt=rt===null?Ut.material:rt,ee=Ut.group;Pt.layers.test(at.layers)&&pi(Pt,X,at,Ot,Qt,ee)}}function pi(b,X,at,rt,q,vt){b.onBeforeRender(w,X,at,rt,q,vt),b.modelViewMatrix.multiplyMatrices(at.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),q.onBeforeRender(w,X,at,rt,b,vt),q.transparent===!0&&q.side===hi&&q.forceSinglePass===!1?(q.side=Wn,q.needsUpdate=!0,w.renderBufferDirect(at,X,rt,q,b,vt),q.side=Xa,q.needsUpdate=!0,w.renderBufferDirect(at,X,rt,q,b,vt),q.side=hi):w.renderBufferDirect(at,X,rt,q,b,vt),b.onAfterRender(w,X,at,rt,q,vt)}function Ze(b,X,at){X.isScene!==!0&&(X=Ne);const rt=Wt.get(b),q=x.state.lights,vt=x.state.shadowsArray,Ut=q.state.version,Pt=kt.getParameters(b,q.state,vt,X,at),Ot=kt.getProgramCacheKey(Pt);let Qt=rt.programs;rt.environment=b.isMeshStandardMaterial?X.environment:null,rt.fog=X.fog,rt.envMap=(b.isMeshStandardMaterial?nt:A).get(b.envMap||rt.environment),rt.envMapRotation=rt.environment!==null&&b.envMap===null?X.environmentRotation:b.envMapRotation,Qt===void 0&&(b.addEventListener("dispose",te),Qt=new Map,rt.programs=Qt);let ee=Qt.get(Ot);if(ee!==void 0){if(rt.currentProgram===ee&&rt.lightsStateVersion===Ut)return Pi(b,Pt),ee}else Pt.uniforms=kt.getUniforms(b),b.onBeforeCompile(Pt,w),ee=kt.acquireProgram(Pt,Ot),Qt.set(Ot,ee),rt.uniforms=Pt.uniforms;const Zt=rt.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Zt.clippingPlanes=bt.uniform),Pi(b,Pt),rt.needsLights=Wc(b),rt.lightsStateVersion=Ut,rt.needsLights&&(Zt.ambientLightColor.value=q.state.ambient,Zt.lightProbe.value=q.state.probe,Zt.directionalLights.value=q.state.directional,Zt.directionalLightShadows.value=q.state.directionalShadow,Zt.spotLights.value=q.state.spot,Zt.spotLightShadows.value=q.state.spotShadow,Zt.rectAreaLights.value=q.state.rectArea,Zt.ltc_1.value=q.state.rectAreaLTC1,Zt.ltc_2.value=q.state.rectAreaLTC2,Zt.pointLights.value=q.state.point,Zt.pointLightShadows.value=q.state.pointShadow,Zt.hemisphereLights.value=q.state.hemi,Zt.directionalShadowMap.value=q.state.directionalShadowMap,Zt.directionalShadowMatrix.value=q.state.directionalShadowMatrix,Zt.spotShadowMap.value=q.state.spotShadowMap,Zt.spotLightMatrix.value=q.state.spotLightMatrix,Zt.spotLightMap.value=q.state.spotLightMap,Zt.pointShadowMap.value=q.state.pointShadowMap,Zt.pointShadowMatrix.value=q.state.pointShadowMatrix),rt.currentProgram=ee,rt.uniformsList=null,ee}function xn(b){if(b.uniformsList===null){const X=b.currentProgram.getUniforms();b.uniformsList=Bc.seqWithValue(X.seq,b.uniforms)}return b.uniformsList}function Pi(b,X){const at=Wt.get(b);at.outputColorSpace=X.outputColorSpace,at.batching=X.batching,at.batchingColor=X.batchingColor,at.instancing=X.instancing,at.instancingColor=X.instancingColor,at.instancingMorph=X.instancingMorph,at.skinning=X.skinning,at.morphTargets=X.morphTargets,at.morphNormals=X.morphNormals,at.morphColors=X.morphColors,at.morphTargetsCount=X.morphTargetsCount,at.numClippingPlanes=X.numClippingPlanes,at.numIntersection=X.numClipIntersection,at.vertexAlphas=X.vertexAlphas,at.vertexTangents=X.vertexTangents,at.toneMapping=X.toneMapping}function Gs(b,X,at,rt,q){X.isScene!==!0&&(X=Ne),L.resetTextureUnits();const vt=X.fog,Ut=rt.isMeshStandardMaterial?X.environment:null,Pt=j===null?w.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:Ls,Ot=(rt.isMeshStandardMaterial?nt:A).get(rt.envMap||Ut),Qt=rt.vertexColors===!0&&!!at.attributes.color&&at.attributes.color.itemSize===4,ee=!!at.attributes.tangent&&(!!rt.normalMap||rt.anisotropy>0),Zt=!!at.morphAttributes.position,ve=!!at.morphAttributes.normal,Ee=!!at.morphAttributes.color;let Ge=ka;rt.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Ge=w.toneMapping);const Fe=at.morphAttributes.position||at.morphAttributes.normal||at.morphAttributes.color,re=Fe!==void 0?Fe.length:0,Ht=Wt.get(rt),an=x.state.lights;if(ut===!0&&(At===!0||b!==C)){const fn=b===C&&rt.id===D;bt.setState(rt,b,fn)}let Te=!1;rt.version===Ht.__version?(Ht.needsLights&&Ht.lightsStateVersion!==an.state.version||Ht.outputColorSpace!==Pt||q.isBatchedMesh&&Ht.batching===!1||!q.isBatchedMesh&&Ht.batching===!0||q.isBatchedMesh&&Ht.batchingColor===!0&&q.colorTexture===null||q.isBatchedMesh&&Ht.batchingColor===!1&&q.colorTexture!==null||q.isInstancedMesh&&Ht.instancing===!1||!q.isInstancedMesh&&Ht.instancing===!0||q.isSkinnedMesh&&Ht.skinning===!1||!q.isSkinnedMesh&&Ht.skinning===!0||q.isInstancedMesh&&Ht.instancingColor===!0&&q.instanceColor===null||q.isInstancedMesh&&Ht.instancingColor===!1&&q.instanceColor!==null||q.isInstancedMesh&&Ht.instancingMorph===!0&&q.morphTexture===null||q.isInstancedMesh&&Ht.instancingMorph===!1&&q.morphTexture!==null||Ht.envMap!==Ot||rt.fog===!0&&Ht.fog!==vt||Ht.numClippingPlanes!==void 0&&(Ht.numClippingPlanes!==bt.numPlanes||Ht.numIntersection!==bt.numIntersection)||Ht.vertexAlphas!==Qt||Ht.vertexTangents!==ee||Ht.morphTargets!==Zt||Ht.morphNormals!==ve||Ht.morphColors!==Ee||Ht.toneMapping!==Ge||Ht.morphTargetsCount!==re)&&(Te=!0):(Te=!0,Ht.__version=rt.version);let Dn=Ht.currentProgram;Te===!0&&(Dn=Ze(rt,X,q));let zi=!1,mn=!1,Za=!1;const he=Dn.getUniforms(),An=Ht.uniforms;if(Yt.useProgram(Dn.program)&&(zi=!0,mn=!0,Za=!0),rt.id!==D&&(D=rt.id,mn=!0),zi||C!==b){Yt.buffers.depth.getReversed()?(St.copy(b.projectionMatrix),XS(St),WS(St),he.setValue(I,"projectionMatrix",St)):he.setValue(I,"projectionMatrix",b.projectionMatrix),he.setValue(I,"viewMatrix",b.matrixWorldInverse);const tn=he.map.cameraPosition;tn!==void 0&&tn.setValue(I,Ft.setFromMatrixPosition(b.matrixWorld)),ge.logarithmicDepthBuffer&&he.setValue(I,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(rt.isMeshPhongMaterial||rt.isMeshToonMaterial||rt.isMeshLambertMaterial||rt.isMeshBasicMaterial||rt.isMeshStandardMaterial||rt.isShaderMaterial)&&he.setValue(I,"isOrthographic",b.isOrthographicCamera===!0),C!==b&&(C=b,mn=!0,Za=!0)}if(q.isSkinnedMesh){he.setOptional(I,q,"bindMatrix"),he.setOptional(I,q,"bindMatrixInverse");const fn=q.skeleton;fn&&(fn.boneTexture===null&&fn.computeBoneTexture(),he.setValue(I,"boneTexture",fn.boneTexture,L))}q.isBatchedMesh&&(he.setOptional(I,q,"batchingTexture"),he.setValue(I,"batchingTexture",q._matricesTexture,L),he.setOptional(I,q,"batchingIdTexture"),he.setValue(I,"batchingIdTexture",q._indirectTexture,L),he.setOptional(I,q,"batchingColorTexture"),q._colorsTexture!==null&&he.setValue(I,"batchingColorTexture",q._colorsTexture,L));const Un=at.morphAttributes;if((Un.position!==void 0||Un.normal!==void 0||Un.color!==void 0)&&Xt.update(q,at,Dn),(mn||Ht.receiveShadow!==q.receiveShadow)&&(Ht.receiveShadow=q.receiveShadow,he.setValue(I,"receiveShadow",q.receiveShadow)),rt.isMeshGouraudMaterial&&rt.envMap!==null&&(An.envMap.value=Ot,An.flipEnvMap.value=Ot.isCubeTexture&&Ot.isRenderTargetTexture===!1?-1:1),rt.isMeshStandardMaterial&&rt.envMap===null&&X.environment!==null&&(An.envMapIntensity.value=X.environmentIntensity),mn&&(he.setValue(I,"toneMappingExposure",w.toneMappingExposure),Ht.needsLights&&Xc(An,Za),vt&&rt.fog===!0&&wt.refreshFogUniforms(An,vt),wt.refreshMaterialUniforms(An,rt,W,V,x.state.transmissionRenderTarget[b.id]),Bc.upload(I,xn(Ht),An,L)),rt.isShaderMaterial&&rt.uniformsNeedUpdate===!0&&(Bc.upload(I,xn(Ht),An,L),rt.uniformsNeedUpdate=!1),rt.isSpriteMaterial&&he.setValue(I,"center",q.center),he.setValue(I,"modelViewMatrix",q.modelViewMatrix),he.setValue(I,"normalMatrix",q.normalMatrix),he.setValue(I,"modelMatrix",q.matrixWorld),rt.isShaderMaterial||rt.isRawShaderMaterial){const fn=rt.uniformsGroups;for(let tn=0,Cr=fn.length;tn<Cr;tn++){const Ai=fn[tn];k.update(Ai,Dn),k.bind(Ai,Dn)}}return Dn}function Xc(b,X){b.ambientLightColor.needsUpdate=X,b.lightProbe.needsUpdate=X,b.directionalLights.needsUpdate=X,b.directionalLightShadows.needsUpdate=X,b.pointLights.needsUpdate=X,b.pointLightShadows.needsUpdate=X,b.spotLights.needsUpdate=X,b.spotLightShadows.needsUpdate=X,b.rectAreaLights.needsUpdate=X,b.hemisphereLights.needsUpdate=X}function Wc(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return j},this.setRenderTargetTextures=function(b,X,at){Wt.get(b.texture).__webglTexture=X,Wt.get(b.depthTexture).__webglTexture=at;const rt=Wt.get(b);rt.__hasExternalTextures=!0,rt.__autoAllocateDepthBuffer=at===void 0,rt.__autoAllocateDepthBuffer||ue.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),rt.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(b,X){const at=Wt.get(b);at.__webglFramebuffer=X,at.__useDefaultFramebuffer=X===void 0},this.setRenderTarget=function(b,X=0,at=0){j=b,G=X,P=at;let rt=!0,q=null,vt=!1,Ut=!1;if(b){const Ot=Wt.get(b);if(Ot.__useDefaultFramebuffer!==void 0)Yt.bindFramebuffer(I.FRAMEBUFFER,null),rt=!1;else if(Ot.__webglFramebuffer===void 0)L.setupRenderTarget(b);else if(Ot.__hasExternalTextures)L.rebindTextures(b,Wt.get(b.texture).__webglTexture,Wt.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const Zt=b.depthTexture;if(Ot.__boundDepthTexture!==Zt){if(Zt!==null&&Wt.has(Zt)&&(b.width!==Zt.image.width||b.height!==Zt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(b)}}const Qt=b.texture;(Qt.isData3DTexture||Qt.isDataArrayTexture||Qt.isCompressedArrayTexture)&&(Ut=!0);const ee=Wt.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(ee[X])?q=ee[X][at]:q=ee[X],vt=!0):b.samples>0&&L.useMultisampledRTT(b)===!1?q=Wt.get(b).__webglMultisampledFramebuffer:Array.isArray(ee)?q=ee[at]:q=ee,H.copy(b.viewport),ct.copy(b.scissor),ot=b.scissorTest}else H.copy(N).multiplyScalar(W).floor(),ct.copy(it).multiplyScalar(W).floor(),ot=Mt;if(Yt.bindFramebuffer(I.FRAMEBUFFER,q)&&rt&&Yt.drawBuffers(b,q),Yt.viewport(H),Yt.scissor(ct),Yt.setScissorTest(ot),vt){const Ot=Wt.get(b.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+X,Ot.__webglTexture,at)}else if(Ut){const Ot=Wt.get(b.texture),Qt=X||0;I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,Ot.__webglTexture,at||0,Qt)}D=-1},this.readRenderTargetPixels=function(b,X,at,rt,q,vt,Ut){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pt=Wt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Ut!==void 0&&(Pt=Pt[Ut]),Pt){Yt.bindFramebuffer(I.FRAMEBUFFER,Pt);try{const Ot=b.texture,Qt=Ot.format,ee=Ot.type;if(!ge.textureFormatReadable(Qt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable(ee)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}X>=0&&X<=b.width-rt&&at>=0&&at<=b.height-q&&I.readPixels(X,at,rt,q,ae.convert(Qt),ae.convert(ee),vt)}finally{const Ot=j!==null?Wt.get(j).__webglFramebuffer:null;Yt.bindFramebuffer(I.FRAMEBUFFER,Ot)}}},this.readRenderTargetPixelsAsync=async function(b,X,at,rt,q,vt,Ut){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pt=Wt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Ut!==void 0&&(Pt=Pt[Ut]),Pt){const Ot=b.texture,Qt=Ot.format,ee=Ot.type;if(!ge.textureFormatReadable(Qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable(ee))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(X>=0&&X<=b.width-rt&&at>=0&&at<=b.height-q){Yt.bindFramebuffer(I.FRAMEBUFFER,Pt);const Zt=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,Zt),I.bufferData(I.PIXEL_PACK_BUFFER,vt.byteLength,I.STREAM_READ),I.readPixels(X,at,rt,q,ae.convert(Qt),ae.convert(ee),0);const ve=j!==null?Wt.get(j).__webglFramebuffer:null;Yt.bindFramebuffer(I.FRAMEBUFFER,ve);const Ee=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await kS(I,Ee,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,Zt),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,vt),I.deleteBuffer(Zt),I.deleteSync(Ee),vt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(b,X=null,at=0){b.isTexture!==!0&&(Ss("WebGLRenderer: copyFramebufferToTexture function signature has changed."),X=arguments[0]||null,b=arguments[1]);const rt=Math.pow(2,-at),q=Math.floor(b.image.width*rt),vt=Math.floor(b.image.height*rt),Ut=X!==null?X.x:0,Pt=X!==null?X.y:0;L.setTexture2D(b,0),I.copyTexSubImage2D(I.TEXTURE_2D,at,0,0,Ut,Pt,q,vt),Yt.unbindTexture()};const Jo=I.createFramebuffer(),ja=I.createFramebuffer();this.copyTextureToTexture=function(b,X,at=null,rt=null,q=0,vt=null){b.isTexture!==!0&&(Ss("WebGLRenderer: copyTextureToTexture function signature has changed."),rt=arguments[0]||null,b=arguments[1],X=arguments[2],vt=arguments[3]||0,at=null),vt===null&&(q!==0?(Ss("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),vt=q,q=0):vt=0);let Ut,Pt,Ot,Qt,ee,Zt,ve,Ee,Ge;const Fe=b.isCompressedTexture?b.mipmaps[vt]:b.image;if(at!==null)Ut=at.max.x-at.min.x,Pt=at.max.y-at.min.y,Ot=at.isBox3?at.max.z-at.min.z:1,Qt=at.min.x,ee=at.min.y,Zt=at.isBox3?at.min.z:0;else{const Un=Math.pow(2,-q);Ut=Math.floor(Fe.width*Un),Pt=Math.floor(Fe.height*Un),b.isDataArrayTexture?Ot=Fe.depth:b.isData3DTexture?Ot=Math.floor(Fe.depth*Un):Ot=1,Qt=0,ee=0,Zt=0}rt!==null?(ve=rt.x,Ee=rt.y,Ge=rt.z):(ve=0,Ee=0,Ge=0);const re=ae.convert(X.format),Ht=ae.convert(X.type);let an;X.isData3DTexture?(L.setTexture3D(X,0),an=I.TEXTURE_3D):X.isDataArrayTexture||X.isCompressedArrayTexture?(L.setTexture2DArray(X,0),an=I.TEXTURE_2D_ARRAY):(L.setTexture2D(X,0),an=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,X.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,X.unpackAlignment);const Te=I.getParameter(I.UNPACK_ROW_LENGTH),Dn=I.getParameter(I.UNPACK_IMAGE_HEIGHT),zi=I.getParameter(I.UNPACK_SKIP_PIXELS),mn=I.getParameter(I.UNPACK_SKIP_ROWS),Za=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,Fe.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Fe.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Qt),I.pixelStorei(I.UNPACK_SKIP_ROWS,ee),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Zt);const he=b.isDataArrayTexture||b.isData3DTexture,An=X.isDataArrayTexture||X.isData3DTexture;if(b.isDepthTexture){const Un=Wt.get(b),fn=Wt.get(X),tn=Wt.get(Un.__renderTarget),Cr=Wt.get(fn.__renderTarget);Yt.bindFramebuffer(I.READ_FRAMEBUFFER,tn.__webglFramebuffer),Yt.bindFramebuffer(I.DRAW_FRAMEBUFFER,Cr.__webglFramebuffer);for(let Ai=0;Ai<Ot;Ai++)he&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Wt.get(b).__webglTexture,q,Zt+Ai),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Wt.get(X).__webglTexture,vt,Ge+Ai)),I.blitFramebuffer(Qt,ee,Ut,Pt,ve,Ee,Ut,Pt,I.DEPTH_BUFFER_BIT,I.NEAREST);Yt.bindFramebuffer(I.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(q!==0||b.isRenderTargetTexture||Wt.has(b)){const Un=Wt.get(b),fn=Wt.get(X);Yt.bindFramebuffer(I.READ_FRAMEBUFFER,Jo),Yt.bindFramebuffer(I.DRAW_FRAMEBUFFER,ja);for(let tn=0;tn<Ot;tn++)he?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Un.__webglTexture,q,Zt+tn):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Un.__webglTexture,q),An?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,fn.__webglTexture,vt,Ge+tn):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,fn.__webglTexture,vt),q!==0?I.blitFramebuffer(Qt,ee,Ut,Pt,ve,Ee,Ut,Pt,I.COLOR_BUFFER_BIT,I.NEAREST):An?I.copyTexSubImage3D(an,vt,ve,Ee,Ge+tn,Qt,ee,Ut,Pt):I.copyTexSubImage2D(an,vt,ve,Ee,Qt,ee,Ut,Pt);Yt.bindFramebuffer(I.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else An?b.isDataTexture||b.isData3DTexture?I.texSubImage3D(an,vt,ve,Ee,Ge,Ut,Pt,Ot,re,Ht,Fe.data):X.isCompressedArrayTexture?I.compressedTexSubImage3D(an,vt,ve,Ee,Ge,Ut,Pt,Ot,re,Fe.data):I.texSubImage3D(an,vt,ve,Ee,Ge,Ut,Pt,Ot,re,Ht,Fe):b.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,vt,ve,Ee,Ut,Pt,re,Ht,Fe.data):b.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,vt,ve,Ee,Fe.width,Fe.height,re,Fe.data):I.texSubImage2D(I.TEXTURE_2D,vt,ve,Ee,Ut,Pt,re,Ht,Fe);I.pixelStorei(I.UNPACK_ROW_LENGTH,Te),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Dn),I.pixelStorei(I.UNPACK_SKIP_PIXELS,zi),I.pixelStorei(I.UNPACK_SKIP_ROWS,mn),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Za),vt===0&&X.generateMipmaps&&I.generateMipmap(an),Yt.unbindTexture()},this.copyTextureToTexture3D=function(b,X,at=null,rt=null,q=0){return b.isTexture!==!0&&(Ss("WebGLRenderer: copyTextureToTexture3D function signature has changed."),at=arguments[0]||null,rt=arguments[1]||null,b=arguments[2],X=arguments[3],q=arguments[4]||0),Ss('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(b,X,at,rt,q)},this.initRenderTarget=function(b){Wt.get(b).__webglFramebuffer===void 0&&L.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?L.setTextureCube(b,0):b.isData3DTexture?L.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?L.setTexture2DArray(b,0):L.setTexture2D(b,0),Yt.unbindTexture()},this.resetState=function(){G=0,P=0,j=null,Yt.reset(),Oe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return oa}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorspace=Re._getDrawingBufferColorSpace(t),i.unpackColorSpace=Re._getUnpackColorSpace()}}const Je={name:"Priyansha Sharma",initials:"PS",role:"Product Operations Lead",location:"Delhi, India",email:"2priyansharma6@gmail.com",resume:"/Priyansha_Sharma_CV_3.pdf",headline:"Workflow-focused operator turning platform signals, vendor ecosystems, and stakeholder needs into reliable delivery systems.",summary:"Results-driven Product Operations professional with 2+ years of experience in workflow optimization, stakeholder management, and cross-functional coordination within technology-enabled service platforms. Currently pursuing an MBA to strengthen product management acumen.",focusAreas:["Product lifecycle support","Requirements analysis","Workflow optimization","SLA and KPI tracking","Vendor partnerships","Platform administration"],competencies:["ClickUp","Advanced Excel","Power BI","ServiceNow familiarity","Business documentation","User story refinement"],metrics:[{value:"100%",label:"SLA/TAT adherence",detail:"Maintained across vendor engagements for 12+ months."},{value:"30%",label:"Delivery lift",detail:"Improved team timelines through structured workflows."},{value:"10+",label:"Partner relationships",detail:"Managed vendors and external partners as single POC."},{value:"3",label:"Promotions",detail:"Advanced from Jr. Associate to Team Lead in 2 years."},{value:"4",label:"Team members led",detail:"Trained and aligned a cross-functional operations team."}],experience:[{company:"Cache Labs",role:"Team Lead - Product & Operations",period:"March 2026 - Present",bullets:["Own end-to-end operations of the CIP platform across intake, processing, and delivery.","Implemented structured task management frameworks in ClickUp, improving delivery timelines by 30%.","Serve as primary contact for clients and internal teams, translating business needs into actionable tasks.","Manage 10+ vendors and resolve 20+ escalations monthly while maintaining 100% SLA adherence.","Collaborate with CEO and Founder on scaling strategy, product roadmaps, and platform expansion."]},{company:"Cache Labs",role:"Sr. Operations Associate",period:"April 2025 - February 2026",bullets:["Designed operational trackers and dashboards for structured weekly leadership reporting.","Managed end-to-end vendor relationships and reduced resolution time through tighter communication loops.","Identified user pain points and recommended platform improvements from operational data."]},{company:"Cache Labs",role:"Operations Associate",period:"September 2024 - March 2025",bullets:["Maintained documentation, progress reports, and process workflows for cross-functional execution.","Supported requirement gathering and testing for in-house digital products including a journals platform."]},{company:"Cache Labs",role:"Jr. Operations Associate",period:"April 2024 - August 2024",bullets:["Delivered across multiple product lines with attention to process efficiency and quality outcomes.","Resolved complex customer issues using decision-support tools and cross-functional coordination."]},{company:"Helping India Feeding India",role:"Marketing & Operations Intern",period:"May 2023 - August 2023",bullets:["Designed and executed 5+ awareness campaigns for social impact initiatives.","Created 20+ impact-driven narratives to strengthen brand storytelling and stakeholder engagement."]}],education:["MBA, Manipal Academy of Higher Education - pursuing, 2027","B.Sc. Microbiology, Dr. Shyama Prasad Mukherjee University, Ranchi - 79.83%, 2023","Class XII, CBSE, Surendranath Centenary School, Ranchi - 80%, 2020","Class X, ICSE, St. Francis School, Ranchi - 86%, 2018"],certifications:["Careers in Tourism - Event Operations Job Simulation, Forage, 2023","Supply Chain Operations, Rutgers via Coursera","Operations Management: Organization and Analysis, Illinois via Coursera"],publication:"Published research review: Circulating Tumor Cells: An Approach for Early Detection of Cancer, IJRAR."};function Hb(){const s=document.createElement("canvas");return!!(s.getContext("webgl2")||s.getContext("webgl"))}function Gb(s,t,i){const r=document.createElement("canvas");r.width=768,r.height=448;const l=r.getContext("2d");if(!l)return new rv(r);l.fillStyle="#f7f7f2",l.fillRect(0,0,r.width,r.height),l.strokeStyle="#160008",l.lineWidth=10,l.strokeRect(22,22,r.width-44,r.height-44),l.fillStyle=i,l.fillRect(22,22,96,r.height-44),l.fillStyle="#160008",l.font="700 74px ui-monospace, SFMono-Regular, Menlo, monospace",l.fillText(s,152,184),l.font="500 36px Inter, Arial, sans-serif",Vb(l,t,154,252,540,45);const c=new rv(r);return c.colorSpace=Vn,c.anisotropy=8,c}function Vb(s,t,i,r,l,c){const f=t.split(" ");let d="";f.forEach((p,m)=>{const g=`${d}${p} `;s.measureText(g).width>l&&m>0?(s.fillText(d,i,r),d=`${p} `,r+=c):d=g}),s.fillText(d,i,r)}function kb(){const s=new x0,t=8;for(let i=0;i<t*2;i+=1){const r=i%2===0?.5:.11,l=i/(t*2)*Math.PI*2,c=Math.cos(l)*r,f=Math.sin(l)*r;i===0?s.moveTo(c,f):s.lineTo(c,f)}return s.closePath(),new Hd(s)}function Xb(){const s=kn.useRef(null),[t,i]=kn.useState(!1);return kn.useEffect(()=>{const r=s.current;if(!r||!Hb()){i(!0);return}const l=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=new mM,f=new fi(42,window.innerWidth/window.innerHeight,.1,100);f.position.set(0,.4,10);const d=new Fb({alpha:!0,antialias:!0,preserveDrawingBuffer:!0});d.setPixelRatio(Math.min(window.devicePixelRatio,2)),d.setSize(window.innerWidth,window.innerHeight),d.outputColorSpace=Vn,r.appendChild(d.domElement);const p=new Ga;c.add(p);const m=new tE(16777215,1.6),g=new $M(16777215,2.4);g.position.set(4,5,5),c.add(m,g);const _=["#f20a3f","#00a6a6","#f4bf2a","#ffffff"],y=Je.metrics.map((tt,O)=>{const V=Gb(tt.value,tt.label,_[O%_.length]),W=new Io({map:V,transparent:!0,side:hi}),xt=new Xn(new Qo(2.5,1.46),W),Tt=O/Je.metrics.length*Math.PI*2;return xt.position.set(Math.cos(Tt)*4.2,Math.sin(Tt*1.2)*1.45,Math.sin(Tt)*1.6-1.1),xt.rotation.set(.12*Math.sin(Tt),-Tt*.22,.08*Math.cos(Tt)),p.add(xt),xt}),S=new wh({color:"#160008",roughness:.38,metalness:.2}),E=new wh({color:"#f20a3f",roughness:.26,metalness:.34}),R=new wh({color:"#00a6a6",roughness:.45,metalness:.18}),M=new Ga;for(let tt=0;tt<22;tt+=1){const O=new zs(.12+tt%4*.08,.12+tt%5*.1,.12),V=tt%3===0?E:tt%3===1?R:S,W=new Xn(O,V);W.position.set(tt%6*.42-1.15,Math.floor(tt/6)*.36-.6,0),W.rotation.z=tt%2*.2,M.add(W)}M.position.set(.3,-.25,-.4),M.rotation.set(-.3,.35,.12),p.add(M);const x=kb(),B=new Io({color:"#f4bf2a",side:hi}),U=new Ga;for(let tt=0;tt<16;tt+=1){const O=new Xn(x,B),V=tt/16*Math.PI*2;O.position.set(Math.cos(V)*5.4,Math.sin(V)*2.6,Math.sin(V*2)*1.5),O.scale.setScalar(.24+tt%4*.06),U.add(O)}p.add(U);const w=new Ga,K=new Io({color:"#160008",transparent:!0,opacity:.18,side:hi});for(let tt=0;tt<4;tt+=1){const O=new Xn(new Gd(2.5+tt*.62,.006,8,120),K);O.rotation.set(1.3,.25+tt*.2,tt*.18),w.add(O)}p.add(w);const G={x:0,y:0},P={value:0},j={x:window.innerWidth>900?1.9:1.05,scale:window.innerWidth>900?.88:.62};p.scale.setScalar(j.scale);const D=tt=>{G.x=(tt.clientX/window.innerWidth-.5)*2,G.y=(tt.clientY/window.innerHeight-.5)*2},C=()=>{const tt=document.documentElement.scrollHeight-window.innerHeight;P.value=tt>0?window.scrollY/tt:0},H=()=>{f.aspect=window.innerWidth/window.innerHeight,f.updateProjectionMatrix(),j.x=window.innerWidth>900?1.9:1.05,j.scale=window.innerWidth>900?.88:.62,p.scale.setScalar(j.scale),d.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("pointermove",D),window.addEventListener("scroll",C,{passive:!0}),window.addEventListener("resize",H),C();let ct=0;const ot=new nE,gt=()=>{const tt=ot.getElapsedTime();p.rotation.y=G.x*.12+P.value*.72,p.rotation.x=-G.y*.08+P.value*.18,p.position.y=.4-P.value*1.9,p.position.x=j.x+P.value*-.55,y.forEach((O,V)=>{O.position.y+=Math.sin(tt*.55+V)*.0018,O.rotation.z=Math.sin(tt*.38+V)*.04}),M.rotation.y=tt*.18,U.rotation.z=tt*.08,w.rotation.z=tt*.04,w.rotation.x=.16+Math.sin(tt*.2)*.04,d.render(c,f),l||(ct=window.requestAnimationFrame(gt))};return gt(),()=>{window.cancelAnimationFrame(ct),window.removeEventListener("pointermove",D),window.removeEventListener("scroll",C),window.removeEventListener("resize",H),r.removeChild(d.domElement),c.traverse(tt=>{tt instanceof Xn&&(tt.geometry.dispose(),(Array.isArray(tt.material)?tt.material:[tt.material]).forEach(V=>V.dispose()))}),d.dispose()}},[]),yt.jsxs("div",{className:"scene-shell","aria-hidden":"true",children:[yt.jsx("div",{ref:s,className:"scene-shell__mount"}),t?yt.jsx("div",{className:"scene-shell__fallback"}):null]})}const Wb=[{href:"#about",label:"About"},{href:"#impact",label:"Impact"},{href:"#experience",label:"Experience"},{href:"#contact",label:"Contact"}];function qb(){const[s,t]=kn.useState(!1),[i,r]=kn.useState(!0),[l,c]=kn.useState(!1);return kn.useEffect(()=>{const f=window.setTimeout(()=>t(!0),1450),d=window.setTimeout(()=>r(!1),2300);return()=>{window.clearTimeout(f),window.clearTimeout(d)}},[]),kn.useEffect(()=>{document.documentElement.dataset.contrast=l?"high":"standard"},[l]),yt.jsxs("div",{className:"app",children:[i?yt.jsx(jb,{done:s}):null,yt.jsx(Xb,{}),yt.jsx(Yb,{highContrast:l,onToggleContrast:()=>c(f=>!f)}),yt.jsxs("main",{children:[yt.jsxs("section",{className:"hero section",id:"top","data-section":"hero",children:[yt.jsx(O_,{text:"workflow signal"}),yt.jsxs("div",{className:"hero__inner",children:[yt.jsxs("p",{className:"eyebrow",children:[Je.location," / Product Operations"]}),yt.jsxs("h1",{children:[yt.jsx("span",{children:Je.name}),yt.jsx("strong",{children:Je.role})]}),yt.jsx("p",{className:"hero__copy",children:Je.headline}),yt.jsxs("div",{className:"hero__actions",children:[yt.jsxs("a",{className:"button button--primary",href:"#contact",children:[yt.jsx(Vv,{size:18,"aria-hidden":"true"}),"Contact"]}),yt.jsxs("a",{className:"button button--ghost",href:Je.resume,download:!0,children:[yt.jsx(N_,{size:18,"aria-hidden":"true"}),"Resume"]})]})]}),yt.jsx("div",{className:"hero__ticker","aria-label":"Profile highlights",children:Je.metrics.slice(0,4).map(f=>yt.jsxs("span",{children:[yt.jsx("strong",{children:f.value})," ",f.label]},f.label))})]}),yt.jsxs("section",{className:"section about",id:"about",children:[yt.jsx("div",{className:"section__label",children:"01 / About"}),yt.jsxs("div",{className:"about__grid",children:[yt.jsx("h2",{children:"Operational clarity for product-shaped problems."}),yt.jsxs("div",{className:"about__content",children:[yt.jsx("p",{children:Je.summary}),yt.jsx("div",{className:"pill-grid","aria-label":"Focus areas",children:Je.focusAreas.map(f=>yt.jsx("span",{children:f},f))})]})]})]}),yt.jsxs("section",{className:"section impact",id:"impact",children:[yt.jsx("div",{className:"section__label",children:"02 / Impact"}),yt.jsx("h2",{children:"Execution metrics that behave like product signals."}),yt.jsx("div",{className:"metric-grid",children:Je.metrics.map(f=>yt.jsxs("article",{className:"metric-card",children:[yt.jsx("strong",{children:f.value}),yt.jsx("h3",{children:f.label}),yt.jsx("p",{children:f.detail})]},f.label))})]}),yt.jsxs("section",{className:"section ledger",id:"experience",children:[yt.jsx("div",{className:"section__label",children:"03 / Experience"}),yt.jsxs("div",{className:"ledger__header",children:[yt.jsx("h2",{children:"From operations associate to platform lead."}),yt.jsx("p",{children:"A two-year progression across service delivery, product support, client communication, vendor coordination, and leadership."})]}),yt.jsx("div",{className:"timeline",children:Je.experience.map((f,d)=>yt.jsxs("article",{className:"timeline-item",children:[yt.jsx("div",{className:"timeline-item__marker",children:String(d+1).padStart(2,"0")}),yt.jsxs("div",{className:"timeline-item__body",children:[yt.jsx("p",{className:"timeline-item__period",children:f.period}),yt.jsx("h3",{children:f.role}),yt.jsx("p",{className:"timeline-item__company",children:f.company}),yt.jsx("ul",{children:f.bullets.map(p=>yt.jsx("li",{children:p},p))})]})]},`${f.company}-${f.role}`))})]}),yt.jsxs("section",{className:"section proof","aria-labelledby":"proof-heading",children:[yt.jsx("div",{className:"section__label",children:"04 / Proof"}),yt.jsx("h2",{id:"proof-heading",children:"Education, tools, and operating range."}),yt.jsxs("div",{className:"proof__grid",children:[yt.jsx(Ih,{title:"Education",items:Je.education}),yt.jsx(Ih,{title:"Certifications",items:Je.certifications}),yt.jsx(Ih,{title:"Competencies",items:Je.competencies})]}),yt.jsx("p",{className:"publication",children:Je.publication})]}),yt.jsxs("section",{className:"section contact",id:"contact",children:[yt.jsx(O_,{text:"ready to coordinate"}),yt.jsxs("div",{className:"contact__inner",children:[yt.jsx("p",{className:"eyebrow",children:"Contact"}),yt.jsx("h2",{children:"Let's build workflows that move."}),yt.jsxs("div",{className:"contact__actions",children:[yt.jsxs("a",{className:"contact__email",href:`mailto:${Je.email}`,children:[Je.email,yt.jsx(Ky,{size:22,"aria-hidden":"true"})]}),yt.jsxs("a",{className:"button button--primary",href:Je.resume,download:!0,children:[yt.jsx(N_,{size:18,"aria-hidden":"true"}),"Download CV"]})]})]})]})]}),yt.jsx("footer",{className:"site-footer",children:yt.jsx("a",{href:"#top","aria-label":"Back to top",children:Je.initials})})]})}function Yb({highContrast:s,onToggleContrast:t}){return yt.jsxs("header",{className:"site-header",children:[yt.jsx("a",{className:"site-header__mark",href:"#top","aria-label":"Priyansha Sharma home",children:Je.initials}),yt.jsx("nav",{className:"site-nav","aria-label":"Primary navigation",children:Wb.map(i=>yt.jsx("a",{href:i.href,children:i.label},i.href))}),yt.jsxs("div",{className:"site-header__actions",children:[yt.jsx("a",{className:"icon-link",href:`mailto:${Je.email}`,"aria-label":"Email Priyansha Sharma",children:yt.jsx(Vv,{size:19,"aria-hidden":"true"})}),yt.jsx("button",{className:"icon-link",type:"button",onClick:t,"aria-label":"Toggle contrast",children:s?yt.jsx(Jy,{size:19,"aria-hidden":"true"}):yt.jsx(Qy,{size:19,"aria-hidden":"true"})})]})]})}function jb({done:s}){return yt.jsxs("div",{className:`intro${s?" intro--done":""}`,"aria-hidden":s,children:[yt.jsxs("div",{className:"intro__mark",children:[yt.jsx("span",{children:"P"}),yt.jsx("span",{children:"S"})]}),yt.jsx("div",{className:"intro__rail intro__rail--top"}),yt.jsx("div",{className:"intro__rail intro__rail--right"}),yt.jsx("div",{className:"intro__rail intro__rail--bottom"}),yt.jsx("div",{className:"intro__rail intro__rail--left"})]})}function Ih({title:s,items:t}){return yt.jsxs("article",{className:"info-block",children:[yt.jsx("h3",{children:s}),yt.jsx("ul",{children:t.map(i=>yt.jsx("li",{children:i},i))})]})}qy.createRoot(document.getElementById("root")).render(yt.jsx(Iy.StrictMode,{children:yt.jsx(qb,{})}));
